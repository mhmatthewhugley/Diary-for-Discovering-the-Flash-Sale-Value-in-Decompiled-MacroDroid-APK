...
public final class C2242b extends C0002c {

    /* renamed from: E */
    public Map<Integer, View> f6879E = new LinkedHashMap();
    ...
    /* renamed from: o0 */
    public void mo24466o0() {
        this.f6879E.clear();
    }

    public View onCreateView(LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        C13706o.m87929f(layoutInflater, "inflater");
        View inflate = layoutInflater.inflate(C17535R$layout.fragment_constraint_onboard, viewGroup, false);
