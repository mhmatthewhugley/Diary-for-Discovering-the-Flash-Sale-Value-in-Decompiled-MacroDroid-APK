...
public final class NavBackStackEntry implements LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner {
    ...
    static /* synthetic */ class C08031 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.navigation.NavBackStackEntry.C08031.<clinit>():void");
        }
    }
    ...
    private static Lifecycle.State getStateAfter(@NonNull Lifecycle.Event event) {
        switch (C08031.$SwitchMap$androidx$lifecycle$Lifecycle$Event[event.ordinal()]) {
            case 1:
            case 2:
