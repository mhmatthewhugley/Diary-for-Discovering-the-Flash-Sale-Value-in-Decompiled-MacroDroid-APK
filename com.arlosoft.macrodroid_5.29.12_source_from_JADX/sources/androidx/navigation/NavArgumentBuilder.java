...
public final class NavArgumentBuilder {
    ...
    public final NavArgument build() {
        ...
        C13706o.m87925b(build, "builder.build()");
        return build;
    }
