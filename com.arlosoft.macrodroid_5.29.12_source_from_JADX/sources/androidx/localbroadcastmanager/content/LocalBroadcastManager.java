...
public final class LocalBroadcastManager {
    ...
    public boolean sendBroadcast(@androidx.annotation.NonNull android.content.Intent r23) {
        /*
            ...
            monitor-enter(r2)
            java.lang.String r10 = r23.getAction()     // Catch:{ all -> 0x0145 }
            android.content.Context r3 = r1.mAppContext     // Catch:{ all -> 0x0145 }
            android.content.ContentResolver r3 = r3.getContentResolver()     // Catch:{ all -> 0x0145 }
            java.lang.String r11 = r0.resolveTypeIfNeeded(r3)     // Catch:{ all -> 0x0145 }
            android.net.Uri r12 = r23.getData()     // Catch:{ all -> 0x0145 }
            java.lang.String r13 = r23.getScheme()     // Catch:{ all -> 0x0145 }
            java.util.Set r14 = r23.getCategories()     // Catch:{ all -> 0x0145 }
            int r3 = r23.getFlags()     // Catch:{ all -> 0x0145 }
            r3 = r3 & 8
            r9 = 1
        ...
        L_0x002f:
            ...
            r3.append(r11)     // Catch:{ all -> 0x0145 }
            java.lang.String r4 = " scheme "
            r3.append(r4)     // Catch:{ all -> 0x0145 }
            r3.append(r13)     // Catch:{ all -> 0x0145 }
            java.lang.String r4 = " of intent "
            r3.append(r4)     // Catch:{ all -> 0x0145 }
            r3.append(r0)     // Catch:{ all -> 0x0145 }
        L_0x004e:
            java.util.HashMap<java.lang.String, java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord>> r3 = r1.mActions     // Catch:{ all -> 0x0145 }
            java.lang.String r4 = r23.getAction()     // Catch:{ all -> 0x0145 }
            java.lang.Object r3 = r3.get(r4)     // Catch:{ all -> 0x0145 }
            r8 = r3
            java.util.ArrayList r8 = (java.util.ArrayList) r8     // Catch:{ all -> 0x0145 }
            ...
            r3.append(r4)     // Catch:{ all -> 0x0145 }
            r3.append(r8)     // Catch:{ all -> 0x0145 }
        L_0x006c:
            r3 = 0
            r7 = r3
            r6 = 0
        L_0x006f:
            int r3 = r8.size()     // Catch:{ all -> 0x0145 }
            if (r6 >= r3) goto L_0x0112
            java.lang.Object r3 = r8.get(r6)     // Catch:{ all -> 0x0145 }
            r5 = r3
            androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord r5 = (androidx.localbroadcastmanager.content.LocalBroadcastManager.ReceiverRecord) r5     // Catch:{ all -> 0x0145 }
            if (r16 == 0) goto L_0x008d
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ all -> 0x0145 }
            r3.<init>()     // Catch:{ all -> 0x0145 }
            java.lang.String r4 = "Matching against filter "
            r3.append(r4)     // Catch:{ all -> 0x0145 }
            android.content.IntentFilter r4 = r5.filter     // Catch:{ all -> 0x0145 }
            r3.append(r4)     // Catch:{ all -> 0x0145 }
        L_0x008d:
            boolean r3 = r5.broadcasting     // Catch:{ all -> 0x0145 }
            ...
            goto L_0x0106
        L_0x009d:
            android.content.IntentFilter r3 = r5.filter     // Catch:{ all -> 0x0145 }
            ...
            r11 = 1
            r9 = r17
            int r3 = r3.match(r4, r5, r6, r7, r8, r9)     // Catch:{ all -> 0x0145 }
            if (r3 < 0) goto L_0x00db
            if (r16 == 0) goto L_0x00cc
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ all -> 0x0145 }
            r4.<init>()     // Catch:{ all -> 0x0145 }
            java.lang.String r5 = "  Filter matched!  match=0x"
            r4.append(r5)     // Catch:{ all -> 0x0145 }
            java.lang.String r3 = java.lang.Integer.toHexString(r3)     // Catch:{ all -> 0x0145 }
            r4.append(r3)     // Catch:{ all -> 0x0145 }
        L_0x00cc:
            if (r10 != 0) goto L_0x00d4
            java.util.ArrayList r7 = new java.util.ArrayList     // Catch:{ all -> 0x0145 }
            r7.<init>()     // Catch:{ all -> 0x0145 }
            goto L_0x00d5
        L_0x00d4:
            r7 = r10
        L_0x00d5:
            r7.add(r15)     // Catch:{ all -> 0x0145 }
            r15.broadcasting = r11     // Catch:{ all -> 0x0145 }
            goto L_0x0107
        L_0x00db:
        ...
        L_0x0112:
            ...
            r3 = 0
        L_0x0117:
            int r4 = r10.size()     // Catch:{ all -> 0x0145 }
            if (r3 >= r4) goto L_0x0129
            java.lang.Object r4 = r10.get(r3)     // Catch:{ all -> 0x0145 }
            androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord r4 = (androidx.localbroadcastmanager.content.LocalBroadcastManager.ReceiverRecord) r4     // Catch:{ all -> 0x0145 }
            r5 = 0
            r4.broadcasting = r5     // Catch:{ all -> 0x0145 }
            int r3 = r3 + 1
            goto L_0x0117
        L_0x0129:
            java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord> r3 = r1.mPendingBroadcasts     // Catch:{ all -> 0x0145 }
            androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord r4 = new androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord     // Catch:{ all -> 0x0145 }
            r4.<init>(r0, r10)     // Catch:{ all -> 0x0145 }
            r3.add(r4)     // Catch:{ all -> 0x0145 }
            android.os.Handler r0 = r1.mHandler     // Catch:{ all -> 0x0145 }
            boolean r0 = r0.hasMessages(r11)     // Catch:{ all -> 0x0145 }
            if (r0 != 0) goto L_0x0140
            android.os.Handler r0 = r1.mHandler     // Catch:{ all -> 0x0145 }
            r0.sendEmptyMessage(r11)     // Catch:{ all -> 0x0145 }
        L_0x0140:
