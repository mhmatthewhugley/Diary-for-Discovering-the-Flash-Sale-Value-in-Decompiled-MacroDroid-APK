...
class FragmentAnim {
    ...
    static AnimationOrAnimator loadAnimation(@NonNull Context context, @NonNull Fragment fragment, boolean z, boolean z2) {
        ...
        if (viewGroup != null) {
            int i = C0621R.C0622id.visible_removing_fragment_view_tag;
    ...
    private static int transitToAnimResourceId(@NonNull Context context, int i, boolean z) {
        if (i == 4097) {
            return z ? C0621R.animator.fragment_open_enter : C0621R.animator.fragment_open_exit;
        }
        if (i == 8194) {
            return z ? C0621R.animator.fragment_close_enter : C0621R.animator.fragment_close_exit;
        }
        if (i != 8197) {
            if (i == 4099) {
                return z ? C0621R.animator.fragment_fade_enter : C0621R.animator.fragment_fade_exit;
            }
            if (i != 4100) {
                return -1;
            }
