...
public class FragmentActivity extends ComponentActivity implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    /* renamed from: c */
    public static final /* synthetic */ int f542c = 0;
    boolean mCreated;
    ...
    private void init() {
        getSavedStateRegistry().registerSavedStateProvider(LIFECYCLE_TAG, new C0682b(this));
        addOnContextAvailableListener(new C0681a(this));
    }
