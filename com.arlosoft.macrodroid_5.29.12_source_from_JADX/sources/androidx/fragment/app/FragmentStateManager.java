...
class FragmentStateManager {
    ...
    static /* synthetic */ class C06662 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.fragment.app.FragmentStateManager.C06662.<clinit>():void");
        }
    }
    ...
    public int computeExpectedState() {
        ...
        int i2 = C06662.$SwitchMap$androidx$lifecycle$Lifecycle$State[fragment.mMaxState.ordinal()];
        if (i2 != 1) {
            if (i2 == 2) {
                i = Math.min(i, 5);
            } else if (i2 == 3) {
    ...
    public void createView() {
        ...
        if (!this.mFragment.mFromLayout) {
            ...
            if (view != null) {
                ...
                Fragment fragment5 = this.mFragment;
                fragment5.mView.setTag(C0621R.C0622id.fragment_container_view_tag, fragment5);
                if (viewGroup != null) {
                    addViewToContainer();
                }
    ...
    public void ensureInflatedView() {
        ...
        if (fragment.mFromLayout && fragment.mInLayout && !fragment.mPerformedCreateView) {
            ...
            if (view != null) {
                view.setSaveFromParentEnabled(false);
                Fragment fragment3 = this.mFragment;
                fragment3.mView.setTag(C0621R.C0622id.fragment_container_view_tag, fragment3);
                Fragment fragment4 = this.mFragment;
