...
public class ViewTransition {
    ...
    ViewTransition(android.content.Context r10, org.xmlpull.v1.XmlPullParser r11) {
        /*
            ...
            r9.mContext = r10
            int r2 = r11.getEventType()     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
        L_0x002a:
            r3 = 1
            ...
            goto L_0x00ed
        L_0x0037:
            java.lang.String r2 = r11.getName()     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            boolean r2 = r4.equals(r2)     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            if (r2 == 0) goto L_0x00ed
            return
        L_0x0042:
            java.lang.String r2 = r11.getName()     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            int r7 = r2.hashCode()     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            r8 = 4
            switch(r7) {
            ...
            }     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
        L_0x004e:
            goto L_0x007f
        L_0x004f:
            java.lang.String r4 = "CustomAttribute"
            boolean r4 = r2.equals(r4)     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
        ...
        L_0x0080:
            ...
            java.lang.String r3 = TAG     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            java.lang.String r4 = androidx.constraintlayout.motion.widget.Debug.getLoc()     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            java.lang.String r5 = java.lang.String.valueOf(r4)     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            int r5 = r5.length()     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            int r5 = r5 + 13
            int r6 = r2.length()     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            int r5 = r5 + r6
            java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            r6.<init>(r5)     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            r6.append(r4)     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            java.lang.String r4 = " unknown tag "
            r6.append(r4)     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            r6.append(r2)     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            java.lang.String r2 = r6.toString()     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            android.util.Log.e(r3, r2)     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            java.lang.String r2 = TAG     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            int r3 = r11.getLineNumber()     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            r4 = 16
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            r5.<init>(r4)     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            java.lang.String r4 = ".xml:"
            r5.append(r4)     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            r5.append(r3)     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            java.lang.String r3 = r5.toString()     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            android.util.Log.e(r2, r3)     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            goto L_0x00ed
        L_0x00d3:
            androidx.constraintlayout.widget.ConstraintSet$Constraint r2 = r9.mConstraintDelta     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            java.util.HashMap<java.lang.String, androidx.constraintlayout.widget.ConstraintAttribute> r2 = r2.mCustomConstraints     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            androidx.constraintlayout.widget.ConstraintAttribute.parse(r10, r11, r2)     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            goto L_0x00ed
        L_0x00db:
            androidx.constraintlayout.widget.ConstraintSet$Constraint r2 = androidx.constraintlayout.widget.ConstraintSet.buildDelta(r10, r11)     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            r9.mConstraintDelta = r2     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            goto L_0x00ed
        L_0x00e2:
            androidx.constraintlayout.motion.widget.KeyFrames r2 = new androidx.constraintlayout.motion.widget.KeyFrames     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            r2.<init>(r10, r11)     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            r9.mKeyFrames = r2     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            goto L_0x00ed
        L_0x00ea:
            r9.parseViewTransitionTags(r10, r11)     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
        L_0x00ed:
            int r2 = r11.next()     // Catch:{ XmlPullParserException -> 0x00f8, IOException -> 0x00f3 }
            goto L_0x002a
        L_0x00f3:
            r10 = move-exception
            r10.printStackTrace()
    ...
    private void parseViewTransitionTags(Context context, XmlPullParser xmlPullParser) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), C0382R.styleable.ViewTransition);
        int indexCount = obtainStyledAttributes.getIndexCount();
        for (int i = 0; i < indexCount; i++) {
            int index = obtainStyledAttributes.getIndex(i);
            if (index == C0382R.styleable.ViewTransition_android_id) {
                this.mId = obtainStyledAttributes.getResourceId(index, this.mId);
            } else if (index == C0382R.styleable.ViewTransition_motionTarget) {
            ...
            } else if (index == C0382R.styleable.ViewTransition_onStateTransition) {
                this.mOnStateTransition = obtainStyledAttributes.getInt(index, this.mOnStateTransition);
            } else if (index == C0382R.styleable.ViewTransition_transitionDisable) {
                this.mDisabled = obtainStyledAttributes.getBoolean(index, this.mDisabled);
            } else if (index == C0382R.styleable.ViewTransition_pathMotionArc) {
                this.mPathMotionArc = obtainStyledAttributes.getInt(index, this.mPathMotionArc);
            } else if (index == C0382R.styleable.ViewTransition_duration) {
                this.mDuration = obtainStyledAttributes.getInt(index, this.mDuration);
            } else if (index == C0382R.styleable.ViewTransition_upDuration) {
                this.mUpDuration = obtainStyledAttributes.getInt(index, this.mUpDuration);
            } else if (index == C0382R.styleable.ViewTransition_viewTransitionMode) {
                this.mViewTransitionMode = obtainStyledAttributes.getInt(index, this.mViewTransitionMode);
            } else if (index == C0382R.styleable.ViewTransition_motionInterpolator) {
    ...
    public void applyTransition(ViewTransitionController viewTransitionController, MotionLayout motionLayout, int i, ConstraintSet constraintSet, View... viewArr) {
        if (!this.mDisabled) {
            ...
            int i4 = C0382R.C0385id.view_transition;
            ...
            motionLayout.transitionToEnd(new C0371a(this, viewArr));
        }
    }
