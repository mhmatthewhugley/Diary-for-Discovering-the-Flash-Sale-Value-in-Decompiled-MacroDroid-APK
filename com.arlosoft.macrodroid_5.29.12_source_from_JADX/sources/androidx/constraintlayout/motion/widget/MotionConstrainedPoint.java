...
class MotionConstrainedPoint implements Comparable<MotionConstrainedPoint> {
            ...
            switch (c) {
                ...
                default:
                    if (!next.startsWith("CUSTOM")) {
                        Log.e("MotionPaths", next.length() != 0 ? "UNKNOWN spline ".concat(next) : new String("UNKNOWN spline "));
                        break;
                    } else {
                        ...
                        if (!this.attributes.containsKey(str)) {
                            ...
                            if (!(viewSpline instanceof ViewSpline.CustomSet)) {
                                ...
                                StringBuilder sb = new StringBuilder(next.length() + 69 + valueOf.length());
                                sb.append(next);
    ...
    public void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.position, this.f388x, this.f389y, this.width, this.height, this.alpha, this.elevation, this.rotation, this.rotationX, this.rotationY, this.scaleX, this.scaleY, this.mPivotX, this.mPivotY, this.translationX, this.translationY, this.translationZ, this.mPathRotate};
        int i = 0;
    ...
    public void different(MotionConstrainedPoint motionConstrainedPoint, boolean[] zArr, String[] strArr) {
        ...
        zArr[1] = zArr[1] | diff(this.f388x, motionConstrainedPoint.f388x);
        zArr[2] = zArr[2] | diff(this.f389y, motionConstrainedPoint.f389y);
