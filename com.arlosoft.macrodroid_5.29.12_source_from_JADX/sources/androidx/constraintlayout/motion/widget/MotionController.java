...
public class MotionController {
    ...
    public void getDpDt(float f, float f2, float f3, float[] fArr) {
        ...
        float f5 = motionPaths.f392x;
        MotionPaths motionPaths2 = this.mStartMotionPath;
        float f6 = f5 - motionPaths2.f392x;
        float f7 = motionPaths.f393y - motionPaths2.f393y;
    ...
    public float getFinalX() {
        return this.mEndMotionPath.f392x;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f393y;
    }
    ...
    public float getKeyFrameParameter(int i, float f, float f2) {
        MotionPaths motionPaths = this.mEndMotionPath;
        float f3 = motionPaths.f392x;
        MotionPaths motionPaths2 = this.mStartMotionPath;
        float f4 = motionPaths2.f392x;
        float f5 = f3 - f4;
        float f6 = motionPaths.f393y;
        float f7 = motionPaths2.f393y;
        float f8 = f6 - f7;
    ...
    public KeyPositionBase getPositionKeyframe(int i, int i2, float f, float f2) {
        ...
        float f3 = motionPaths.f392x;
        rectF.left = f3;
        float f4 = motionPaths.f393y;
        rectF.top = f4;
        rectF.right = f3 + motionPaths.width;
        rectF.bottom = f4 + motionPaths.height;
        RectF rectF2 = new RectF();
        MotionPaths motionPaths2 = this.mEndMotionPath;
        float f5 = motionPaths2.f392x;
        rectF2.left = f5;
        float f6 = motionPaths2.f393y;
        rectF2.top = f6;
    ...
    public void getPostLayoutDvDp(float f, int i, int i2, float f2, float f3, float[] fArr) {
        ...
        if (this.mSpline != null) {
            ...
            MotionPaths motionPaths = this.mEndMotionPath;
            float f7 = motionPaths.f392x;
            MotionPaths motionPaths2 = this.mStartMotionPath;
            float f8 = f7 - motionPaths2.f392x;
            float f9 = motionPaths.f393y - motionPaths2.f393y;
    ...
    public float getStartX() {
        return this.mStartMotionPath.f392x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f393y;
    }
    ...
    public void setup(int r18, int r19, float r20, long r21) {
        ...
        L_0x0382:
            ...
            int r11 = r10.length
            if (r9 >= r11) goto L_0x03c2
            r11 = r10[r9]
            java.lang.String[] r12 = androidx.constraintlayout.motion.widget.MotionPaths.names
            int r13 = r12.length
            if (r11 >= r13) goto L_0x03bf
            r10 = r10[r9]
            r10 = r12[r10]
    ...
    public String toString() {
        MotionPaths motionPaths = this.mStartMotionPath;
        float f = motionPaths.f392x;
        float f2 = motionPaths.f393y;
        MotionPaths motionPaths2 = this.mEndMotionPath;
        float f3 = motionPaths2.f392x;
        float f4 = motionPaths2.f393y;
