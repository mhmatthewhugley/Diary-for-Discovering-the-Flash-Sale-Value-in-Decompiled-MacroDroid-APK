...
public class CLToken extends CLElement {
    ...
    static /* synthetic */ class C03371 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.core.parser.CLToken.C03371.<clinit>():void");
        }
    }
    ...
    public boolean validate(char c, long j) {
        int i = C03371.$SwitchMap$androidx$constraintlayout$core$parser$CLToken$Type[this.type.ordinal()];
        boolean z = false;
        if (i == 1) {
