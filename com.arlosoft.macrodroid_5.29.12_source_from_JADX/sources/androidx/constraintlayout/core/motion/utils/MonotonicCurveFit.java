...
public class MonotonicCurveFit extends CurveFit {
    ...
    /* renamed from: mT */
    private double[] f360mT;
    private double[][] mTangent;

    /* renamed from: mY */
    private double[][] f361mY;
    ...
    public void getPos(double d, double[] dArr) {
        double[] dArr2 = this.f360mT;
        int length = dArr2.length;
        int i = 0;
        int length2 = this.f361mY[0].length;
        if (this.mExtrapolate) {
            if (d <= dArr2[0]) {
                getSlope(dArr2[0], this.mSlopeTemp);
                for (int i2 = 0; i2 < length2; i2++) {
                    dArr[i2] = this.f361mY[0][i2] + ((d - this.f360mT[0]) * this.mSlopeTemp[i2]);
                }
                return;
            }
            int i3 = length - 1;
            if (d >= dArr2[i3]) {
                ...
                while (i < length2) {
                    dArr[i] = this.f361mY[i3][i] + ((d - this.f360mT[i3]) * this.mSlopeTemp[i]);
                    i++;
                }
                return;
            }
        ...
        while (i6 < length - 1) {
            if (d == this.f360mT[i6]) {
                for (int i7 = 0; i7 < length2; i7++) {
                    dArr[i7] = this.f361mY[i6][i7];
                }
            }
            double[] dArr3 = this.f360mT;
            int i8 = i6 + 1;
            if (d < dArr3[i8]) {
                double d2 = dArr3[i8] - dArr3[i6];
                double d3 = (d - dArr3[i6]) / d2;
                while (i < length2) {
                    double[][] dArr4 = this.f361mY;
    ...
    public void getPos(double d, float[] fArr) {
        ...
        if (this.mExtrapolate) {
            if (d <= dArr[0]) {
                ...
                for (int i2 = 0; i2 < length2; i2++) {
                    fArr[i2] = (float) (this.f361mY[0][i2] + ((d - this.f360mT[0]) * this.mSlopeTemp[i2]));
                }
                return;
            }
            int i3 = length - 1;
            if (d >= dArr[i3]) {
                ...
                while (i < length2) {
                    fArr[i] = (float) (this.f361mY[i3][i] + ((d - this.f360mT[i3]) * this.mSlopeTemp[i]));
                    i++;
                }
                return;
            }
            ...
            for (int i4 = 0; i4 < length2; i4++) {
                fArr[i4] = (float) this.f361mY[0][i4];
            }
            return;
        } else {
            int i5 = length - 1;
        ...
        while (i6 < length - 1) {
            if (d == this.f360mT[i6]) {
                for (int i7 = 0; i7 < length2; i7++) {
                    fArr[i7] = (float) this.f361mY[i6][i7];
                }
            }
            double[] dArr2 = this.f360mT;
            int i8 = i6 + 1;
    ...
    public double getPos(double d, int i) {
        ...
        if (this.mExtrapolate) {
            if (d <= dArr[0]) {
                return this.f361mY[0][i2] + ((d - dArr[0]) * getSlope(dArr[0], i2));
            }
            int i4 = length - 1;
            if (d >= dArr[i4]) {
                return this.f361mY[i4][i2] + ((d - dArr[i4]) * getSlope(dArr[i4], i2));
            }
        } else if (d <= dArr[0]) {
            return this.f361mY[0][i2];
        } else {
            int i5 = length - 1;
            if (d >= dArr[i5]) {
                return this.f361mY[i5][i2];
            }
        }
        while (i3 < length - 1) {
            double[] dArr2 = this.f360mT;
            if (d == dArr2[i3]) {
                return this.f361mY[i3][i2];
            }
            int i6 = i3 + 1;
            if (d < dArr2[i6]) {
