...
public class StopLogicEngine implements StopEngine {
    ...
    public String debug(String str, float f) {
        ...
        sb.append(str + " ===== " + this.mType + IOUtils.LINE_SEPARATOR_UNIX);
        sb.append(str);
        ...
        String str2 = sb.toString() + str + " dur " + this.mStage1Duration + " vel " + this.mStage1Velocity + " pos " + this.mStage1EndPosition + IOUtils.LINE_SEPARATOR_UNIX;
