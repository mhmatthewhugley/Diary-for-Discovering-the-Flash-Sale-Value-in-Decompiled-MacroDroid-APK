...
public class Motion {
    ...
    private static DifferentialInterpolator getInterpolator(int i, String str, int i2) {
        ...
        return new DifferentialInterpolator() {
            ...
            public float getVelocity() {
                return (float) interpolator.getDiff((double) this.f343mX);
            }
        };
    }
    ...
    public void getDpDt(float f, float f2, float f3, float[] fArr) {
        ...
        float f5 = motionPaths.f346x;
        MotionPaths motionPaths2 = this.mStartMotionPath;
        float f6 = f5 - motionPaths2.f346x;
        float f7 = motionPaths.f347y - motionPaths2.f347y;
    ...
    public float getFinalX() {
        return this.mEndMotionPath.f346x;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f347y;
    }
    ...
    public float getKeyFrameParameter(int i, float f, float f2) {
        MotionPaths motionPaths = this.mEndMotionPath;
        float f3 = motionPaths.f346x;
        MotionPaths motionPaths2 = this.mStartMotionPath;
        float f4 = motionPaths2.f346x;
        float f5 = f3 - f4;
        float f6 = motionPaths.f347y;
        float f7 = motionPaths2.f347y;
        float f8 = f6 - f7;
    ...
    public void getPostLayoutDvDp(float f, int i, int i2, float f2, float f3, float[] fArr) {
        ...
        if (this.mSpline != null) {
            ...
            MotionPaths motionPaths = this.mEndMotionPath;
            float f7 = motionPaths.f346x;
            MotionPaths motionPaths2 = this.mStartMotionPath;
            float f8 = f7 - motionPaths2.f346x;
            float f9 = motionPaths.f347y - motionPaths2.f347y;
    ...
    public float getStartX() {
        return this.mStartMotionPath.f346x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f347y;
    }
    ...
    public boolean interpolate(MotionWidget motionWidget, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float f5 = motionPaths.f346x;
            MotionPaths motionPaths2 = this.mEndMotionPath;
            float f6 = f5 + ((motionPaths2.f346x - f5) * f4);
            float f7 = motionPaths.f347y;
            float f8 = f7 + ((motionPaths2.f347y - f7) * f4);
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f346x + " y: " + this.mStartMotionPath.f347y + " end: x: " + this.mEndMotionPath.f346x + " y: " + this.mEndMotionPath.f347y;
    }
}
