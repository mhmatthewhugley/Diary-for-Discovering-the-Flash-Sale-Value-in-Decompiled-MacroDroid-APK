...
import androidx.constraintlayout.core.motion.utils.C0328a;
import androidx.constraintlayout.core.motion.utils.C0331d;
...
public class MotionWidget implements TypedValues {
    ...
    public int getId(String str) {
        int a = C0328a.m384a(str);
        if (a != -1) {
            return a;
        }
        return C0331d.m389a(str);
    }
