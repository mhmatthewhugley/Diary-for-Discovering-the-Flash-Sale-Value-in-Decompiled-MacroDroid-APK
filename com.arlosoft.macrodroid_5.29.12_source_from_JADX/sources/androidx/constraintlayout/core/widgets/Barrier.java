    ...
    public void addToSolver(LinearSystem linearSystem, boolean z) {
        ...
        if (i5 >= 0 && i5 < 4) {
            ...
            if (this.resolved) {
                ...
                if (i6 == 0 || i6 == 1) {
                    linearSystem.addEquality(this.mLeft.mSolverVariable, this.f376mX);
                    linearSystem.addEquality(this.mRight.mSolverVariable, this.f376mX);
                } else if (i6 == 2 || i6 == 3) {
                    linearSystem.addEquality(this.mTop.mSolverVariable, this.f377mY);
                    linearSystem.addEquality(this.mBottom.mSolverVariable, this.f377mY);
                }
            } else {
                int i7 = 0;
                while (true) {
