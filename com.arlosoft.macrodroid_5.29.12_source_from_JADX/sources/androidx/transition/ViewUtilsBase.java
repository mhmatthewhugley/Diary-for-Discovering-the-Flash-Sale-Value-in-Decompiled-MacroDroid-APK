...
class ViewUtilsBase {
    ...
    public void clearNonTransitionAlpha(@NonNull View view) {
        if (view.getVisibility() == 0) {
            view.setTag(C1217R.C1220id.save_non_transition_alpha, (Object) null);
        }
    }

    public float getTransitionAlpha(@NonNull View view) {
        Float f = (Float) view.getTag(C1217R.C1220id.save_non_transition_alpha);
        if (f != null) {
    ...
    public void saveNonTransitionAlpha(@NonNull View view) {
        int i = C1217R.C1220id.save_non_transition_alpha;
    ...
    public void setTransitionAlpha(@NonNull View view, float f) {
        Float f2 = (Float) view.getTag(C1217R.C1220id.save_non_transition_alpha);
        if (f2 != null) {
