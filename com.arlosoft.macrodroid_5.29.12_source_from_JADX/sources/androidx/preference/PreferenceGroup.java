...
public abstract class PreferenceGroup extends Preference {
    ...
    public PreferenceGroup(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0996R.styleable.PreferenceGroup, i, i2);
        int i3 = C0996R.styleable.PreferenceGroup_orderingFromXml;
        this.mOrderingAsAdded = TypedArrayUtils.getBoolean(obtainStyledAttributes, i3, i3, true);
        int i4 = C0996R.styleable.PreferenceGroup_initialExpandedChildrenCount;
