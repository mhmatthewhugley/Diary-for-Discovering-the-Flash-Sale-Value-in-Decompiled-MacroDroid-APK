...
public class StaggeredGridLayoutManager2 extends StaggeredGridLayoutManager {
    ...
    public StaggeredGridLayoutManager2(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mCheckForGapsRunnable = new Runnable() {
            public void run() {
                StaggeredGridLayoutManager2.this.checkForGaps();
            }
        };
        RecyclerView.LayoutManager.Properties properties = RecyclerView.LayoutManager.getProperties(context, attributeSet, i, i2);
        setOrientation(properties.orientation);
        setSpanCount2(properties.spanCount);
    ...
    private void handleUpdate(int r7, int r8, int r9) {
        ...
        L_0x001c:
            r3 = r7
        L_0x001d:
            androidx.recyclerview.widget.StaggeredGridLayoutManager2$LazySpanLookup r4 = r6.mLazySpanLookup
            ...
            goto L_0x0041
        L_0x002b:
            androidx.recyclerview.widget.StaggeredGridLayoutManager2$LazySpanLookup r9 = r6.mLazySpanLookup
            r9.offsetForRemoval(r7, r4)
            androidx.recyclerview.widget.StaggeredGridLayoutManager2$LazySpanLookup r7 = r6.mLazySpanLookup
        ...
        L_0x0056:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.recyclerview.widget.StaggeredGridLayoutManager2.handleUpdate(int, int, int):void");
    }

    private void measureChildWithDecorationsAndMargin(View view, LayoutParams layoutParams, boolean z) {
        if (layoutParams.mFullSpan) {
            if (this.mOrientation == 1) {
                measureChildWithDecorationsAndMargin(view, this.mFullSizeSpec, RecyclerView.LayoutManager.getChildMeasureSpec(getHeight(), getHeightMode(), 0, layoutParams.height, true), z);
            } else {
                measureChildWithDecorationsAndMargin(view, RecyclerView.LayoutManager.getChildMeasureSpec(getWidth(), getWidthMode(), 0, layoutParams.width, true), this.mFullSizeSpec, z);
            }
        } else if (this.mOrientation == 1) {
            measureChildWithDecorationsAndMargin(view, RecyclerView.LayoutManager.getChildMeasureSpec(this.mSizePerSpan, getWidthMode(), 0, layoutParams.width, false), RecyclerView.LayoutManager.getChildMeasureSpec(getHeight(), getHeightMode(), 0, layoutParams.height, true), z);
        } else {
            measureChildWithDecorationsAndMargin(view, RecyclerView.LayoutManager.getChildMeasureSpec(getWidth(), getWidthMode(), 0, layoutParams.width, true), RecyclerView.LayoutManager.getChildMeasureSpec(this.mSizePerSpan, getHeightMode(), 0, layoutParams.height, false), z);
        }
    }
    ...
    private void updateLayoutState(int r5, androidx.recyclerview.widget.RecyclerView.State r6) {
        ...
        L_0x0074:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.recyclerview.widget.StaggeredGridLayoutManager2.updateLayoutState(int, androidx.recyclerview.widget.RecyclerView$State):void");
    }
    ...
    public android.view.View hasGapsToFix() {
        ...
        L_0x002e:
            ...
            androidx.recyclerview.widget.StaggeredGridLayoutManager2$LayoutParams r8 = (androidx.recyclerview.widget.StaggeredGridLayoutManager2.LayoutParams) r8
            androidx.recyclerview.widget.StaggeredGridLayoutManager2$Span r9 = r8.mSpan
            int r9 = r9.mIndex
        ...
        L_0x008b:
            ...
            androidx.recyclerview.widget.StaggeredGridLayoutManager2$LayoutParams r9 = (androidx.recyclerview.widget.StaggeredGridLayoutManager2.LayoutParams) r9
            androidx.recyclerview.widget.StaggeredGridLayoutManager2$Span r8 = r8.mSpan
            int r8 = r8.mIndex
            androidx.recyclerview.widget.StaggeredGridLayoutManager2$Span r9 = r9.mSpan
            int r9 = r9.mIndex
            int r8 = r8 - r9
        ...
        L_0x00ab:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.recyclerview.widget.StaggeredGridLayoutManager2.hasGapsToFix():android.view.View");
    }
    ...
    public void setSpanCount2(int i) {
        assertNotInLayoutOrScroll((String) null);
    ...
    class AnchorInfo {
        ...
        public void assignCoordinateFromPadding() {
            ...
            if (this.mLayoutFromEnd) {
                i = StaggeredGridLayoutManager2.this.mPrimaryOrientation.getEndAfterPadding();
            } else {
                i = StaggeredGridLayoutManager2.this.mPrimaryOrientation.getStartAfterPadding();
            }
            this.mOffset = i;
        }
        ...
        public void saveSpanReferenceLines(Span[] spanArr) {
            ...
            if (iArr == null || iArr.length < length) {
                this.mSpanReferenceLines = new int[StaggeredGridLayoutManager2.this.mSpans.length];
            }
        ...
        public void assignCoordinateFromPadding(int i) {
            if (this.mLayoutFromEnd) {
                this.mOffset = StaggeredGridLayoutManager2.this.mPrimaryOrientation.getEndAfterPadding() - i;
            } else {
                this.mOffset = StaggeredGridLayoutManager2.this.mPrimaryOrientation.getStartAfterPadding() + i;
            }
        }
    }
    ...
    private void onLayoutChildren(androidx.recyclerview.widget.RecyclerView.Recycler r9, androidx.recyclerview.widget.RecyclerView.State r10, boolean r11) {
        /*
            r8 = this;
            androidx.recyclerview.widget.StaggeredGridLayoutManager2$AnchorInfo r0 = r8.mAnchorInfo
            androidx.recyclerview.widget.StaggeredGridLayoutManager2$SavedState r1 = r8.mPendingSavedState
            r2 = -1
        ...
        L_0x002a:
            ...
            r0.reset()
            androidx.recyclerview.widget.StaggeredGridLayoutManager2$SavedState r5 = r8.mPendingSavedState
        ...
        L_0x0059:
            androidx.recyclerview.widget.StaggeredGridLayoutManager2$LazySpanLookup r5 = r8.mLazySpanLookup
            r5.clear()
        ...
        L_0x0073:
            ...
            androidx.recyclerview.widget.StaggeredGridLayoutManager2$Span[] r5 = r8.mSpans
            r5 = r5[r1]
            r5.clear()
            int r5 = r0.mOffset
            r6 = -2147483648(0xffffffff80000000, float:-0.0)
            if (r5 == r6) goto L_0x008b
            androidx.recyclerview.widget.StaggeredGridLayoutManager2$Span[] r6 = r8.mSpans
            r6 = r6[r1]
            r6.setLine(r5)
        L_0x008b:
            int r1 = r1 + 1
        ...
        L_0x008e:
            ...
            androidx.recyclerview.widget.StaggeredGridLayoutManager2$AnchorInfo r1 = r8.mAnchorInfo
        ...
        L_0x0098:
            ...
            r5 = r5[r1]
            r5.clear()
            androidx.recyclerview.widget.StaggeredGridLayoutManager2$AnchorInfo r6 = r8.mAnchorInfo
        ...
        L_0x015b:
            ...
            androidx.recyclerview.widget.StaggeredGridLayoutManager2$AnchorInfo r11 = r8.mAnchorInfo
            r11.reset()
        L_0x0166:
        ...
        L_0x017a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.recyclerview.widget.StaggeredGridLayoutManager2.onLayoutChildren(androidx.recyclerview.widget.RecyclerView$Recycler, androidx.recyclerview.widget.RecyclerView$State, boolean):void");
    }
    ...
    class Span {
        ...
        public void appendToSpan(View view) {
            ...
            if (layoutParams.isItemRemoved() || layoutParams.isItemChanged()) {
                this.mDeletedSize += StaggeredGridLayoutManager2.this.mPrimaryOrientation.getDecoratedMeasurement(view);
            }
        }
        ...
        public void cacheReferenceLineAndClear(boolean z, int i) {
            ...
            clear();
            if (i2 != Integer.MIN_VALUE) {
                if (z && i2 < StaggeredGridLayoutManager2.this.mPrimaryOrientation.getEndAfterPadding()) {
                    return;
                }
                if (z || i2 <= StaggeredGridLayoutManager2.this.mPrimaryOrientation.getStartAfterPadding()) {
        ...
        public void calculateCachedEnd() {
            ...
            LayoutParams layoutParams = getLayoutParams(view);
            this.mCachedEnd = StaggeredGridLayoutManager2.this.mPrimaryOrientation.getDecoratedEnd(view);
            if (layoutParams.mFullSpan && (fullSpanItem = StaggeredGridLayoutManager2.this.mLazySpanLookup.getFullSpanItem(layoutParams.getViewLayoutPosition())) != null && fullSpanItem.mGapDir == 1) {
        ...
        public void calculateCachedStart() {
            ...
            LayoutParams layoutParams = getLayoutParams(view);
            this.mCachedStart = StaggeredGridLayoutManager2.this.mPrimaryOrientation.getDecoratedStart(view);
            if (layoutParams.mFullSpan && (fullSpanItem = StaggeredGridLayoutManager2.this.mLazySpanLookup.getFullSpanItem(layoutParams.getViewLayoutPosition())) != null && fullSpanItem.mGapDir == -1) {
        ...
        public int findFirstCompletelyVisibleItemPosition() {
            if (StaggeredGridLayoutManager2.this.mReverseLayout) {
        ...
        public int findOnePartiallyOrCompletelyVisibleChild(int i, int i2, boolean z, boolean z2, boolean z3) {
            int startAfterPadding = StaggeredGridLayoutManager2.this.mPrimaryOrientation.getStartAfterPadding();
            int endAfterPadding = StaggeredGridLayoutManager2.this.mPrimaryOrientation.getEndAfterPadding();
            int i3 = i2 > i ? 1 : -1;
            while (i != i2) {
                View view = this.mViews.get(i);
                int decoratedStart = StaggeredGridLayoutManager2.this.mPrimaryOrientation.getDecoratedStart(view);
                int decoratedEnd = StaggeredGridLayoutManager2.this.mPrimaryOrientation.getDecoratedEnd(view);
                boolean z4 = false;
                ...
                if (z5 && z4) {
                    if (!z || !z2) {
                        if (z2) {
                            return StaggeredGridLayoutManager2.this.getPosition(view);
                        }
        ...
        public View getFocusableViewAfter(int i, int i2) {
            ...
            if (i2 != -1) {
                ...
                while (size >= 0) {
                    ...
                    StaggeredGridLayoutManager2 staggeredGridLayoutManager2 = StaggeredGridLayoutManager2.this;
                    if (staggeredGridLayoutManager2.mReverseLayout && staggeredGridLayoutManager2.getPosition(view2) >= i) {
                        break;
                    }
                    StaggeredGridLayoutManager2 staggeredGridLayoutManager22 = StaggeredGridLayoutManager2.this;
                    if ((!staggeredGridLayoutManager22.mReverseLayout && staggeredGridLayoutManager22.getPosition(view2) <= i) || !view2.hasFocusable()) {
                        break;
                    }
                    size--;
                    view = view2;
                ...
                while (i3 < size2) {
                    ...
                    StaggeredGridLayoutManager2 staggeredGridLayoutManager23 = StaggeredGridLayoutManager2.this;
                    if (staggeredGridLayoutManager23.mReverseLayout && staggeredGridLayoutManager23.getPosition(view3) <= i) {
                        break;
                    }
                    StaggeredGridLayoutManager2 staggeredGridLayoutManager24 = StaggeredGridLayoutManager2.this;
                    if ((!staggeredGridLayoutManager24.mReverseLayout && staggeredGridLayoutManager24.getPosition(view3) >= i) || !view3.hasFocusable()) {
                        break;
                    }
                    i3++;
                    view = view3;
        ...
        public void popEnd() {
            ...
            if (layoutParams.isItemRemoved() || layoutParams.isItemChanged()) {
                this.mDeletedSize -= StaggeredGridLayoutManager2.this.mPrimaryOrientation.getDecoratedMeasurement(remove);
            }
            if (size == 1) {
                this.mCachedStart = Integer.MIN_VALUE;
            }
    ...
    public StaggeredGridLayoutManager2(int i, int i2) {
        super(i, i2);
        boolean z = false;
        this.mReverseLayout = false;
        this.mShouldReverseLayout = false;
