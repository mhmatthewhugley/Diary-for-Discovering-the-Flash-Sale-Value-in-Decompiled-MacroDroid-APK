...
import android.support.p004v4.app.C0063a;
...
public final class NotificationManagerCompat {
    ...
    private static class NotifyTask implements Task {
        ...
        public void send(C0063a aVar) throws RemoteException {
            aVar.notify(this.packageName, this.f404id, this.tag, this.notif);
        }

        @NonNull
        public String toString() {
            return "NotifyTask[" + "packageName:" + this.packageName + ", id:" + this.f404id + ", tag:" + this.tag + "]";
        }
    }
    ...
    private static class SideChannelManager implements Handler.Callback, ServiceConnection {
        ...
        private void handleServiceConnected(ComponentName componentName, IBinder iBinder) {
            ListenerRecord listenerRecord = this.mRecordMap.get(componentName);
            if (listenerRecord != null) {
                listenerRecord.service = C0063a.C0064a.asInterface(iBinder);
                listenerRecord.retryCount = 0;
                processListenerQueue(listenerRecord);
            }
        }
    ...
    private interface Task {
        void send(C0063a aVar) throws RemoteException;
    }
    ...
    private static class CancelTask implements Task {
        ...
        public void send(C0063a aVar) throws RemoteException {
            if (this.all) {
                ...
                aVar.cancel(this.packageName, this.f403id, this.tag);
            }
        }

        @NonNull
        public String toString() {
            return "CancelTask[" + "packageName:" + this.packageName + ", id:" + this.f403id + ", tag:" + this.tag + ", all:" + this.all + "]";
        }
