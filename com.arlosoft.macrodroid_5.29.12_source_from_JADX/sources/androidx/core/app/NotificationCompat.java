...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(@Nullable Bitmap bitmap) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0395R.dimen.compat_notification_large_icon_max_width);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0395R.dimen.compat_notification_large_icon_max_height);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            ...
            boolean z2 = true;
            int i = 0;
            RemoteViews applyStandardTemplate = applyStandardTemplate(true, C0395R.C0399layout.notification_template_custom_big, false);
            applyStandardTemplate.removeAllViews(C0395R.C0398id.actions);
            ...
            if (!z || nonContextualActions == null || (min = Math.min(nonContextualActions.size(), 3)) <= 0) {
                ...
                for (int i2 = 0; i2 < min; i2++) {
                    applyStandardTemplate.addView(C0395R.C0398id.actions, generateActionButton(nonContextualActions.get(i2)));
                }
            }
            if (!z2) {
                i = 8;
            }
            applyStandardTemplate.setViewVisibility(C0395R.C0398id.actions, i);
            applyStandardTemplate.setViewVisibility(C0395R.C0398id.action_divider, i);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            if (z) {
                i = C0395R.C0399layout.notification_action_tombstone;
            } else {
                i = C0395R.C0399layout.notification_action;
            }
            RemoteViews remoteViews = new RemoteViews(packageName, i);
            IconCompat iconCompat = action.getIconCompat();
            if (iconCompat != null) {
                remoteViews.setImageViewBitmap(C0395R.C0398id.action_image, createColoredBitmap(iconCompat, this.mBuilder.mContext.getResources().getColor(C0395R.C0396color.notification_action_color_filter)));
            }
            remoteViews.setTextViewText(C0395R.C0398id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0395R.C0398id.action_container, action.actionIntent);
            }
            remoteViews.setContentDescription(C0395R.C0398id.action_container, action.title);
            return remoteViews;
        }
    ...
    public static abstract class Style {
        ...
        private int calculateTopPadding() {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0395R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0395R.dimen.notification_top_pad_large_text);
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0395R.C0397drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0395R.C0398id.title, 8);
            remoteViews.setViewVisibility(C0395R.C0398id.text2, 8);
            remoteViews.setViewVisibility(C0395R.C0398id.text, 8);
        }
        ...
        public android.widget.RemoteViews applyStandardTemplate(boolean r13, int r14, boolean r15) {
            /*
                ...
                int r1 = androidx.core.C0395R.C0398id.icon
                ...
                int r13 = r13.icon
                if (r13 == 0) goto L_0x0091
                int r13 = androidx.core.C0395R.dimen.notification_right_icon_size
                int r13 = r0.getDimensionPixelSize(r13)
                int r1 = androidx.core.C0395R.dimen.notification_small_icon_background_padding
                ...
                int r1 = androidx.core.C0395R.C0398id.right_icon
            ...
            L_0x0060:
                ...
                int r13 = r13.icon
                if (r13 == 0) goto L_0x0091
                int r13 = androidx.core.C0395R.C0398id.icon
                r7.setViewVisibility(r13, r8)
                int r1 = androidx.core.C0395R.dimen.notification_large_icon_width
                int r1 = r0.getDimensionPixelSize(r1)
                int r2 = androidx.core.C0395R.dimen.notification_big_circle_margin
                int r2 = r0.getDimensionPixelSize(r2)
                int r1 = r1 - r2
                int r2 = androidx.core.C0395R.dimen.notification_small_icon_size_as_large
                int r2 = r0.getDimensionPixelSize(r2)
            ...
            L_0x0091:
                ...
                int r1 = androidx.core.C0395R.C0398id.title
            ...
            L_0x009c:
                ...
                int r1 = androidx.core.C0395R.C0398id.text
                r7.setTextViewText(r1, r13)
                r13 = 1
                goto L_0x00ab
            L_0x00aa:
            ...
            L_0x00ab:
                ...
                int r13 = androidx.core.C0395R.C0398id.info
            ...
            L_0x00be:
                ...
                int r13 = androidx.core.C0395R.integer.status_bar_notification_info_maxnum
                int r13 = r0.getInteger(r13)
                androidx.core.app.NotificationCompat$Builder r1 = r12.mBuilder
                int r1 = r1.mNumber
                if (r1 <= r13) goto L_0x00da
                int r13 = androidx.core.C0395R.C0398id.info
                int r1 = androidx.core.C0395R.string.status_bar_notification_info_overflow
                java.lang.String r1 = r0.getString(r1)
                r7.setTextViewText(r13, r1)
                goto L_0x00ec
            L_0x00da:
                java.text.NumberFormat r13 = java.text.NumberFormat.getIntegerInstance()
                int r1 = androidx.core.C0395R.C0398id.info
                androidx.core.app.NotificationCompat$Builder r2 = r12.mBuilder
                int r2 = r2.mNumber
                long r2 = (long) r2
            ...
            L_0x00f8:
                ...
                int r2 = androidx.core.C0395R.C0398id.text
                r7.setTextViewText(r2, r1)
                androidx.core.app.NotificationCompat$Builder r1 = r12.mBuilder
                java.lang.CharSequence r1 = r1.mContentText
                if (r1 == 0) goto L_0x0113
                int r2 = androidx.core.C0395R.C0398id.text2
                r7.setTextViewText(r2, r1)
                r7.setViewVisibility(r2, r8)
                r1 = 1
                goto L_0x0119
            L_0x0113:
                int r1 = androidx.core.C0395R.C0398id.text2
                r7.setViewVisibility(r1, r10)
            L_0x0118:
                r1 = 0
            L_0x0119:
                ...
                int r15 = androidx.core.C0395R.dimen.notification_subtext_size
                int r15 = r0.getDimensionPixelSize(r15)
                float r15 = (float) r15
                int r0 = androidx.core.C0395R.C0398id.text
                r7.setTextViewTextSize(r0, r8, r15)
            L_0x0129:
                int r2 = androidx.core.C0395R.C0398id.line1
                r3 = 0
                r4 = 0
                r5 = 0
                r6 = 0
            ...
            L_0x0133:
                ...
                int r15 = androidx.core.C0395R.C0398id.chronometer
                ...
                goto L_0x0184
            L_0x0172:
                int r14 = androidx.core.C0395R.C0398id.time
            ...
            L_0x0183:
                r9 = r11
            L_0x0184:
                int r14 = androidx.core.C0395R.C0398id.right_side
            ...
            L_0x018c:
                ...
                int r14 = androidx.core.C0395R.C0398id.line3
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            int i = C0395R.C0398id.notification_main_column;
            remoteViews.removeAllViews(i);
            remoteViews.addView(i, remoteViews2.clone());
            remoteViews.setViewVisibility(i, 0);
            remoteViews.setViewPadding(C0395R.C0398id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
        }
    ...
    static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        if (i4 < 23) {
            return new Action(action2.icon, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, i5, z3, isContextual, isAuthenticationRequired);
        }
        if (action.getIcon() == null && (i2 = action2.icon) != 0) {
            return new Action(i2, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, i5, z3, isContextual, isAuthenticationRequired);
        }
        if (action.getIcon() != null) {
            iconCompat = IconCompat.createFromIconOrNullIfZeroResId(action.getIcon());
        }
        return new Action(iconCompat, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, i5, z3, isContextual, isAuthenticationRequired);
    }
