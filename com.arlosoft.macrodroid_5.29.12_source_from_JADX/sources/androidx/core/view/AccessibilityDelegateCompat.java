...
public class AccessibilityDelegateCompat {
    ...
    static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View view) {
        List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> list = (List) view.getTag(C0395R.C0398id.tag_accessibility_actions);
    ...
    private boolean performClickableSpanAction(int i, View view) {
        ...
        SparseArray sparseArray = (SparseArray) view.getTag(C0395R.C0398id.tag_accessibility_clickable_spans);
    ...
    public boolean performAccessibilityAction(@NonNull View view, int i, @Nullable Bundle bundle) {
        ...
        return (z || i != C0395R.C0398id.accessibility_action_clickable_span || bundle == null) ? z : performClickableSpanAction(bundle.getInt(AccessibilityClickableSpanCompat.SPAN_ID, -1), view);
    }
