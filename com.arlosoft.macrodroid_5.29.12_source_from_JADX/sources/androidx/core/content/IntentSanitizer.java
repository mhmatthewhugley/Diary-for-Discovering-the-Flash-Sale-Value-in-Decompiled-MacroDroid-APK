...
public class IntentSanitizer {
    ...
    public static final class Builder {
        ...
        private Predicate<String> mAllowedActions = C0418h.f414a;
        private Predicate<String> mAllowedCategories = C0420j.f416a;
        private Predicate<ClipData> mAllowedClipData = C0433t.f438a;
        private Predicate<Uri> mAllowedClipDataUri = C0415e.f411a;
        private Predicate<ComponentName> mAllowedComponents = C0414d.f410a;
        private Predicate<Uri> mAllowedData = C0416f.f412a;
        private Map<String, Predicate<Object>> mAllowedExtras = new HashMap();
        private int mAllowedFlags;
        private Predicate<String> mAllowedPackages = C0419i.f415a;
        private Predicate<String> mAllowedTypes = C0417g.f413a;
        ...
        public Builder allowAction(@NonNull String str) {
            ...
            allowAction((Predicate<String>) new C0432s(str));
            return this;
        }
        ...
        public Builder allowAnyComponent() {
            ...
            this.mAllowedComponents = C0434u.f439a;
            return this;
        }
        ...
        public Builder allowCategory(@NonNull String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowCategory((Predicate<String>) new C0432s(str));
        }

        @NonNull
        public Builder allowClipData(@NonNull Predicate<ClipData> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedClipData = this.mAllowedClipData.mo6771or(predicate);
            return this;
        }
        ...
        public Builder allowClipDataUri(@NonNull Predicate<Uri> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedClipDataUri = this.mAllowedClipDataUri.mo6771or(predicate);
            return this;
        }
        ...
        public Builder allowClipDataUriWithAuthority(@NonNull String str) {
            Preconditions.checkNotNull(str);
            return allowClipDataUri(new C0426p(str));
        }
        ...
        public Builder allowComponent(@NonNull ComponentName componentName) {
            ...
            return allowComponent((Predicate<ComponentName>) new C0413c(componentName));
        }

        @NonNull
        public Builder allowComponentWithPackage(@NonNull String str) {
            Preconditions.checkNotNull(str);
            return allowComponent((Predicate<ComponentName>) new C0424n(str));
        }

        @NonNull
        public Builder allowData(@NonNull Predicate<Uri> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedData = this.mAllowedData.mo6771or(predicate);
            return this;
        }
        ...
        public Builder allowExtraStreamUriWithAuthority(@NonNull String str) {
            Preconditions.checkNotNull(str);
            allowExtra("android.intent.extra.STREAM", Uri.class, new C0429r(str));
            return this;
        }
        ...
        public Builder allowPackage(@NonNull String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowPackage((Predicate<String>) new C0432s(str));
        }
        ...
        public Builder allowType(@NonNull String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowType((Predicate<String>) new C0432s(str));
        }
        ...
        public <T> Builder allowExtra(@NonNull String str, @NonNull Class<T> cls, @NonNull Predicate<T> predicate) {
            ...
            Preconditions.checkNotNull(predicate);
            return allowExtra(str, (Predicate<Object>) new C0423m(cls, predicate));
        }
        ...
        public Builder allowAction(@NonNull Predicate<String> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedActions = this.mAllowedActions.mo6771or(predicate);
            return this;
        }
        ...
        public Builder allowCategory(@NonNull Predicate<String> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedCategories = this.mAllowedCategories.mo6771or(predicate);
            return this;
        }
        ...
        public Builder allowComponent(@NonNull Predicate<ComponentName> predicate) {
            ...
            this.mAllowedComponents = this.mAllowedComponents.mo6771or(predicate);
            return this;
        }
        ...
        public Builder allowPackage(@NonNull Predicate<String> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedPackages = this.mAllowedPackages.mo6771or(predicate);
            return this;
        }
        ...
        public Builder allowType(@NonNull Predicate<String> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedTypes = this.mAllowedTypes.mo6771or(predicate);
            return this;
        }
        ...
        public Builder allowExtra(@NonNull String str, @NonNull Predicate<Object> predicate) {
            ...
            if (predicate2 == null) {
                predicate2 = C0421k.f417a;
            }
            this.mAllowedExtras.put(str, predicate2.mo6771or(predicate));
            return this;
        }
    }
    ...
    public Intent sanitizeByFiltering(@NonNull Intent intent) {
        return sanitize(intent, C0412b.f408a);
    }

    @NonNull
    public Intent sanitizeByThrowing(@NonNull Intent intent) {
        return sanitize(intent, C0411a.f407a);
    }
