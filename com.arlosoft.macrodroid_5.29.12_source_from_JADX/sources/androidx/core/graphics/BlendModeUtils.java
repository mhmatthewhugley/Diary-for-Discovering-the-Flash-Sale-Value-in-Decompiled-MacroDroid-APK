...
class BlendModeUtils {
    ...
    static /* synthetic */ class C04371 {
        ...
        static {
            ...
            L_0x015c:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.graphics.BlendModeUtils.C04371.<clinit>():void");
        }
    }
    ...
    static class Api29Impl {
        ...
        static Object obtainBlendModeFromCompat(@NonNull BlendModeCompat blendModeCompat) {
            switch (C04371.$SwitchMap$androidx$core$graphics$BlendModeCompat[blendModeCompat.ordinal()]) {
                case 1:
