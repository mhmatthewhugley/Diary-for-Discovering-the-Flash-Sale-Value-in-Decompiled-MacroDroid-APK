...
public class WebMessagePortImpl extends WebMessagePortCompat {
    ...
    private WebMessagePortBoundaryInterface getBoundaryInterface() {
        if (this.mBoundaryInterface == null) {
            this.mBoundaryInterface = (WebMessagePortBoundaryInterface) C15627a.m94878a(WebMessagePortBoundaryInterface.class, WebViewGlueCommunicator.getCompatConverter().convertWebMessagePort(this.mFrameworksImpl));
        }
    ...
    public void postMessage(@NonNull WebMessageCompat webMessageCompat) {
        ...
        if (webViewFeatureInternal.isSupportedByFramework()) {
            ...
            getBoundaryInterface().postMessage(C15627a.m94880c(new WebMessageAdapter(webMessageCompat)));
        } else {
            throw WebViewFeatureInternal.getUnsupportedOperationException();
        }
    }
    ...
    public void setWebMessageCallback(@NonNull final WebMessagePortCompat.WebMessageCallbackCompat webMessageCallbackCompat) {
        ...
        if (webViewFeatureInternal.isSupportedByFramework()) {
            ...
            getBoundaryInterface().setWebMessageCallback(C15627a.m94880c(new WebMessageCallbackAdapter(webMessageCallbackCompat)));
        } else {
            throw WebViewFeatureInternal.getUnsupportedOperationException();
        }
    }
    ...
    public WebMessagePortImpl(InvocationHandler invocationHandler) {
        this.mBoundaryInterface = (WebMessagePortBoundaryInterface) C15627a.m94878a(WebMessagePortBoundaryInterface.class, invocationHandler);
    }
    ...
    public void setWebMessageCallback(Handler handler, @NonNull final WebMessagePortCompat.WebMessageCallbackCompat webMessageCallbackCompat) {
        ...
        if (webViewFeatureInternal.isSupportedByFramework()) {
            ...
            getBoundaryInterface().setWebMessageCallback(C15627a.m94880c(new WebMessageCallbackAdapter(webMessageCallbackCompat)), handler);
        } else {
            throw WebViewFeatureInternal.getUnsupportedOperationException();
        }
    }
