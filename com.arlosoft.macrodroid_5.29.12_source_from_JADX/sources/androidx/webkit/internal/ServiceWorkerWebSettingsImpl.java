...
public class ServiceWorkerWebSettingsImpl extends ServiceWorkerWebSettingsCompat {
    ...
    private ServiceWorkerWebSettingsBoundaryInterface getBoundaryInterface() {
        if (this.mBoundaryInterface == null) {
            this.mBoundaryInterface = (ServiceWorkerWebSettingsBoundaryInterface) C15627a.m94878a(ServiceWorkerWebSettingsBoundaryInterface.class, WebViewGlueCommunicator.getCompatConverter().convertServiceWorkerSettings(this.mFrameworksImpl));
        }
    ...
    public ServiceWorkerWebSettingsImpl(@NonNull InvocationHandler invocationHandler) {
        this.mBoundaryInterface = (ServiceWorkerWebSettingsBoundaryInterface) C15627a.m94878a(ServiceWorkerWebSettingsBoundaryInterface.class, invocationHandler);
    }
}
