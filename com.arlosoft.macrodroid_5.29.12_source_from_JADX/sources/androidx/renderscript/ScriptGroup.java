...
public final class ScriptGroup extends BaseObj {
    ...
    static class C1079IO {
        Allocation mAllocation;
        Script.KernelID mKID;

        C1079IO(Script.KernelID kernelID) {
            this.mKID = kernelID;
        }
    }
    ...
    public static final class Builder {
        ...
        private boolean calcOrderRecurse(Node node, int i) {
            ...
            while (it.hasNext()) {
                ...
                if (fieldID != null) {
                    node2 = findNode(fieldID.mScript);
                } else {
            ...
            if (this.mNodes.size() != 0) {
                ...
                for (int i3 = 0; i3 < this.mNodes.size(); i3++) {
                    ...
                    while (i4 < node.mKernels.size()) {
                        ...
                        if (!z) {
                            arrayList.add(new C1079IO(kernelID));
                        }
                        if (!z2) {
                            arrayList2.add(new C1079IO(kernelID));
                        }
                        i4++;
                        i2 = i5;
                    }
                ...
                if (i2 == this.mKernelCount) {
                    ...
                    scriptGroup.mOutputs = new C1079IO[arrayList2.size()];
                    for (int i9 = 0; i9 < arrayList2.size(); i9++) {
                        scriptGroup.mOutputs[i9] = (C1079IO) arrayList2.get(i9);
                    }
                    scriptGroup.mInputs = new C1079IO[arrayList.size()];
                    for (int i10 = 0; i10 < arrayList.size(); i10++) {
                        scriptGroup.mInputs[i10] = (C1079IO) arrayList.get(i10);
                    }
