...
public class ScriptIntrinsicColorMatrix extends ScriptIntrinsic {
    ...
    public void setAdd(Float4 float4) {
        ...
        float42.f594x = float4.f594x;
        float42.f595y = float4.f595y;
        float42.f596z = float4.f596z;
        float42.f593w = float4.f593w;
        FieldPacker fieldPacker = new FieldPacker(16);
        fieldPacker.addF32(float4.f594x);
        fieldPacker.addF32(float4.f595y);
        fieldPacker.addF32(float4.f596z);
        fieldPacker.addF32(float4.f593w);
    ...
    public void setAdd(float f, float f2, float f3, float f4) {
        ...
        float4.f593w = f4;
        FieldPacker fieldPacker = new FieldPacker(16);
        fieldPacker.addF32(this.mAdd.f594x);
        fieldPacker.addF32(this.mAdd.f595y);
        fieldPacker.addF32(this.mAdd.f596z);
        fieldPacker.addF32(this.mAdd.f593w);
        setVar(1, fieldPacker);
    }
}
