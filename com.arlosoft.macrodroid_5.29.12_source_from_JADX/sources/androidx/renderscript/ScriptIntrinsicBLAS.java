...
public final class ScriptIntrinsicBLAS extends ScriptIntrinsic {
    ...
    static void validateL3(Element element, int i, int i2, int i3, Allocation allocation, Allocation allocation2, Allocation allocation3) {
        ...
        if ((allocation != null && !allocation.getType().getElement().isCompatible(element)) || ((allocation2 != null && !allocation2.getType().getElement().isCompatible(element)) || (allocation3 != null && !allocation3.getType().getElement().isCompatible(element)))) {
            ...
            if (allocation == null || allocation2 == null) {
                ...
                } else if (allocation != null && allocation2 != null && i10 != i6) {
                    throw new RSRuntimeException("Called BLAS with invalid dimensions");
                }
    ...
    public void BNNM(Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3, int i3, int i4) {
        ...
        validateL3(Element.m552U8(this.mRS), 111, 112, 0, allocation, allocation2, allocation3);
        if (i5 < 0 || i5 > 255) {
            ...
            renderScript.nScriptIntrinsicBLAS_BNNM(getID(renderScript), y, y2, x, j3, i, j2, i2, j, i3, i4, isIncSupp);
        }
    }
    ...
    public void CGBMV(int i, int i2, int i3, Float2 float2, Allocation allocation, Allocation allocation2, int i4, Float2 float22, Allocation allocation3, int i5) {
        ...
        RenderScript renderScript = this.mRS;
        int i6 = i;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 64, i6, 0, 0, 0, 0, y, x, 0, float23.f588x, float23.f589y, id, id2, float24.f588x, float24.f589y, id3, i4, i5, i2, i3, isIncSupp);
    }
    ...
    public void CGEMM(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 125, i, i2, 0, 0, 0, i7, i9, i8, float23.f588x, float23.f589y, j3, j2, float24.f588x, float24.f589y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CGEMV(int i, Float2 float2, Allocation allocation, Allocation allocation2, int i2, Float2 float22, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        int i4 = i;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 63, i4, 0, 0, 0, 0, y, x, 0, float23.f588x, float23.f589y, id, id2, float24.f588x, float24.f589y, id3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CGERC(Float2 float2, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 99, 0, 0, 0, 0, 0, y, x, 0, float22.f588x, float22.f589y, id2, id3, 0.0f, 0.0f, j, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void CGERU(Float2 float2, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 98, 0, 0, 0, 0, 0, y, x, 0, float22.f588x, float22.f589y, id2, id3, 0.0f, 0.0f, j, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void CHBMV(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, int i3, Float2 float22, Allocation allocation3, int i4) {
        ...
        if (i2 >= 0) {
            ...
            int i5 = i;
            int i6 = i2;
            renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 96, 0, 0, 0, i5, 0, 0, validateSYR2, i6, float23.f588x, float23.f589y, id, id2, float24.f588x, float24.f589y, id3, i3, i4, 0, 0, isIncSupp);
            return;
        }
    ...
    public void CHEMM(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 137, 0, 0, i, i2, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, float23.f588x, float23.f589y, j3, j2, float24.f588x, float24.f589y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CHEMV(int i, Float2 float2, Allocation allocation, Allocation allocation2, int i2, Float2 float22, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        int i4 = i;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 95, 0, 0, 0, i4, 0, 0, validateSYR2, 0, float23.f588x, float23.f589y, id, id2, float24.f588x, float24.f589y, id3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CHER(int i, float f, Allocation allocation, int i2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 100, 0, 0, 0, i, 0, 0, validateSYR, 0, f, 0.0f, j2, 0, 0.0f, 0.0f, j, i2, 0, 0, 0, isIncSupp);
    }
    ...
    public void CHER2(int i, Float2 float2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        int i4 = i;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 102, 0, 0, 0, i4, 0, 0, validateSYR2, 0, float22.f588x, float22.f589y, id2, id3, 0.0f, 0.0f, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CHER2K(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, float f, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 139, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i5, float22.f588x, float22.f589y, allocation4.getID(this.mRS), j2, f, 0.0f, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CHERK(int i, int i2, float f, Allocation allocation, float f2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 138, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), i5, f, 0.0f, j2, 0, f2, 0.0f, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CHPMV(int i, Float2 float2, Allocation allocation, Allocation allocation2, int i2, Float2 float22, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        int i4 = i;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 97, 0, 0, 0, i4, 0, 0, validateSPR2, 0, float23.f588x, float23.f589y, id, id2, float24.f588x, float24.f589y, id3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CHPR(int i, float f, Allocation allocation, int i2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 101, 0, 0, 0, i, 0, 0, validateSPR, 0, f, 0.0f, j2, 0, 0.0f, 0.0f, j, i2, 0, 0, 0, isIncSupp);
    }
    ...
    public void CHPR2(int i, Float2 float2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        int i4 = i;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 103, 0, 0, 0, i4, 0, 0, validateSPR2, 0, float22.f588x, float22.f589y, id2, id3, 0.0f, 0.0f, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CSYMM(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        if (allocation.getType().getX() == allocation.getType().getY()) {
            ...
            int i3 = i;
            int i4 = i2;
            renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 126, 0, 0, i3, i4, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, float23.f588x, float23.f589y, id, id2, float24.f588x, float24.f589y, id3, 0, 0, 0, 0, isIncSupp);
            return;
        }
    ...
    public void CSYR2K(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 128, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i5, float23.f588x, float23.f589y, j3, j2, float24.f588x, float24.f589y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CSYRK(int i, int i2, Float2 float2, Allocation allocation, Float2 float22, Allocation allocation2) {
        ...
        int i6 = i2;
        int i7 = i;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 127, i6, 0, 0, i7, 0, 0, allocation2.getType().getX(), i5, float23.f588x, float23.f589y, id, 0, float24.f588x, float24.f589y, allocation4.getID(this.mRS), 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CTBMV(int i, int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        if (i4 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 66, i2, 0, 0, i, i3, 0, y, i4, 0.0f, 0.0f, id, id2, 0.0f, 0.0f, 0, i5, 0, 0, 0, isIncSupp);
            return;
        }
    ...
    public void CTBSV(int i, int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        if (i4 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 69, i2, 0, 0, i, i3, 0, y, i4, 0.0f, 0.0f, id, id2, 0.0f, 0.0f, 0, i5, 0, 0, 0, isIncSupp);
            return;
        }
    ...
    public void CTPMV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 67, i2, 0, 0, i, i3, 0, validateTPMV, 0, 0.0f, 0.0f, id, id2, 0.0f, 0.0f, 0, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void CTPSV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 70, i2, 0, 0, i, i3, 0, validateTPMV, 0, 0.0f, 0.0f, id, id2, 0.0f, 0.0f, 0, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void CTRMM(int i, int i2, int i3, int i4, Float2 float2, Allocation allocation, Allocation allocation2) {
        ...
        int i7 = i2;
        int i8 = i4;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 129, i5, 0, i6, i7, i8, allocation2.getType().getY(), allocation2.getType().getX(), 0, float22.f588x, float22.f589y, id, j, 0.0f, 0.0f, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CTRMV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 65, i2, 0, 0, i, i3, 0, y, 0, 0.0f, 0.0f, id, id2, 0.0f, 0.0f, 0, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void CTRSM(int i, int i2, int i3, int i4, Float2 float2, Allocation allocation, Allocation allocation2) {
        ...
        int i7 = i2;
        int i8 = i4;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 130, i5, 0, i6, i7, i8, allocation2.getType().getY(), allocation2.getType().getX(), 0, float22.f588x, float22.f589y, id, j, 0.0f, 0.0f, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CTRSV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 68, i2, 0, 0, i, i3, 0, y, 0, 0.0f, 0.0f, id, id2, 0.0f, 0.0f, 0, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void DGEMM(int i, int i2, double d, Allocation allocation, Allocation allocation2, double d2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 119, i, i2, 0, 0, 0, i6, i8, i7, d, j3, j2, d2, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DSPR(int i, double d, Allocation allocation, int i2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 92, 0, 0, 0, i, 0, 0, validateSPR, 0, d, j2, j, 0.0d, 0, i2, 0, 0, 0, isIncSupp);
    }
    ...
    public void DSYMM(int i, int i2, double d, Allocation allocation, Allocation allocation2, double d2, Allocation allocation3) {
        ...
        if (allocation.getType().getX() == allocation.getType().getY()) {
            ...
            int i3 = i;
            int i4 = i2;
            renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 120, 0, 0, i3, i4, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, d, id, id2, d2, id3, 0, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("Matrix A is not symmetric");
    }
    ...
    public void DSYR(int i, double d, Allocation allocation, int i2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 91, 0, 0, 0, i, 0, 0, validateSYR, 0, d, j2, j, 0.0d, 0, i2, 0, 0, 0, isIncSupp);
    }
    ...
    public void DSYR2K(int i, int i2, double d, Allocation allocation, Allocation allocation2, double d2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 122, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i5, d, j3, j2, d2, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DSYRK(int i, int i2, double d, Allocation allocation, double d2, Allocation allocation2) {
        ...
        int i6 = i2;
        int i7 = i;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 121, i6, 0, 0, i7, 0, 0, allocation2.getType().getX(), i5, d, id, 0, d2, id2, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTBMV(int i, int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        if (i4 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 58, i2, 0, 0, i, i3, 0, y, i4, 0.0d, id, id2, 0.0d, 0, i5, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("K must be greater than or equal to 0");
    }
    ...
    public void DTBSV(int i, int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        if (i4 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 61, i2, 0, 0, i, i3, 0, y, i4, 0.0d, id, id2, 0.0d, 0, i5, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("Number of diagonals must be positive");
    }
    ...
    public void DTPMV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 59, i2, 0, 0, i, i3, 0, validateTPMV, 0, 0.0d, id, id2, 0.0d, 0, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTPSV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 62, i2, 0, 0, i, i3, 0, validateTPMV, 0, 0.0d, id, id2, 0.0d, 0, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTRMM(int i, int i2, int i3, int i4, double d, Allocation allocation, Allocation allocation2) {
        ...
        int i7 = i2;
        int i8 = i4;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 123, i5, 0, i6, i7, i8, allocation2.getType().getY(), allocation2.getType().getX(), 0, d, id, j, 0.0d, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTRMV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 57, i2, 0, 0, i, i3, 0, y, 0, 0.0d, id, id2, 0.0d, 0, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTRSM(int i, int i2, int i3, int i4, double d, Allocation allocation, Allocation allocation2) {
        ...
        int i7 = i2;
        int i8 = i4;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 124, i5, 0, i6, i7, i8, allocation2.getType().getY(), allocation2.getType().getX(), 0, d, id, j, 0.0d, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTRSV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 60, i2, 0, 0, i, i3, 0, y, 0, 0.0d, id, id2, 0.0d, 0, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void SGEMM(int i, int i2, float f, Allocation allocation, Allocation allocation2, float f2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 113, i, i2, 0, 0, 0, i6, i8, i7, f, j3, j2, f2, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void SSPR(int i, float f, Allocation allocation, int i2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 84, 0, 0, 0, i, 0, 0, validateSPR, 0, f, j2, j, 0.0f, 0, i2, 0, 0, 0, isIncSupp);
    }
    ...
    public void SSYMM(int i, int i2, float f, Allocation allocation, Allocation allocation2, float f2, Allocation allocation3) {
        ...
        if (allocation.getType().getX() == allocation.getType().getY()) {
            ...
            int i3 = i;
            int i4 = i2;
            renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 114, 0, 0, i3, i4, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, f, id, id2, f2, id3, 0, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("Matrix A is not symmetric");
    }
    ...
    public void SSYR(int i, float f, Allocation allocation, int i2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 83, 0, 0, 0, i, 0, 0, validateSYR, 0, f, j2, j, 0.0f, 0, i2, 0, 0, 0, isIncSupp);
    }
    ...
    public void SSYR2K(int i, int i2, float f, Allocation allocation, Allocation allocation2, float f2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 116, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i5, f, j3, j2, f2, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void SSYRK(int i, int i2, float f, Allocation allocation, float f2, Allocation allocation2) {
        ...
        int i6 = i2;
        int i7 = i;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 115, i6, 0, 0, i7, 0, 0, allocation2.getType().getX(), i5, f, id, 0, f2, id2, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void STBMV(int i, int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        if (i4 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 50, i2, 0, 0, i, i3, 0, y, i4, 0.0f, id, id2, 0.0f, 0, i5, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("K must be greater than or equal to 0");
    }
    ...
    public void STBSV(int i, int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        if (i4 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 53, i2, 0, 0, i, i3, 0, y, i4, 0.0f, id, id2, 0.0f, 0, i5, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("Number of diagonals must be positive");
    }
    ...
    public void STPMV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 51, i2, 0, 0, i, i3, 0, validateTPMV, 0, 0.0f, id, id2, 0.0f, 0, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void STPSV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 54, i2, 0, 0, i, i3, 0, validateTPMV, 0, 0.0f, id, id2, 0.0f, 0, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void STRMM(int i, int i2, int i3, int i4, float f, Allocation allocation, Allocation allocation2) {
        ...
        int i7 = i2;
        int i8 = i4;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 117, i5, 0, i6, i7, i8, allocation2.getType().getY(), allocation2.getType().getX(), 0, f, id, j, 0.0f, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void STRMV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 49, i2, 0, 0, i, i3, 0, y, 0, 0.0f, id, id2, 0.0f, 0, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void STRSM(int i, int i2, int i3, int i4, float f, Allocation allocation, Allocation allocation2) {
        ...
        int i7 = i2;
        int i8 = i4;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 118, i5, 0, i6, i7, i8, allocation2.getType().getY(), allocation2.getType().getX(), 0, f, id, j, 0.0f, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void STRSV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 52, i2, 0, 0, i, i3, 0, y, 0, 0.0f, id, id2, 0.0f, 0, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZGBMV(int i, int i2, int i3, Double2 double2, Allocation allocation, Allocation allocation2, int i4, Double2 double22, Allocation allocation3, int i5) {
        ...
        RenderScript renderScript = this.mRS;
        int i6 = i;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 72, i6, 0, 0, 0, 0, y, x, 0, double23.f579x, double23.f580y, id, id2, double24.f579x, double24.f580y, id3, i4, i5, i2, i3, isIncSupp);
    }
    ...
    public void ZGEMM(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 131, i, i2, 0, 0, 0, i7, i9, i8, double23.f579x, double23.f580y, j3, j2, double24.f579x, double24.f580y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZGEMV(int i, Double2 double2, Allocation allocation, Allocation allocation2, int i2, Double2 double22, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        int i4 = i;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 71, i4, 0, 0, 0, 0, y, x, 0, double23.f579x, double23.f580y, id, id2, double24.f579x, double24.f580y, id3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZGERC(Double2 double2, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 108, 0, 0, 0, 0, 0, y, x, 0, double22.f579x, double22.f580y, id2, id3, 0.0d, 0.0d, j, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void ZGERU(Double2 double2, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 107, 0, 0, 0, 0, 0, y, x, 0, double22.f579x, double22.f580y, id2, id3, 0.0d, 0.0d, j, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void ZHBMV(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, int i3, Double2 double22, Allocation allocation3, int i4) {
        ...
        if (i2 >= 0) {
            ...
            int i5 = i;
            int i6 = i2;
            renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 105, 0, 0, 0, i5, 0, 0, validateSYR2, i6, double23.f579x, double23.f580y, id, id2, double24.f579x, double24.f580y, id3, i3, i4, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("K must be 0 or greater for HBMV");
    }
    ...
    public void ZHEMM(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 140, 0, 0, i, i2, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, double23.f579x, double23.f580y, j3, j2, double24.f579x, double24.f580y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZHEMV(int i, Double2 double2, Allocation allocation, Allocation allocation2, int i2, Double2 double22, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        int i4 = i;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 104, 0, 0, 0, i4, 0, 0, validateSYR2, 0, double23.f579x, double23.f580y, id, id2, double24.f579x, double24.f580y, id3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZHER(int i, double d, Allocation allocation, int i2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 109, 0, 0, 0, i, 0, 0, validateSYR, 0, d, 0.0d, j2, 0, 0.0d, 0.0d, j, i2, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZHER2(int i, Double2 double2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        int i4 = i;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 111, 0, 0, 0, i4, 0, 0, validateSYR2, 0, double22.f579x, double22.f580y, id2, id3, 0.0d, 0.0d, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZHER2K(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, double d, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 142, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i5, double22.f579x, double22.f580y, allocation4.getID(this.mRS), j2, d, 0.0d, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZHERK(int i, int i2, double d, Allocation allocation, double d2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 141, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), i5, d, 0.0d, j2, 0, d2, 0.0d, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZHPMV(int i, Double2 double2, Allocation allocation, Allocation allocation2, int i2, Double2 double22, Allocation allocation3, int i3) {
        ...
        RenderScript renderScript = this.mRS;
        int i4 = i;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 106, 0, 0, 0, i4, 0, 0, validateSPR2, 0, double23.f579x, double23.f580y, id, id2, double24.f579x, double24.f580y, id3, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZHPR(int i, double d, Allocation allocation, int i2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 110, 0, 0, 0, i, 0, 0, validateSPR, 0, d, 0.0d, j2, 0, 0.0d, 0.0d, j, i2, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZHPR2(int i, Double2 double2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        int i4 = i;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 112, 0, 0, 0, i4, 0, 0, validateSPR2, 0, double22.f579x, double22.f580y, id2, id3, 0.0d, 0.0d, j, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZSYMM(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        if (allocation.getType().getX() == allocation.getType().getY()) {
            ...
            int i3 = i;
            int i4 = i2;
            renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 132, 0, 0, i3, i4, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, double23.f579x, double23.f580y, id, id2, double24.f579x, double24.f580y, id3, 0, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("Matrix A is not symmetric");
    }
    ...
    public void ZSYR2K(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 134, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i5, double23.f579x, double23.f580y, j3, j2, double24.f579x, double24.f580y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZSYRK(int i, int i2, Double2 double2, Allocation allocation, Double2 double22, Allocation allocation2) {
        ...
        int i6 = i2;
        int i7 = i;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 133, i6, 0, 0, i7, 0, 0, allocation2.getType().getX(), i5, double23.f579x, double23.f580y, id, 0, double24.f579x, double24.f580y, allocation4.getID(this.mRS), 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTBMV(int i, int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        if (i4 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 74, i2, 0, 0, i, i3, 0, y, i4, 0.0d, 0.0d, id, id2, 0.0d, 0.0d, 0, i5, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("K must be greater than or equal to 0");
    }
    ...
    public void ZTBSV(int i, int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        if (i4 >= 0) {
            ...
            RenderScript renderScript = this.mRS;
            renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 77, i2, 0, 0, i, i3, 0, y, i4, 0.0d, 0.0d, id, id2, 0.0d, 0.0d, 0, i5, 0, 0, 0, isIncSupp);
            return;
        }
        throw new RSRuntimeException("Number of diagonals must be positive");
    }
    ...
    public void ZTPMV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 75, i2, 0, 0, i, i3, 0, validateTPMV, 0, 0.0d, 0.0d, id, id2, 0.0d, 0.0d, 0, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTPSV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 78, i2, 0, 0, i, i3, 0, validateTPMV, 0, 0.0d, 0.0d, id, id2, 0.0d, 0.0d, 0, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTRMM(int i, int i2, int i3, int i4, Double2 double2, Allocation allocation, Allocation allocation2) {
        ...
        int i7 = i2;
        int i8 = i4;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 135, i5, 0, i6, i7, i8, allocation2.getType().getY(), allocation2.getType().getX(), 0, double22.f579x, double22.f580y, id, j, 0.0d, 0.0d, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTRMV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 73, i2, 0, 0, i, i3, 0, y, 0, 0.0d, 0.0d, id, id2, 0.0d, 0.0d, 0, i4, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTRSM(int i, int i2, int i3, int i4, Double2 double2, Allocation allocation, Allocation allocation2) {
        ...
        int i7 = i2;
        int i8 = i4;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 136, i5, 0, i6, i7, i8, allocation2.getType().getY(), allocation2.getType().getX(), 0, double22.f579x, double22.f580y, id, j, 0.0d, 0.0d, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTRSV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 76, i2, 0, 0, i, i3, 0, y, 0, 0.0d, 0.0d, id, id2, 0.0d, 0.0d, 0, i4, 0, 0, 0, isIncSupp);
    }
}
