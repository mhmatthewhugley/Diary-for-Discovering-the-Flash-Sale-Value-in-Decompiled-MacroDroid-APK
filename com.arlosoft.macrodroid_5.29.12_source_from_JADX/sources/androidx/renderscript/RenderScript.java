...
public class RenderScript {
    ...
    private static androidx.renderscript.RenderScript internalCreate(android.content.Context r10, int r11, androidx.renderscript.RenderScript.ContextType r12, int r13) {
        ...
        L_0x000f:
            ...
            monitor-enter(r10)
            boolean r0 = sInitialized     // Catch:{ all -> 0x01ba }
            r1 = 0
            ...
            java.lang.Class r0 = java.lang.Class.forName(r0)     // Catch:{ Exception -> 0x0058 }
            java.lang.String r6 = "getRuntime"
            java.lang.Class[] r8 = new java.lang.Class[r5]     // Catch:{ Exception -> 0x0058 }
            java.lang.reflect.Method r6 = r0.getDeclaredMethod(r6, r8)     // Catch:{ Exception -> 0x0058 }
            java.lang.Object[] r8 = new java.lang.Object[r5]     // Catch:{ Exception -> 0x0058 }
            java.lang.Object r6 = r6.invoke(r1, r8)     // Catch:{ Exception -> 0x0058 }
            sRuntime = r6     // Catch:{ Exception -> 0x0058 }
            java.lang.String r6 = "registerNativeAllocation"
            java.lang.Class[] r8 = new java.lang.Class[r4]     // Catch:{ Exception -> 0x0058 }
            java.lang.Class r9 = java.lang.Integer.TYPE     // Catch:{ Exception -> 0x0058 }
            r8[r5] = r9     // Catch:{ Exception -> 0x0058 }
            java.lang.reflect.Method r6 = r0.getDeclaredMethod(r6, r8)     // Catch:{ Exception -> 0x0058 }
            registerNativeAllocation = r6     // Catch:{ Exception -> 0x0058 }
            java.lang.String r6 = "registerNativeFree"
            java.lang.Class[] r8 = new java.lang.Class[r4]     // Catch:{ Exception -> 0x0058 }
            r8[r5] = r9     // Catch:{ Exception -> 0x0058 }
            java.lang.reflect.Method r0 = r0.getDeclaredMethod(r6, r8)     // Catch:{ Exception -> 0x0058 }
            registerNativeFree = r0     // Catch:{ Exception -> 0x0058 }
            sUseGCHooks = r4     // Catch:{ Exception -> 0x0058 }
            goto L_0x0061
        L_0x0058:
            java.lang.String r0 = "RenderScript_jni"
            java.lang.String r6 = "No GC methods"
            android.util.Log.e(r0, r6)     // Catch:{ all -> 0x01ba }
            sUseGCHooks = r5     // Catch:{ all -> 0x01ba }
        L_0x0061:
            int r0 = android.os.Build.VERSION.SDK_INT     // Catch:{ UnsatisfiedLinkError -> 0x008e }
            if (r0 >= r3) goto L_0x0080
            java.lang.String r0 = r7.mNativeLibDir     // Catch:{ UnsatisfiedLinkError -> 0x008e }
            if (r0 == 0) goto L_0x0080
            java.lang.StringBuilder r0 = new java.lang.StringBuilder     // Catch:{ UnsatisfiedLinkError -> 0x008e }
            r0.<init>()     // Catch:{ UnsatisfiedLinkError -> 0x008e }
            java.lang.String r6 = r7.mNativeLibDir     // Catch:{ UnsatisfiedLinkError -> 0x008e }
            r0.append(r6)     // Catch:{ UnsatisfiedLinkError -> 0x008e }
            java.lang.String r6 = "/librsjni_androidx.so"
            r0.append(r6)     // Catch:{ UnsatisfiedLinkError -> 0x008e }
            java.lang.String r0 = r0.toString()     // Catch:{ UnsatisfiedLinkError -> 0x008e }
            java.lang.System.load(r0)     // Catch:{ UnsatisfiedLinkError -> 0x008e }
            goto L_0x0085
        L_0x0080:
            java.lang.String r0 = "rsjni_androidx"
            java.lang.System.loadLibrary(r0)     // Catch:{ UnsatisfiedLinkError -> 0x008e }
        L_0x0085:
            sInitialized = r4     // Catch:{ UnsatisfiedLinkError -> 0x008e }
            int r0 = rsnSystemGetPointerSize()     // Catch:{ UnsatisfiedLinkError -> 0x008e }
            sPointerSize = r0     // Catch:{ UnsatisfiedLinkError -> 0x008e }
            goto L_0x00c4
        L_0x008e:
            r11 = move-exception
            java.lang.String r12 = "RenderScript_jni"
            java.lang.StringBuilder r13 = new java.lang.StringBuilder     // Catch:{ all -> 0x01ba }
            r13.<init>()     // Catch:{ all -> 0x01ba }
            java.lang.String r0 = "Error loading RS jni library: "
            r13.append(r0)     // Catch:{ all -> 0x01ba }
            r13.append(r11)     // Catch:{ all -> 0x01ba }
            java.lang.String r13 = r13.toString()     // Catch:{ all -> 0x01ba }
            android.util.Log.e(r12, r13)     // Catch:{ all -> 0x01ba }
            androidx.renderscript.RSRuntimeException r12 = new androidx.renderscript.RSRuntimeException     // Catch:{ all -> 0x01ba }
            java.lang.StringBuilder r13 = new java.lang.StringBuilder     // Catch:{ all -> 0x01ba }
            r13.<init>()     // Catch:{ all -> 0x01ba }
            java.lang.String r0 = "Error loading RS jni library: "
            r13.append(r0)     // Catch:{ all -> 0x01ba }
            ...
            r13.append(r11)     // Catch:{ all -> 0x01ba }
            r13.append(r2)     // Catch:{ all -> 0x01ba }
            java.lang.String r11 = r13.toString()     // Catch:{ all -> 0x01ba }
            r12.<init>(r11)     // Catch:{ all -> 0x01ba }
            throw r12     // Catch:{ all -> 0x01ba }
        L_0x00c4:
            monitor-exit(r10)     // Catch:{ all -> 0x01ba }
        ...
        L_0x00e7:
            ...
            boolean r0 = r7.nLoadSO(r0, r8, r1)
        ...
        L_0x00f5:
            ...
            java.lang.String r10 = r7.mNativeLibDir     // Catch:{ UnsatisfiedLinkError -> 0x011a }
            if (r10 == 0) goto L_0x00ff
            java.lang.System.load(r1)     // Catch:{ UnsatisfiedLinkError -> 0x011a }
            goto L_0x0104
        L_0x00ff:
            java.lang.String r10 = "RSSupport"
            java.lang.System.loadLibrary(r10)     // Catch:{ UnsatisfiedLinkError -> 0x011a }
        L_0x0104:
            boolean r10 = r7.nLoadSO(r5, r8, r1)
            if (r10 == 0) goto L_0x010b
            goto L_0x0158
        L_0x010b:
            java.lang.String r10 = "RenderScript_jni"
            java.lang.String r11 = "Error loading RS Compat library: nLoadSO() failed; Support lib version: 2301"
        ...
        L_0x011a:
            r10 = move-exception
            java.lang.String r11 = "RenderScript_jni"
            java.lang.StringBuilder r12 = new java.lang.StringBuilder
            r12.<init>()
            java.lang.String r13 = "Error loading RS Compat library: "
            r12.append(r13)
            r12.append(r10)
            java.lang.String r13 = " Support lib version: "
            r12.append(r13)
            r12.append(r2)
            ...
            throw r11
        L_0x0158:
            boolean r10 = useIOlib
            if (r10 == 0) goto L_0x0170
            java.lang.String r10 = "RSSupportIO"
            java.lang.System.loadLibrary(r10)     // Catch:{ UnsatisfiedLinkError -> 0x0162 }
            goto L_0x0164
        L_0x0162:
            useIOlib = r5
        L_0x0164:
        ...
        L_0x0170:
            ...
            java.lang.String r10 = "blasV8"
            java.lang.System.loadLibrary(r10)     // Catch:{ UnsatisfiedLinkError -> 0x017a }
            goto L_0x0188
        L_0x017a:
            r10 = move-exception
            java.lang.StringBuilder r0 = new java.lang.StringBuilder
            r0.<init>()
            java.lang.String r1 = "Unable to load BLAS lib, ONLY BNNM will be supported: "
            r0.append(r1)
            r0.append(r10)
        L_0x0188:
            ...
            if (sNative == 1) {
                try {
                    ...
                    if (bundle != null) {
                        ...
                        boolean z = applicationInfo.metaData.getBoolean("androidx.renderscript.EnableBlurWorkaround");
                    }
