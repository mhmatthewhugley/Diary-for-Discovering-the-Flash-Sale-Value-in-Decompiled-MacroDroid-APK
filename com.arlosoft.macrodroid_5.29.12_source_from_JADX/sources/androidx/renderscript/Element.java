...
public class Element extends BaseObj {
    ...
    static /* synthetic */ class C10771 {
        ...
        static {
            ...
            L_0x00a9:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.renderscript.Element.C10771.<clinit>():void");
        }
    }
    ...
    /* renamed from: I8 */
    public static Element m551I8(RenderScript renderScript) {
    ...
    /* renamed from: U8 */
    public static Element m552U8(RenderScript renderScript) {
    ...
    public static Element createPixel(RenderScript renderScript, DataType dataType, DataKind dataKind) {
        if (dataKind != DataKind.PIXEL_L && dataKind != DataKind.PIXEL_A && dataKind != DataKind.PIXEL_LA && dataKind != DataKind.PIXEL_RGB && dataKind != DataKind.PIXEL_RGBA && dataKind != DataKind.PIXEL_DEPTH && dataKind != DataKind.PIXEL_YUV) {
            ...
            int i = C10771.$SwitchMap$androidx$renderscript$Element$DataKind[dataKind.ordinal()];
    ...
    public static Element createVector(RenderScript renderScript, DataType dataType, int i) {
        ...
        switch (C10771.$SwitchMap$androidx$renderscript$Element$DataType[dataType.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
