...
import androidx.databinding.library.C0569R;
...
public abstract class ViewDataBinding extends BaseObservable {
    ...
    static ViewDataBinding getBinding(View view) {
        if (view != null) {
            return (ViewDataBinding) view.getTag(C0569R.C0570id.dataBinding);
        }
        return null;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x0025, code lost:
        if (r0.getLifecycle().getCurrentState().isAtLeast(androidx.lifecycle.Lifecycle.State.STARTED) != false) goto L_0x0028;
     */
    ...
    public void setRootTag(View view) {
        view.setTag(C0569R.C0570id.dataBinding, this);
    }
    ...
    public void setRootTag(View[] viewArr) {
        for (View tag : viewArr) {
            tag.setTag(C0569R.C0570id.dataBinding, this);
        }
    }
