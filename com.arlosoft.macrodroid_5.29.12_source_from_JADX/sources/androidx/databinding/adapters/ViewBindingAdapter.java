...
import androidx.databinding.library.baseAdapters.C0571R;
...
public class ViewBindingAdapter {
    ...
    public static void setOnAttachStateChangeListener(View view, final OnViewDetachedFromWindow onViewDetachedFromWindow, final OnViewAttachedToWindow onViewAttachedToWindow) {
        C05661 r2 = (onViewDetachedFromWindow == null && onViewAttachedToWindow == null) ? null : new View.OnAttachStateChangeListener() {
        ...
        View.OnAttachStateChangeListener onAttachStateChangeListener = (View.OnAttachStateChangeListener) ListenerUtil.trackListener(view, r2, C0571R.C0572id.onAttachStateChangeListener);
