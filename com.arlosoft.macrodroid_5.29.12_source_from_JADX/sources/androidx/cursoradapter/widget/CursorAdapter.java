...
public abstract class CursorAdapter extends BaseAdapter implements Filterable, CursorFilter.CursorFilterClient {
    ...
    public Cursor swapCursor(Cursor cursor) {
        ...
        if (cursor != null) {
            ...
            this.mRowIDColumn = cursor.getColumnIndexOrThrow(Miui3DFaceManagerImpl.TABLE_TEMPLATE_COLUMN_ID);
    ...
    public void init(Context context, Cursor cursor, int i) {
        ...
        this.mRowIDColumn = z ? cursor.getColumnIndexOrThrow(Miui3DFaceManagerImpl.TABLE_TEMPLATE_COLUMN_ID) : -1;
        if ((i & 2) == 2) {
