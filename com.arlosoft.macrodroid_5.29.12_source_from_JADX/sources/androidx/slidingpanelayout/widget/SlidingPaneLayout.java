...
public class SlidingPaneLayout extends ViewGroup {
        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (i18 == -2) {
                    ...
                    i12 = Integer.MIN_VALUE;
                    if (i18 == -1) {
                        i11 = View.MeasureSpec.makeMeasureSpec(paddingLeft - i17, BasicMeasure.EXACTLY);
                    } else {
                        i11 = View.MeasureSpec.makeMeasureSpec(i18, BasicMeasure.EXACTLY);
                    }
                }
                ...
                if (i19 == -2) {
                    ...
                    if (i19 == -1) {
                        i14 = View.MeasureSpec.makeMeasureSpec(i3, BasicMeasure.EXACTLY);
                    } else {
                        i14 = View.MeasureSpec.makeMeasureSpec(i19, BasicMeasure.EXACTLY);
                    }
                    i13 = i14;
                }
                        ...
                        if (!z2 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                if (layoutParams2.width == 0) {
                                    ...
                                    if (i22 == -2) {
                                        ...
                                        i8 = View.MeasureSpec.makeMeasureSpec(i22, BasicMeasure.EXACTLY);
                                    }
                                } else {
                                ...
                                if (z2) {
                                    ...
                                    i6 = i20;
                                    int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i23, BasicMeasure.EXACTLY);
                                    if (i7 != i23) {
                                    ...
                                    i6 = i20;
                                    childAt2.measure(View.MeasureSpec.makeMeasureSpec(i7 + ((int) ((layoutParams2.weight * ((float) Math.max(0, i15))) / f2)), BasicMeasure.EXACTLY), i8);
                                    i21++;
                                    i20 = i6;
                                    i5 = 8;
                                }
                            ...
                            if (z4) {
                                ...
                                if (i24 == -2) {
                                    ...
                                    i9 = BasicMeasure.EXACTLY;
                                    i10 = View.MeasureSpec.makeMeasureSpec(i24, BasicMeasure.EXACTLY);
                                }
                            } else {
                                i9 = BasicMeasure.EXACTLY;
    ...
    public void setParallaxDistance(@C0144Px int i) {
        this.mParallaxBy = i;
        requestLayout();
    }
