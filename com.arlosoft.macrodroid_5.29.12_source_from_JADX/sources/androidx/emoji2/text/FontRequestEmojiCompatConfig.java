...
public class FontRequestEmojiCompatConfig extends EmojiCompat.Config {
    ...
    private static class FontRequestMetadataLoader implements EmojiCompat.MetadataRepoLoader {
        ...
        private void scheduleRetry(Uri uri, long j) {
            synchronized (this.mLock) {
                ...
                if (this.mObserver == null) {
                    C06101 r2 = new ContentObserver(handler) {
                ...
                if (this.mMainHandlerLoadCallback == null) {
                    this.mMainHandlerLoadCallback = new C0615e(this);
                }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:30:?, code lost:
            androidx.core.p007os.TraceCompat.beginSection(S_TRACE_BUILD_TYPEFACE);
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:35:?, code lost:
            androidx.core.p007os.TraceCompat.endSection();
            r1 = r8.mLock;
         */
        ...
        public void createMetadata() {
            ...
            L_0x0034:
                ...
                androidx.core.p007os.TraceCompat.beginSection(r1)     // Catch:{ all -> 0x0073 }
                ...
                androidx.core.p007os.TraceCompat.endSection()     // Catch:{ all -> 0x0094 }
        ...
        public void loadInternal() {
            synchronized (this.mLock) {
                if (this.mCallback != null) {
                    ...
                    this.mExecutor.execute(new C0614d(this));
                }
            }
        }
