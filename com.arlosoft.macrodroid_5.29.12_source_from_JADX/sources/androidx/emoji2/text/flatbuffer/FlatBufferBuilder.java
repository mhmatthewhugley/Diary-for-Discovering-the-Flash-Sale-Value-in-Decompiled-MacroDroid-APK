...
public class FlatBufferBuilder {
    ...
    public void clear() {
        this.space = this.f534bb.capacity();
        this.f534bb.clear();
        this.minalign = 1;
        while (true) {
    ...
    public int createString(CharSequence charSequence) {
        ...
        this.space = i;
        byteBuffer.position(i);
        this.utf8.encodeUtf8(charSequence, this.f534bb);
        return endVector();
    }
    ...
    public ByteBuffer createUnintializedVector(int i, int i2, int i3) {
        ...
        ByteBuffer order = this.f534bb.slice().order(ByteOrder.LITTLE_ENDIAN);
        order.limit(i4);
        return order;
    }
    ...
    public int endTable() {
        ...
        while (true) {
            ...
            int capacity = this.f534bb.capacity() - this.vtables[i4];
            int i5 = this.space;
            short s = this.f534bb.getShort(capacity);
            if (s == this.f534bb.getShort(i5)) {
                int i6 = 2;
                while (i6 < s) {
                    if (this.f534bb.getShort(capacity + i6) == this.f534bb.getShort(i5 + i6)) {
                        i6 += 2;
                    }
                }
                i = this.vtables[i4];
        ...
        if (i != 0) {
            int capacity2 = this.f534bb.capacity() - offset;
            this.space = capacity2;
            this.f534bb.putInt(capacity2, i - offset);
        } else {
    ...
    public void finish(int i, boolean z) {
        ...
        addOffset(i);
        if (z) {
            addInt(this.f534bb.capacity() - this.space);
        }
        this.f534bb.position(this.space);
        this.finished = true;
    }
    ...
    public FlatBufferBuilder init(ByteBuffer byteBuffer, ByteBufferFactory byteBufferFactory) {
        ...
        this.f534bb = byteBuffer;
        byteBuffer.clear();
        this.f534bb.order(ByteOrder.LITTLE_ENDIAN);
        this.minalign = 1;
        this.space = this.f534bb.capacity();
        this.vtable_in_use = 0;
        this.nested = false;
    ...
    public int offset() {
        return this.f534bb.capacity() - this.space;
    }
    ...
    public void required(int i, int i2) {
        int capacity = this.f534bb.capacity() - i;
        if (!(this.f534bb.getShort((capacity - this.f534bb.getInt(capacity)) + i2) != 0)) {
    ...
    public byte[] sizedByteArray(int i, int i2) {
        ...
        this.f534bb.position(i);
        this.f534bb.get(bArr);
        return bArr;
    }

    public InputStream sizedInputStream() {
        finished();
        ByteBuffer duplicate = this.f534bb.duplicate();
        duplicate.position(this.space);
        duplicate.limit(this.f534bb.capacity());
    ...
    public FlatBufferBuilder(int i, ByteBufferFactory byteBufferFactory, ByteBuffer byteBuffer, Utf8 utf82) {
        ...
        if (byteBuffer != null) {
            ...
            this.f534bb = byteBufferFactory.newByteBuffer(i);
        }
        this.utf8 = utf82;
        this.space = this.f534bb.capacity();
    }
    ...
    public byte[] sizedByteArray() {
        return sizedByteArray(this.space, this.f534bb.capacity() - this.space);
    }
    ...
    public int createString(ByteBuffer byteBuffer) {
        ...
        ByteBuffer byteBuffer2 = this.f534bb;
        int i = this.space - remaining;
        this.space = i;
        byteBuffer2.position(i);
        this.f534bb.put(byteBuffer);
        return endVector();
    }
