...
public class FlexBuffers {
    ...
    public static class Blob extends Sized {
        ...
        public ByteBuffer data() {
            ByteBuffer wrap = ByteBuffer.wrap(this.f535bb.data());
        ...
        public byte get(int i) {
            return this.f535bb.get(this.end + i);
        }
        ...
        public byte[] getBytes() {
            ...
            for (int i = 0; i < size; i++) {
                bArr[i] = this.f535bb.get(this.end + i);
            }
            return bArr;
        }
        ...
        public String toString() {
            return this.f535bb.getString(this.end, size());
        }

        public StringBuilder toString(StringBuilder sb) {
            sb.append('\"');
            sb.append(this.f535bb.getString(this.end, size()));
            sb.append('\"');
            return sb;
        }
    }
    ...
    public static class Key extends Object {
        ...
        public String toString() {
            int i = this.end;
            while (this.f535bb.get(i) != 0) {
                i++;
            }
            int i2 = this.end;
            return this.f535bb.getString(i2, i - i2);
        }
    }
    ...
    public static class KeyVector {
        ...
        public Key get(int i) {
            ...
            ReadBuf readBuf = typedVector2.f535bb;
    ...
    public static class Map extends Vector {
        ...
        public Vector values() {
            return new Vector(this.f535bb, this.end, this.byteWidth);
        }
    ...
    public static class Reference {
        ...
        public double asFloat() {
            int i = this.type;
            if (i == 3) {
                return FlexBuffers.readDouble(this.f536bb, this.end, this.parentWidth);
            }
            if (i == 1) {
                return (double) FlexBuffers.readInt(this.f536bb, this.end, this.parentWidth);
            }
            if (i != 2) {
                if (i == 5) {
            ...
            return (double) FlexBuffers.readUInt(this.f536bb, this.end, this.parentWidth);
        }
        ...
        public int asInt() {
            ...
            int i = this.type;
            if (i == 1) {
                return FlexBuffers.readInt(this.f536bb, this.end, this.parentWidth);
            }
            if (i == 2) {
                access$300 = FlexBuffers.readUInt(this.f536bb, this.end, this.parentWidth);
            } else if (i == 3) {
                return (int) FlexBuffers.readDouble(this.f536bb, this.end, this.parentWidth);
            } else {
                if (i == 5) {
        ...
        public long asLong() {
            int i = this.type;
            if (i == 1) {
                return FlexBuffers.readLong(this.f536bb, this.end, this.parentWidth);
            }
            if (i == 2) {
                return FlexBuffers.readUInt(this.f536bb, this.end, this.parentWidth);
            }
            if (i == 3) {
                return (long) FlexBuffers.readDouble(this.f536bb, this.end, this.parentWidth);
            }
            if (i == 5) {
                try {
                ...
                return (long) FlexBuffers.readInt(this.f536bb, this.end, this.parentWidth);
            }
        }
        ...
        public String asString() {
            if (isString()) {
                int access$200 = FlexBuffers.indirect(this.f536bb, this.end, this.parentWidth);
                ReadBuf readBuf = this.f536bb;
                int i = this.byteWidth;
                return this.f536bb.getString(access$200, (int) FlexBuffers.readUInt(readBuf, access$200 - i, i));
            } else if (!isKey()) {
                return "";
            } else {
                int access$2002 = FlexBuffers.indirect(this.f536bb, this.end, this.byteWidth);
                int i2 = access$2002;
                while (this.f536bb.get(i2) != 0) {
                    i2++;
                }
                return this.f536bb.getString(access$2002, i2 - access$2002);
            }
        }
    ...
    private static abstract class Sized extends Object {
        ...
        Sized(ReadBuf readBuf, int i, int i2) {
            super(readBuf, i, i2);
            this.size = FlexBuffers.readInt(this.f535bb, i - i2, i2);
        }
    ...
    public static class TypedVector extends Vector {
        ...
        public Reference get(int i) {
            ...
            return new Reference(this.f535bb, this.end + (i * this.byteWidth), this.byteWidth, 1, this.elemType);
        }
    ...
    public static class Vector extends Sized {
        ...
        public Reference get(int i) {
            ...
            int byteToUnsignedInt = Unsigned.byteToUnsignedInt(this.f535bb.get((int) (((long) this.end) + (size * ((long) this.byteWidth)) + j)));
            return new Reference(this.f535bb, this.end + (i * this.byteWidth), this.byteWidth, byteToUnsignedInt);
        }
