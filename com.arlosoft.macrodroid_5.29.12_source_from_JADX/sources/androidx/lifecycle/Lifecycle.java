...
public abstract class Lifecycle {
    ...
    static /* synthetic */ class C07201 {
        ...
        static {
            ...
            L_0x008d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.lifecycle.Lifecycle.C07201.<clinit>():void");
        }
    }
    ...
    public enum Event {
        ...
        public static Event downFrom(@NonNull State state) {
            int i = C07201.$SwitchMap$androidx$lifecycle$Lifecycle$State[state.ordinal()];
            if (i == 1) {
                return ON_DESTROY;
            }
            if (i == 2) {
        ...
        public State getTargetState() {
            switch (C07201.$SwitchMap$androidx$lifecycle$Lifecycle$Event[ordinal()]) {
                case 1:
                case 2:
