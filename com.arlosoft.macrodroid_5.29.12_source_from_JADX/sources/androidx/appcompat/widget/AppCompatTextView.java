...
public class AppCompatTextView extends TextView implements TintableBackgroundView, TintableCompoundDrawablesView, AutoSizeableTextView, EmojiCompatConfigurationView {
    ...
    public void setFirstBaselineToTopHeight(@C0144Px @IntRange(from = 0) int i) {
    ...
    public void setLastBaselineToBottomHeight(@C0144Px @IntRange(from = 0) int i) {
        if (Build.VERSION.SDK_INT >= 28) {
    ...
    public void setLineHeight(@C0144Px @IntRange(from = 0) int i) {
