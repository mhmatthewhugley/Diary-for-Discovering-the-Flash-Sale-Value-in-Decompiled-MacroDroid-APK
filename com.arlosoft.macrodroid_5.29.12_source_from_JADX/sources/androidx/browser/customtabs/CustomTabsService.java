...
import android.support.customtabs.C0051b;
...
public abstract class CustomTabsService extends Service {
    ...
    private C0051b.C0052a mBinder = new C0051b.C0052a() {
        @Nullable
        ...
        private boolean newSessionInternal(@NonNull C0048a aVar, @Nullable PendingIntent pendingIntent) {
            CustomTabsSessionToken customTabsSessionToken = new CustomTabsSessionToken(aVar, pendingIntent);
            try {
                C0303a aVar2 = new C0303a(this, customTabsSessionToken);
        ...
        public boolean mayLaunchUrl(@Nullable C0048a aVar, @Nullable Uri uri, @Nullable Bundle bundle, @Nullable List<Bundle> list) {
            return CustomTabsService.this.mayLaunchUrl(new CustomTabsSessionToken(aVar, getSessionIdFromBundle(bundle)), uri, bundle, list);
        }

        public boolean newSession(@NonNull C0048a aVar) {
            return newSessionInternal(aVar, (PendingIntent) null);
        }

        public boolean newSessionWithExtras(@NonNull C0048a aVar, @Nullable Bundle bundle) {
            return newSessionInternal(aVar, getSessionIdFromBundle(bundle));
        }

        public int postMessage(@NonNull C0048a aVar, @NonNull String str, @Nullable Bundle bundle) {
            return CustomTabsService.this.postMessage(new CustomTabsSessionToken(aVar, getSessionIdFromBundle(bundle)), str, bundle);
        }

        public boolean receiveFile(@NonNull C0048a aVar, @NonNull Uri uri, int i, @Nullable Bundle bundle) {
            return CustomTabsService.this.receiveFile(new CustomTabsSessionToken(aVar, getSessionIdFromBundle(bundle)), uri, i, bundle);
        }

        public boolean requestPostMessageChannel(@NonNull C0048a aVar, @NonNull Uri uri) {
            return CustomTabsService.this.requestPostMessageChannel(new CustomTabsSessionToken(aVar, (PendingIntent) null), uri);
        }

        public boolean requestPostMessageChannelWithExtras(@NonNull C0048a aVar, @NonNull Uri uri, @NonNull Bundle bundle) {
        ...
        public boolean updateVisuals(@NonNull C0048a aVar, @Nullable Bundle bundle) {
            return CustomTabsService.this.updateVisuals(new CustomTabsSessionToken(aVar, getSessionIdFromBundle(bundle)), bundle);
        }

        public boolean validateRelationship(@NonNull C0048a aVar, int i, @NonNull Uri uri, @Nullable Bundle bundle) {
