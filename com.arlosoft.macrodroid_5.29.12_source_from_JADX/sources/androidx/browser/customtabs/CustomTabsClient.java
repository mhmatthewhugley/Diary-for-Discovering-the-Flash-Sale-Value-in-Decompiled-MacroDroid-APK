...
public class CustomTabsClient {
    ...
    private final C0051b mService;
    private final ComponentName mServiceComponentName;

    CustomTabsClient(C0051b bVar, ComponentName componentName, Context context) {
        this.mService = bVar;
    ...
    private C0048a.C0049a createCallbackWrapper(@Nullable final CustomTabsCallback customTabsCallback) {
        return new C0048a.C0049a() {
    ...
    private CustomTabsSession newSessionInternal(@Nullable CustomTabsCallback customTabsCallback, @Nullable PendingIntent pendingIntent) {
        boolean z;
        C0048a.C0049a createCallbackWrapper = createCallbackWrapper(customTabsCallback);
