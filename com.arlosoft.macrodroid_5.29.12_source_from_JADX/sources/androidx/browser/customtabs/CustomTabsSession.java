...
public final class CustomTabsSession {
    ...
    private final C0048a mCallback;
    ...
    static class MockSession extends C0051b.C0052a {
        MockSession() {
        }
    ...
    CustomTabsSession(C0051b bVar, C0048a aVar, ComponentName componentName, @Nullable PendingIntent pendingIntent) {
        this.mService = bVar;
        this.mCallback = aVar;
