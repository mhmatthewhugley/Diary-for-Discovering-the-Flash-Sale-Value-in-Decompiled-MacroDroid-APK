...
import android.support.customtabs.trusted.C0060b;
...
public final class TrustedWebActivityServiceConnection {
    ...
    TrustedWebActivityServiceConnection(@NonNull C0060b bVar, @NonNull ComponentName componentName) {
        this.mService = bVar;
    ...
    @Nullable
    private static C0057a wrapCallback(@Nullable final TrustedWebActivityCallback trustedWebActivityCallback) {
    ...
    public Bundle sendExtraCommand(@NonNull String str, @NonNull Bundle bundle, @Nullable TrustedWebActivityCallback trustedWebActivityCallback) throws RemoteException {
        IBinder iBinder;
        C0057a wrapCallback = wrapCallback(trustedWebActivityCallback);
