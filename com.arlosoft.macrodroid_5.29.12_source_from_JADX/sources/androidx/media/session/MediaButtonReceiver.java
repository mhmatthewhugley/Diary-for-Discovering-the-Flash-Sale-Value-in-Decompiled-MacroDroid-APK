...
public class MediaButtonReceiver extends BroadcastReceiver {
    ...
    private static class MediaButtonConnectionCallback extends MediaBrowserCompat.C0070c {
        ...
        private void finish() {
            this.mMediaBrowser.mo238b();
            this.mPendingResult.finish();
        }

        public void onConnected() {
            new MediaControllerCompat(this.mContext, this.mMediaBrowser.mo239c()).mo311a((KeyEvent) this.mIntent.getParcelableExtra("android.intent.extra.KEY_EVENT"));
            finish();
        }
    ...
    public static KeyEvent handleIntent(MediaSessionCompat mediaSessionCompat, Intent intent) {
        ...
        mediaSessionCompat.mo347b().mo311a(keyEvent);
        return keyEvent;
    }
    ...
    public static PendingIntent buildMediaButtonPendingIntent(Context context, ComponentName componentName, long j) {
        ...
        int b = PlaybackStateCompat.m301b(j);
        if (b == 0) {
        ...
        return PendingIntent.getBroadcast(context, b, intent, MediaSessionCompat.f252b);
    }
}
