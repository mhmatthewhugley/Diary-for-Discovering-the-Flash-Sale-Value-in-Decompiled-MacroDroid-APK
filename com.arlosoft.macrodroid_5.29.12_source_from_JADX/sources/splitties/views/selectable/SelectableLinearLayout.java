...
public class SelectableLinearLayout extends LinearLayout {
    ...
    public /* synthetic */ SelectableLinearLayout(Context context, AttributeSet attributeSet, int i, int i2, C13695i iVar) {
    ...
    public void dispatchDrawableHotspotChanged(float f, float f2) {
        ...
        Drawable drawable = this.f69222a;
        if (drawable != null) {
    ...
    public final void setForegroundSelector(Drawable drawable) {
        Drawable drawable2 = this.f69222a;
        if (drawable2 != null) {
            drawable2.setCallback((Drawable.Callback) null);
        }
        this.f69222a = drawable;
        if (drawable != null) {
    ...
    public boolean verifyDrawable(Drawable drawable) {
        ...
        return drawable == this.f69222a || super.verifyDrawable(drawable);
    }
