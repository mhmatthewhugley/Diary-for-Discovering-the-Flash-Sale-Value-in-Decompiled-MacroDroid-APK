...
public class ExtendableSavedState extends AbsSavedState {
    ...
    /* renamed from: a */
    public final SimpleArrayMap<String, Bundle> f50294a;

    @NonNull
    public String toString() {
        return "ExtendableSavedState{" + Integer.toHexString(System.identityHashCode(this)) + " states=" + this.f50294a + "}";
    }
    ...
    public void writeToParcel(@NonNull Parcel parcel, int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            strArr[i2] = this.f50294a.keyAt(i2);
            bundleArr[i2] = this.f50294a.valueAt(i2);
        }
    ...
    public ExtendableSavedState(Parcelable parcelable) {
        super(parcelable);
        this.f50294a = new SimpleArrayMap<>();
    }
    ...
    private ExtendableSavedState(@NonNull Parcel parcel, ClassLoader classLoader) {
        ...
        this.f50294a = new SimpleArrayMap<>(readInt);
        for (int i = 0; i < readInt; i++) {
            this.f50294a.put(strArr[i], bundleArr[i]);
        }
    }
}
