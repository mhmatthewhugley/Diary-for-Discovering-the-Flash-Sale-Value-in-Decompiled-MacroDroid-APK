...
final class zzgul extends zzguk {
    ...
    public final int mo47532a(int r12, byte[] r13, int r14, int r15) {
        /*
            r11 = this;
            r0 = -19
            r1 = -62
        ...
        L_0x0022:
            ...
            goto L_0x0039
        L_0x0034:
            int r12 = com.google.android.gms.internal.ads.zzgun.m53480k(r8, r14)
            return r12
        L_0x0039:
        ...
        L_0x004b:
            ...
            goto L_0x0061
        L_0x005a:
            int r12 = com.google.android.gms.internal.ads.zzgun.m53480k(r8, r9)
            return r12
        L_0x005f:
            int r12 = r12 >> 16
        L_0x0061:
            ...
            goto L_0x0072
        L_0x006d:
            int r12 = com.google.android.gms.internal.ads.zzgun.m53481l(r8, r9, r14)
            return r12
        L_0x0072:
        ...
        L_0x00ad:
            ...
            int r3 = com.google.android.gms.internal.ads.zzgun.m53472c(r13, r12, r15)
            goto L_0x00f2
        L_0x00b8:
            int r8 = r12 + 1
            byte r12 = r13[r12]
        ...
        L_0x00f3:
            ...
            goto L_0x0094
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzgul.mo47532a(int, byte[], int, int):int");
    }

    /* access modifiers changed from: package-private */
    /* renamed from: b */
    public final String mo47533b(byte[] bArr, int i, int i2) throws zzgrq {
        int i3;
        ...
        if ((i | i2 | ((length - i) - i2)) >= 0) {
            ...
            while (r12 < i4) {
                ...
                if (zzguj.m53460d(b2)) {
                ...
                } else if (zzguj.m53462f(b2)) {
                    if (i6 < i4) {
                        zzguj.m53459c(b2, bArr[i6], cArr, i3);
                        r12 = i6 + 1;
                        i3++;
                    } else {
                        throw zzgrq.m53035d();
                    }
                } else if (zzguj.m53461e(b2)) {
                    if (i6 < i4 - 1) {
                        int i8 = i6 + 1;
                        zzguj.m53458b(b2, bArr[i6], bArr[i8], cArr, i3);
                        r12 = i8 + 1;
                        i3++;
                    } else {
                        throw zzgrq.m53035d();
                    ...
                    int i9 = i6 + 1;
                    int i10 = i9 + 1;
                    zzguj.m53457a(b2, bArr[i6], bArr[i9], bArr[i10], cArr, i3);
                    i3 += 2;
                    r12 = i10 + 1;
                } else {
                    throw zzgrq.m53035d();
