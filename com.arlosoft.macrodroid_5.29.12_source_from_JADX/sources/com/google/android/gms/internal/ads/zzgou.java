...
public final class zzgou implements zzghu {
    ...
    /* renamed from: a */
    private final ThreadLocal f36980a;
    ...
    public zzgou(java.lang.String r6, java.security.Key r7) throws java.security.GeneralSecurityException {
        /*
            ...
            r5.f36980a = r0
            r1 = 2
            boolean r2 = com.google.android.gms.internal.ads.zzgds.m51728a(r1)
    ...
    public final byte[] mo46821a(byte[] bArr, int i) throws GeneralSecurityException {
        if (i <= this.f36983d) {
            ((Mac) this.f36980a.get()).update(bArr);
            return Arrays.copyOf(((Mac) this.f36980a.get()).doFinal(), i);
        }
