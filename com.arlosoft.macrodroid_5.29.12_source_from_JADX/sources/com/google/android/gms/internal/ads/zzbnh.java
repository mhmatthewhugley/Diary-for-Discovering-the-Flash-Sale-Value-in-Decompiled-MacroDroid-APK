...
public abstract class zzbnh extends zzasa implements zzbni {
    ...
    /* renamed from: Jb */
    public static zzbni m43801Jb(IBinder iBinder) {
        if (iBinder == null) {
            return null;
        }
    ...
    public final boolean mo19892Ib(int r3, android.os.Parcel r4, android.os.Parcel r5, int r6) throws android.os.RemoteException {
        ...
        L_0x002d:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzbnh.mo19892Ib(int, android.os.Parcel, android.os.Parcel, int):boolean");
    }
}
