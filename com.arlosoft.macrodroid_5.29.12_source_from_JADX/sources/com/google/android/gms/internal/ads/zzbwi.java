...
final class zzbwi implements MediationAdLoadCallback {
    ...
    /* renamed from: a */
    final /* synthetic */ zzbvq f27879a;

    /* renamed from: b */
    final /* synthetic */ zzbwj f27880b;
    ...
    public final void mo20475a(AdError adError) {
        try {
            String canonicalName = this.f27880b.f27882a.getClass().getCanonicalName();
            ...
            this.f27879a.mo43086u2(adError.mo19648d());
            this.f27879a.mo43078f2(adError.mo19645a(), adError.mo19647c());
            this.f27879a.mo43088x(adError.mo19645a());
