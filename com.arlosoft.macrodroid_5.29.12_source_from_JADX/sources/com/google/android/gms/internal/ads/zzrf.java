...
public final class zzrf {
    ...
    /* renamed from: a */
    private static final Pattern f38343a = Pattern.compile("^\\D?(\\d+)$");
    @GuardedBy("MediaCodecUtil.class")

    /* renamed from: b */
    private static final HashMap f38344b = new HashMap();

    /* renamed from: c */
    private static int f38345c = -1;

    /* renamed from: d */
    public static final /* synthetic */ int f38346d = 0;

    /* renamed from: a */
    public static int m54722a() throws zzqz {
        int i;
        int i2 = f38345c;
        if (i2 == -1) {
            zzqn c = m54724c("video/avc", false, false);
            if (c != null) {
                int i3 = 0;
                for (MediaCodecInfo.CodecProfileLevel codecProfileLevel : c.mo48071g()) {
                ...
                i2 = Math.max(i3, zzen.f34500a >= 21 ? 345600 : 172800);
            } else {
                i2 = 0;
            }
            f38345c = i2;
    ...
    public static android.util.Pair m54723b(com.google.android.gms.internal.ads.zzaf r17) {
        /*
            r0 = r17
            java.lang.String r1 = r0.f24210i
            r2 = 0
        ...
        L_0x0008:
            ...
            java.lang.String r3 = r0.f24213l
            ...
            java.lang.String r0 = r0.f24210i
            int r3 = r1.length
        ...
        L_0x0040:
            ...
            goto L_0x01f8
        L_0x0043:
            java.util.regex.Pattern r3 = f38343a
            r2 = r1[r6]
        ...
        L_0x026a:
            ...
            java.lang.String r3 = com.google.android.gms.internal.ads.zzbt.m44091d(r3)     // Catch:{ NumberFormatException -> 0x02d5 }
        ...
        L_0x02e3:
            return r2
        L_0x02e4:
            java.lang.String r2 = r0.f24210i
            com.google.android.gms.internal.ads.zzq r0 = r0.f24225x
            int r11 = r1.length
        ...
        L_0x03ec:
            ...
            goto L_0x0639
        L_0x03ef:
            java.util.regex.Pattern r2 = f38343a
            r8 = r1[r6]
        ...
        L_0x081f:
            ...
            com.google.android.gms.internal.ads.zzdw.m48255e(r4, r1)     // Catch:{ NumberFormatException -> 0x0835 }
            goto L_0x0736
        L_0x0835:
            java.lang.String r0 = java.lang.String.valueOf(r0)
            java.lang.String r1 = "Ignoring malformed AVC codec string: "
        ...
        L_0x0844:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzrf.m54723b(com.google.android.gms.internal.ads.zzaf):android.util.Pair");
    }

    @Nullable
    /* renamed from: c */
    public static zzqn m54724c(String str, boolean z, boolean z2) throws zzqz {
        List f = m54727f(str, false, false);
        if (f.isEmpty()) {
            return null;
        }
        return (zzqn) f.get(0);
    ...
    @Nullable
    /* renamed from: d */
    public static zzqn m54725d() throws zzqz {
        return m54724c("audio/raw", false, false);
    }

    @Nullable
    /* renamed from: e */
    public static String m54726e(zzaf zzaf) {
        Pair b;
        if ("audio/eac3-joc".equals(zzaf.f24213l)) {
            return "audio/eac3";
        }
        if (!"video/dolby-vision".equals(zzaf.f24213l) || (b = m54723b(zzaf)) == null) {
            return null;
        }
    ...
    /* renamed from: f */
    public static synchronized List m54727f(String str, boolean z, boolean z2) throws zzqz {
        zzra zzra;
        String str2 = str;
        boolean z3 = z;
        boolean z4 = z2;
        synchronized (zzrf.class) {
            ...
            ArrayList h = m54729h(zzqx, zzra);
            if (z3 && h.isEmpty() && i >= 21 && i <= 23) {
                h = m54729h(zzqx, new zzrc((zzrb) null));
                if (!h.isEmpty()) {
                    String str3 = ((zzqn) h.get(0)).f38257a;
                    zzdw.m48255e("MediaCodecUtil", "MediaCodecList API didn't list secure decoder for: " + str2 + ". Assuming: " + str3);
                }
            }
            if ("audio/raw".equals(str2)) {
                if (i < 26 && zzen.f34501b.equals("R9") && h.size() == 1 && ((zzqn) h.get(0)).f38257a.equals("OMX.MTK.AUDIO.DECODER.RAW")) {
                    h.add(zzqn.m54637c("OMX.google.raw.decoder", "audio/raw", "audio/raw", (MediaCodecInfo.CodecCapabilities) null, false, true, false, false, false));
                }
                m54730i(h, zzqv.f38336a);
            }
            if (i < 21 && h.size() > 1) {
                String str4 = ((zzqn) h.get(0)).f38257a;
                if ("OMX.SEC.mp3.dec".equals(str4) || "OMX.SEC.MP3.Decoder".equals(str4) || "OMX.brcm.audio.mp3.decoder".equals(str4)) {
                    m54730i(h, zzqw.f38337a);
                }
            }
            if (i < 32 && h.size() > 1 && "OMX.qti.audio.decoder.flac".equals(((zzqn) h.get(0)).f38257a)) {
                h.add((zzqn) h.remove(0));
            }
            zzfvn t = zzfvn.m51133t(h);
            hashMap.put(zzqx, t);
            return t;
        }
    }
    ...
    @CheckResult
    /* renamed from: g */
    public static List m54728g(List list, zzaf zzaf) {
        ArrayList arrayList = new ArrayList(list);
        m54730i(arrayList, new zzqt(zzaf));
        return arrayList;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:155:0x0233, code lost:
        if (r1.f38339b == false) goto L_0x0235;
     */
    ...
    /* renamed from: h */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static java.util.ArrayList m54729h(com.google.android.gms.internal.ads.zzqx r27, com.google.android.gms.internal.ads.zzra r28) throws com.google.android.gms.internal.ads.zzqz {
        /*
            r1 = r27
            r2 = r28
            ...
            java.lang.String r15 = r1.f38338a     // Catch:{ Exception -> 0x02ff }
            int r14 = r28.zza()     // Catch:{ Exception -> 0x02ff }
            boolean r16 = r28.mo48093b()     // Catch:{ Exception -> 0x02ff }
            r17 = 0
            r13 = 0
        L_0x001a:
            if (r13 >= r14) goto L_0x02fe
            android.media.MediaCodecInfo r0 = r2.mo48091B(r13)     // Catch:{ Exception -> 0x02ff }
            int r7 = com.google.android.gms.internal.ads.zzen.f34500a     // Catch:{ Exception -> 0x02ff }
            r8 = 29
        ...
        L_0x0092:
            java.lang.String r10 = com.google.android.gms.internal.ads.zzen.f34502c     // Catch:{ Exception -> 0x02ff }
            boolean r10 = r11.equals(r10)     // Catch:{ Exception -> 0x02ff }
            if (r10 == 0) goto L_0x00dc
            java.lang.String r10 = com.google.android.gms.internal.ads.zzen.f34501b     // Catch:{ Exception -> 0x02ff }
        ...
        L_0x00dc:
            ...
            java.lang.String r8 = com.google.android.gms.internal.ads.zzen.f34502c     // Catch:{ Exception -> 0x02ff }
            boolean r8 = r11.equals(r8)     // Catch:{ Exception -> 0x02ff }
            if (r8 == 0) goto L_0x011a
            java.lang.String r8 = com.google.android.gms.internal.ads.zzen.f34501b     // Catch:{ Exception -> 0x02ff }
        ...
        L_0x01b4:
            ...
            boolean r7 = r2.mo48092a(r4, r11, r10)     // Catch:{ Exception -> 0x029e }
            boolean r8 = r2.mo48094c(r4, r11, r10)     // Catch:{ Exception -> 0x029e }
            boolean r5 = r1.f38340c     // Catch:{ Exception -> 0x029e }
        ...
        L_0x01c9:
            ...
            goto L_0x002c
        L_0x01cd:
            boolean r5 = r2.mo48092a(r3, r11, r10)     // Catch:{ Exception -> 0x029e }
            boolean r7 = r2.mo48094c(r3, r11, r10)     // Catch:{ Exception -> 0x029e }
            boolean r8 = r1.f38339b     // Catch:{ Exception -> 0x029e }
            r20 = 1
        ...
        L_0x01de:
            ...
            r5 = 1
        L_0x01e1:
            int r7 = com.google.android.gms.internal.ads.zzen.f34500a     // Catch:{ Exception -> 0x029e }
            r8 = 29
            ...
            goto L_0x01f9
        L_0x01ee:
            boolean r8 = m54731j(r0, r15)     // Catch:{ Exception -> 0x029e }
        ...
        L_0x01f7:
            r21 = 0
        L_0x01f9:
            boolean r22 = m54731j(r0, r15)     // Catch:{ Exception -> 0x029e }
            r8 = 29
        ...
        L_0x0206:
            ...
            java.lang.String r0 = com.google.android.gms.internal.ads.zzfse.m50915a(r0)     // Catch:{ Exception -> 0x029e }
        ...
        L_0x0229:
            ...
            boolean r7 = r1.f38339b     // Catch:{ Exception -> 0x029e }
            if (r7 == r5) goto L_0x0235
        L_0x022f:
            if (r16 != 0) goto L_0x0265
            boolean r7 = r1.f38339b     // Catch:{ Exception -> 0x025a }
        ...
        L_0x0235:
            ...
            r26 = r15
            r15 = r18
            com.google.android.gms.internal.ads.zzqn r0 = com.google.android.gms.internal.ads.zzqn.m54637c(r7, r8, r9, r10, r11, r12, r13, r14, r15)     // Catch:{ Exception -> 0x0256 }
        ...
        L_0x0265:
            ...
            r1 = r15
            r15 = r5
            com.google.android.gms.internal.ads.zzqn r0 = com.google.android.gms.internal.ads.zzqn.m54637c(r7, r8, r9, r10, r11, r12, r13, r14, r15)     // Catch:{ Exception -> 0x0299 }
        ...
        L_0x029e:
            ...
            r26 = r15
        L_0x02a8:
            int r5 = com.google.android.gms.internal.ads.zzen.f34500a     // Catch:{ Exception -> 0x02ff }
            ...
            com.google.android.gms.internal.ads.zzdw.m48252b(r7, r0)     // Catch:{ Exception -> 0x02ff }
            goto L_0x02f4
        L_0x02d0:
            ...
            com.google.android.gms.internal.ads.zzdw.m48252b(r7, r1)     // Catch:{ Exception -> 0x02ff }
        ...
        L_0x02ff:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzrf.m54729h(com.google.android.gms.internal.ads.zzqx, com.google.android.gms.internal.ads.zzra):java.util.ArrayList");
    }

    /* renamed from: i */
    private static void m54730i(List list, zzre zzre) {
        Collections.sort(list, new zzqu(zzre));
    }

    /* renamed from: j */
    private static boolean m54731j(MediaCodecInfo mediaCodecInfo, String str) {
        if (zzen.f34500a >= 29) {
        ...
        String a = zzfse.m50915a(mediaCodecInfo.getName());
        if (a.startsWith("arc.")) {
            return false;
        }
