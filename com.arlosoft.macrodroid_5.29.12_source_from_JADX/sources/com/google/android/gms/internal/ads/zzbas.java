...
public final class zzbas {
    ...
    public static com.google.android.gms.internal.ads.zzbas m43002a(com.google.android.gms.internal.ads.zzbak r17) throws com.google.android.gms.internal.ads.zzasz {
        /*
            r0 = 4
            r1 = r17
            r1.mo42337w(r0)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            int r0 = r17.mo42321g()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            r2 = 3
            r0 = r0 & r2
            r3 = 1
            int r6 = r0 + 1
        ...
        L_0x001e:
            ...
            byte[] r8 = m43003b(r17)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            r5.add(r8)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            int r7 = r7 + 1
            goto L_0x001e
        L_0x002a:
            int r7 = r17.mo42321g()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            r8 = 0
        L_0x002f:
            if (r8 >= r7) goto L_0x003b
            byte[] r9 = m43003b(r17)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
        ...
        L_0x003b:
            ...
            r0 = 8
            r8.mo42341d(r0)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            int r1 = r8.mo42338a(r0)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            r9 = 16
            r8.mo42341d(r9)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            r8.mo42340c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            r10 = 100
        ...
        L_0x008c:
            ...
            goto L_0x00dc
        L_0x008e:
            int r1 = r8.mo42340c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            if (r1 != r2) goto L_0x0099
            r8.mo42342e()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            r10 = 3
            goto L_0x009a
        L_0x0099:
            r10 = r1
        L_0x009a:
            r8.mo42340c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            r8.mo42340c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            r8.mo42341d(r3)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            boolean r11 = r8.mo42342e()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
        ...
        L_0x00b1:
            ...
            boolean r12 = r8.mo42342e()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
        ...
        L_0x00c6:
            ...
            int r14 = r8.mo42339b()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            int r14 = r14 + r15
            int r14 = r14 + 256
            int r14 = r14 % 256
        L_0x00d3:
        ...
        L_0x00dc:
            r8.mo42340c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            int r10 = r8.mo42340c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
        ...
        L_0x00e9:
            ...
            r8.mo42342e()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            r8.mo42339b()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            r8.mo42339b()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            int r10 = r8.mo42340c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
        ...
        L_0x0104:
            r8.mo42340c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            r8.mo42341d(r3)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            int r4 = r8.mo42340c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            int r4 = r4 + r3
            int r10 = r8.mo42340c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            int r10 = r10 + r3
            boolean r11 = r8.mo42342e()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
        ...
        L_0x0121:
            ...
            int r11 = r8.mo42340c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            int r13 = r8.mo42340c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            int r14 = r8.mo42340c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            int r15 = r8.mo42340c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
        ...
        L_0x014e:
            ...
            int r10 = r10 - r14
        L_0x0156:
            boolean r1 = r8.mo42342e()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            if (r1 == 0) goto L_0x019a
            boolean r1 = r8.mo42342e()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            if (r1 == 0) goto L_0x019a
            int r0 = r8.mo42338a(r0)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            r1 = 255(0xff, float:3.57E-43)
            if (r0 != r1) goto L_0x017b
            int r0 = r8.mo42338a(r9)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
            int r1 = r8.mo42338a(r9)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
        ...
        L_0x017b:
            ...
            float[] r1 = com.google.android.gms.internal.ads.zzbai.f26400b     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01af }
        ...
        L_0x01af:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzbas.m43002a(com.google.android.gms.internal.ads.zzbak):com.google.android.gms.internal.ads.zzbas");
    }

    /* renamed from: b */
    private static byte[] m43003b(zzbak zzbak) {
        int j = zzbak.mo42324j();
        int c = zzbak.mo42317c();
        zzbak.mo42337w(j);
        return zzbad.m42929b(zzbak.f26406a, c, j);
    }
}
