...
public final class zzwl implements zzwh, zzfz {
    ...
    /* renamed from: E */
    public static final zzfvn f38781E = zzfvn.m51127F(4800000L, 3100000L, 2100000L, 1500000L, 800000L);

    /* renamed from: F */
    public static final zzfvn f38782F = zzfvn.m51127F(1500000L, 1000000L, 730000L, 440000L, 170000L);

    /* renamed from: G */
    public static final zzfvn f38783G = zzfvn.m51127F(2200000L, 1400000L, 1100000L, 910000L, 620000L);

    /* renamed from: H */
    public static final zzfvn f38784H = zzfvn.m51127F(3000000L, 1900000L, 1400000L, 1000000L, 660000L);

    /* renamed from: I */
    public static final zzfvn f38785I = zzfvn.m51127F(6000000L, 4100000L, 3200000L, 1800000L, 1000000L);

    /* renamed from: J */
    public static final zzfvn f38786J = zzfvn.m51127F(2800000L, 2400000L, 1600000L, 1100000L, 950000L);
    @Nullable

    /* renamed from: K */
    private static zzwl f38787K;

    /* renamed from: A */
    private long f38788A;
    ...
    /* renamed from: D */
    private long f38791D;

    /* renamed from: a */
    private final zzfvq f38792a;

    /* renamed from: c */
    private final zzwf f38793c;

    /* renamed from: d */
    private final zzxb f38794d;

    /* renamed from: f */
    private final zzde f38795f;
    ...
    /* renamed from: p */
    private long f38798p;

    /* renamed from: s */
    private long f38799s;
    ...
    public zzwl() {
        zzfvq.m51148d();
        zzde zzde = zzde.f32179a;
        throw null;
    }

    /* renamed from: c */
    public static synchronized zzwl m55263c(Context context) {
        zzwl zzwl;
        ...
        synchronized (zzwl.class) {
            if (f38787K == null) {
                ...
                int[] i = m55269i(zzen.m49173l(context));
                HashMap hashMap = new HashMap(8);
                hashMap.put(0, 1000000L);
                zzfvn zzfvn = f38781E;
                hashMap.put(2, (Long) zzfvn.get(i[0]));
                hashMap.put(3, (Long) f38782F.get(i[1]));
                hashMap.put(4, (Long) f38783G.get(i[2]));
                hashMap.put(5, (Long) f38784H.get(i[3]));
                hashMap.put(10, (Long) f38785I.get(i[4]));
                hashMap.put(9, (Long) f38786J.get(i[5]));
                hashMap.put(7, (Long) zzfvn.get(i[0]));
                f38787K = new zzwl(context2, hashMap, 2000, zzde.f32179a, true, (zzwk) null);
            }
            zzwl = f38787K;
        }
        return zzwl;
    ...
    /* renamed from: e */
    private final long m55265e(int i) {
        Long l = (Long) this.f38792a.get(Integer.valueOf(i));
        if (l == null) {
            l = (Long) this.f38792a.get(0);
        }
        if (l == null) {
            l = 1000000L;
        }
    ...
    /* renamed from: f */
    private final void m55266f(int i, long j, long j2) {
        long j3;
        int i2;
        if (i == 0) {
            if (j != 0) {
                j3 = j;
            } else if (j2 != this.f38791D) {
                j3 = 0;
            } else {
                return;
            }
        ...
        this.f38791D = j2;
        this.f38793c.mo48334b(i2, j3, j2);
    }
    ...
    public final synchronized void m55267g(int r9) {
        /*
            r8 = this;
            monitor-enter(r8)
            int r0 = r8.f38800z     // Catch:{ all -> 0x004e }
            if (r0 == 0) goto L_0x000c
            boolean r1 = r8.f38796g     // Catch:{ all -> 0x004e }
        ...
        L_0x000c:
            ...
            return
        L_0x0010:
            r8.f38800z = r9     // Catch:{ all -> 0x004e }
            r0 = 1
            ...
            goto L_0x004c
        L_0x001c:
            long r0 = r8.m55265e(r9)     // Catch:{ all -> 0x004e }
            r8.f38790C = r0     // Catch:{ all -> 0x004e }
            long r0 = android.os.SystemClock.elapsedRealtime()     // Catch:{ all -> 0x004e }
            int r9 = r8.f38797o     // Catch:{ all -> 0x004e }
            if (r9 <= 0) goto L_0x0031
            long r2 = r8.f38798p     // Catch:{ all -> 0x004e }
            long r2 = r0 - r2
        ...
        L_0x0031:
            ...
            r3 = 0
        L_0x0033:
            long r4 = r8.f38799s     // Catch:{ all -> 0x004e }
            long r6 = r8.f38790C     // Catch:{ all -> 0x004e }
            r2 = r8
            r2.m55266f(r3, r4, r6)     // Catch:{ all -> 0x004e }
            r8.f38798p = r0     // Catch:{ all -> 0x004e }
            r0 = 0
            r8.f38799s = r0     // Catch:{ all -> 0x004e }
            r8.f38789B = r0     // Catch:{ all -> 0x004e }
            r8.f38788A = r0     // Catch:{ all -> 0x004e }
            com.google.android.gms.internal.ads.zzxb r9 = r8.f38794d     // Catch:{ all -> 0x004e }
            r9.mo48370c()     // Catch:{ all -> 0x004e }
            monitor-exit(r8)
            return
        L_0x004c:
            monitor-exit(r8)
        ...
        L_0x004e:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzwl.m55267g(int):void");
    }

    /* renamed from: h */
    private static boolean m55268h(zzfc zzfc, boolean z) {
        return z && !zzfc.mo45582b(8);
    }
    ...
    /* renamed from: i */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static int[] m55269i(java.lang.String r3) {
        /*
            int r0 = r3.hashCode()
        ...
        L_0x0bd5:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzwl.m55269i(java.lang.String):int[]");
    }

    /* renamed from: B */
    public final synchronized void mo43960B(zzex zzex, zzfc zzfc, boolean z) {
        if (m55268h(zzfc, z)) {
            zzdd.m47212f(this.f38797o > 0);
            long elapsedRealtime = SystemClock.elapsedRealtime();
            int i = (int) (elapsedRealtime - this.f38798p);
            this.f38788A += (long) i;
            long j = this.f38789B;
            long j2 = this.f38799s;
            this.f38789B = j + j2;
            if (i > 0) {
                this.f38794d.mo48369b((int) Math.sqrt((double) j2), (((float) j2) * 8000.0f) / ((float) i));
                if (this.f38788A >= 2000 || this.f38789B >= 524288) {
                    this.f38790C = (long) this.f38794d.mo48368a(0.5f);
                }
                m55266f(i, this.f38799s, this.f38790C);
                this.f38798p = elapsedRealtime;
                this.f38799s = 0;
            }
            this.f38797o--;
        }
    ...
    /* renamed from: a */
    public final void mo48336a(Handler handler, zzwg zzwg) {
        Objects.requireNonNull(zzwg);
        this.f38793c.mo48333a(handler, zzwg);
    }

    /* renamed from: b */
    public final void mo48337b(zzwg zzwg) {
        this.f38793c.mo48335c(zzwg);
    }

    /* renamed from: j */
    public final synchronized void mo43969j(zzex zzex, zzfc zzfc, boolean z, int i) {
        if (m55268h(zzfc, z)) {
            this.f38799s += (long) i;
        }
    }
    ...
    /* renamed from: y */
    public final synchronized void mo43983y(zzex zzex, zzfc zzfc, boolean z) {
        if (m55268h(zzfc, z)) {
            if (this.f38797o == 0) {
                this.f38798p = SystemClock.elapsedRealtime();
            }
            this.f38797o++;
        }
    }
    ...
    /* synthetic */ zzwl(Context context, Map map, int i, zzde zzde, boolean z, zzwk zzwk) {
        this.f38792a = zzfvq.m51147c(map);
        this.f38793c = new zzwf();
        this.f38794d = new zzxb(2000);
        this.f38795f = zzde;
        this.f38796g = true;
        if (context != null) {
            zzed b = zzed.m48601b(context);
            int a = b.mo45178a();
            this.f38800z = a;
            this.f38790C = m55265e(a);
            b.mo45179d(new zzwj(this));
            return;
        }
        this.f38800z = 0;
        this.f38790C = m55265e(0);
    }
}
