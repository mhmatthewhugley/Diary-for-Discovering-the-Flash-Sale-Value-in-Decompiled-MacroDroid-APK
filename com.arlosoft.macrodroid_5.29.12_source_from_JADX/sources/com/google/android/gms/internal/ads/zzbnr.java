...
public abstract class zzbnr extends zzasa implements zzbns {
    ...
    /* renamed from: Jb */
    public static zzbns m43814Jb(IBinder iBinder) {
        if (iBinder == null) {
            return null;
        }
    ...
    public final boolean mo19892Ib(int r3, android.os.Parcel r4, android.os.Parcel r5, int r6) throws android.os.RemoteException {
        ...
        L_0x0029:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzbnr.mo19892Ib(int, android.os.Parcel, android.os.Parcel, int):boolean");
    }
}
