...
public enum zzbp {
    ...
    /* renamed from: q0 */
    private static final zzbp[] f45619q0 = null;
    ...
    static {
        int i;
        f45619q0 = new zzbp[r1];
        for (zzbp zzbp : values()) {
            f45619q0[zzbp.zzac] = zzbp;
        }
    }

    private zzbp(int i, int i2, zzcg zzcg) {
        this.zzac = i;
        this.zzab = zzcg;
        zzcg zzcg2 = zzcg.VOID;
        int i3 = i2 - 1;
        if (i3 == 1) {
            this.zzad = zzcg.mo53958b();
        } else if (i3 != 3) {
            this.zzad = null;
        } else {
            this.zzad = zzcg.mo53958b();
