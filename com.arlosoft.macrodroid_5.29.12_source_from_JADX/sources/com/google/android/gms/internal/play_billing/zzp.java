...
public abstract class zzp<E> extends zzm<E> implements List<E>, RandomAccess {
    ...
    /* renamed from: c */
    private static final zzs<Object> f45487c = new zzn(zzq.f45488f, 0);

    zzp() {
    }

    /* renamed from: k */
    public static <E> zzp<E> m63942k() {
        return zzq.f45488f;
    }
        ...
        if (obj instanceof List) {
            ...
            if (size == list.size()) {
                if (list instanceof RandomAccess) {
                    int i = 0;
                    while (i < size) {
                        if (zzi.m63925a(get(i), list.get(i))) {
                            i++;
                        }
                    }
                    return true;
                ...
                while (true) {
                    if (it.hasNext()) {
                        if (it2.hasNext()) {
                            if (!zzi.m63925a(it.next(), it2.next())) {
                                break;
                            }
                        } else {
                            break;
