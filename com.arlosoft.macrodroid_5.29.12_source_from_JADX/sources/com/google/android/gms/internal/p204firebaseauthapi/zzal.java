...
public abstract class zzal extends zzai implements List, RandomAccess {
    ...
    /* renamed from: c */
    private static final zzao f39894c = new zzaj(zzam.f39895f, 0);

    zzal() {
    }

    /* renamed from: k */
    public static zzal m56890k() {
        return zzam.f39895f;
    }
        ...
        if (obj instanceof List) {
            ...
            if (size == list.size()) {
                if (list instanceof RandomAccess) {
                    int i = 0;
                    while (i < size) {
                        if (zzu.m58078a(get(i), list.get(i))) {
                            i++;
                        }
                    }
                    return true;
                ...
                while (true) {
                    if (it.hasNext()) {
                        if (it2.hasNext()) {
                            if (!zzu.m58078a(it.next(), it2.next())) {
                                break;
                            }
                        } else {
                            break;
