...
public final class zzqn implements zzjk {
    ...
    /* renamed from: a */
    private final ThreadLocal f40340a;
    ...
    public zzqn(java.lang.String r6, java.security.Key r7) throws java.security.GeneralSecurityException {
        /*
            r5 = this;
            r5.<init>()
            ...
            r5.f40340a = r0
            r1 = 2
            boolean r2 = com.google.android.gms.internal.p204firebaseauthapi.zzdv.m57153a(r1)
        ...
        L_0x0090:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p204firebaseauthapi.zzqn.<init>(java.lang.String, java.security.Key):void");
    }

    /* renamed from: a */
    public final byte[] mo49512a(byte[] bArr, int i) throws GeneralSecurityException {
        if (i <= this.f40343d) {
            ((Mac) this.f40340a.get()).update(bArr);
            return Arrays.copyOf(((Mac) this.f40340a.get()).doFinal(), i);
        }
