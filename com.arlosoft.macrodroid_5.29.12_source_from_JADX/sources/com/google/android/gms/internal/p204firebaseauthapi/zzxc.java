...
public final class zzxc {
    ...
    /* renamed from: a */
    static final SparseArray f40582a;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:49:0x00d6, code lost:
        return new com.google.firebase.auth.FirebaseAuthUserCollisionException(m58362d(r0), r1);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:51:0x00e0, code lost:
        return new com.google.firebase.auth.FirebaseAuthException(m58362d(r0), r1);
     */
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static com.google.firebase.FirebaseException m58359a(com.google.android.gms.common.api.Status r3) {
        /*
            int r0 = r3.mo21294n2()
            java.lang.String r1 = m58364f(r0)
            java.lang.String r1 = m58363e(r1, r3)
        ...
        L_0x0041:
            ...
            java.lang.String r3 = m58363e(r0, r3)
        ...
        L_0x004d:
            ...
            java.lang.String r0 = m58362d(r0)
            r3.<init>(r0, r1)
            return r3
        L_0x0057:
        ...
        L_0x0061:
            ...
            java.lang.String r0 = m58362d(r0)
            java.lang.String r3 = r3.mo21295o2()
            r2.<init>(r0, r1, r3)
            return r2
        L_0x006f:
        ...
        L_0x009b:
            ...
            return r3
        L_0x00a5:
            java.lang.String r3 = m58363e(r2, r3)
            com.google.firebase.FirebaseException r0 = new com.google.firebase.FirebaseException
            r0.<init>(r3)
            return r0
        L_0x00af:
        ...
        L_0x0105:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p204firebaseauthapi.zzxc.m58359a(com.google.android.gms.common.api.Status):com.google.firebase.FirebaseException");
    }

    /* renamed from: b */
    public static FirebaseException m58360b(Status status, AuthCredential authCredential, @Nullable String str, @Nullable String str2) {
        int n2 = status.mo21294n2();
        if (n2 != 17012 && n2 != 17007 && n2 != 17025) {
            return m58359a(status);
        }
        FirebaseAuthUserCollisionException firebaseAuthUserCollisionException = new FirebaseAuthUserCollisionException(m58362d(n2), m58363e(m58364f(n2), status));
        firebaseAuthUserCollisionException.mo22638d(authCredential);
        firebaseAuthUserCollisionException.mo22639e(str);
        firebaseAuthUserCollisionException.mo22640f(str2);
        return firebaseAuthUserCollisionException;
    }

    /* renamed from: c */
    public static FirebaseAuthMultiFactorException m58361c(FirebaseAuth firebaseAuth, zztm zztm, @Nullable FirebaseUser firebaseUser) {
        Objects.requireNonNull(firebaseAuth);
        Objects.requireNonNull(zztm);
        Pair pair = (Pair) f40582a.get(17078);
        String str = (String) pair.first;
        String str2 = (String) pair.second;
        Parcelable.Creator<zzae> creator = zzae.CREATOR;
        List<MultiFactorInfo> n2 = zztm.mo49906n2();
        ArrayList arrayList = new ArrayList();
        for (MultiFactorInfo multiFactorInfo : n2) {
            if (multiFactorInfo instanceof PhoneMultiFactorInfo) {
                arrayList.add((PhoneMultiFactorInfo) multiFactorInfo);
            }
        }
        return new FirebaseAuthMultiFactorException(str, str2, new zzae(arrayList, zzag.m6166m2(zztm.mo49906n2(), zztm.mo49905m2()), firebaseAuth.mo22612f().mo61951o(), zztm.mo49904l2(), (zzx) firebaseUser));
    }

    /* renamed from: d */
    private static String m58362d(int i) {
        Pair pair = (Pair) f40582a.get(i);
        return pair != null ? (String) pair.first : "INTERNAL_ERROR";
    }

    /* renamed from: e */
    private static String m58363e(String str, Status status) {
        if (TextUtils.isEmpty(status.mo21295o2())) {
            return str;
        }
        return String.format(String.valueOf(str).concat(" [ %s ]"), new Object[]{status.mo21295o2()});
    }

    /* renamed from: f */
    private static String m58364f(int i) {
        Pair pair = (Pair) f40582a.get(i);
