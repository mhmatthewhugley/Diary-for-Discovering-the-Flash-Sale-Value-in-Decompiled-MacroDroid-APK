...
final class zzvo extends zzyb {
    ...
    public final void mo49944a(TaskCompletionSource taskCompletionSource, zzxb zzxb) {
        ...
        zzxb.mo50021p(this.f40540w, this.f40621b);
    }

    /* renamed from: b */
    public final void mo49945b() {
        zzx i = zzwy.m58269i(this.f40622c, this.f40629j);
        FirebaseUser firebaseUser = this.f40623d;
        if (firebaseUser == null || firebaseUser.mo22654r2().equalsIgnoreCase(i.mo22654r2())) {
