...
public final class zzag {
    /* renamed from: a */
    public static String m56867a(String str) {
        if (zzx.m58310c(str)) {
            return null;
        }
        return str;
    ...
    /* renamed from: b */
    public static String m56868b(String str, Object... objArr) {
        int length;
        int length2;
        int indexOf;
        String str2;
    ...
    /* renamed from: c */
    public static String m56869c(String str) {
        return zzx.m58309b(str);
    }

    /* renamed from: d */
    public static boolean m56870d(String str) {
        return zzx.m58310c(str);
    }
}
