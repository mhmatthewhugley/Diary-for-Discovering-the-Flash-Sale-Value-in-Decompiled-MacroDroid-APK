...
final /* synthetic */ class zzmr {
    ...
    static {
        ...
        L_0x000c:
            r1 = 2
            r4 = 4
            int[] r5 = f40244a     // Catch:{ NoSuchFieldError -> 0x0012 }
            r5[r4] = r1     // Catch:{ NoSuchFieldError -> 0x0012 }
        L_0x0012:
            int[] r5 = f40244a     // Catch:{ NoSuchFieldError -> 0x0016 }
            r5[r1] = r3     // Catch:{ NoSuchFieldError -> 0x0016 }
        L_0x0016:
            r1 = 5
            int[] r3 = f40244a     // Catch:{ NoSuchFieldError -> 0x001b }
            r3[r1] = r4     // Catch:{ NoSuchFieldError -> 0x001b }
        L_0x001b:
            r3 = 6
            int[] r4 = f40244a     // Catch:{ NoSuchFieldError -> 0x0020 }
            r4[r3] = r1     // Catch:{ NoSuchFieldError -> 0x0020 }
        L_0x0020:
            int[] r1 = f40244a     // Catch:{ NoSuchFieldError -> 0x0025 }
            r4 = 0
            r1[r4] = r3     // Catch:{ NoSuchFieldError -> 0x0025 }
        L_0x0025:
            int[] r1 = f40244a     // Catch:{ NoSuchFieldError -> 0x0029 }
            r1[r2] = r0     // Catch:{ NoSuchFieldError -> 0x0029 }
        L_0x0029:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p204firebaseauthapi.zzmr.<clinit>():void");
    }
}
