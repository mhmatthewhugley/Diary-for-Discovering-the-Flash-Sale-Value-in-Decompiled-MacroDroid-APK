...
public final class zzcc extends AbstractSafeParcelable {
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof zzcc) {
            return Objects.m4470a(this.f44587a, ((zzcc) obj).f44587a);
        }
        return false;
    }

    public final int hashCode() {
        return Objects.m4471b(this.f44587a);
    }

    public final void writeToParcel(Parcel parcel, int i) {
        int a = SafeParcelWriter.m4563a(parcel);
        SafeParcelWriter.m4575m(parcel, 1, this.f44587a.asBinder(), false);
    ...
    zzcc(@com.google.android.gms.common.internal.safeparcel.SafeParcelable.Param android.os.IBinder r3) {
        /*
            r2 = this;
