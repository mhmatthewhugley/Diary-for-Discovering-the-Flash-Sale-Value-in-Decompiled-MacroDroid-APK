...
public final class zziu {
    ...
    /* renamed from: a */
    public static zziu m67180a(Context context) {
        Preconditions.m4488k(context);
        synchronized (zziu.class) {
            if (f48415b == null) {
                f48415b = new zziu(context);
            }
        }
        return f48415b;
    }
    ...
    @VisibleForTesting
    /* renamed from: c */
    static final boolean m67181c(PackageInfo packageInfo, boolean z) {
        ...
        if (z) {
            return m67183e(packageInfo, f48416c, f48417d);
        }
        return m67183e(packageInfo, f48416c);
    }

    /* renamed from: d */
    private static byte[] m67182d(String str) {
        try {
    ...
    /* renamed from: e */
    private static final boolean m67183e(PackageInfo packageInfo, byte[]... bArr) {
        Signature[] signatureArr = packageInfo.signatures;
    ...
    @ShowFirstParty
    /* renamed from: b */
    public final boolean mo56521b(String str) {
        PackageInfo packageInfo;
        try {
            packageInfo = Wrappers.m4929a(this.f48418a).mo21963f("com.google.android.wearable.app.cn", 64);
        ...
        if (GooglePlayServicesUtilLight.m3566g(this.f48418a)) {
            return m67181c(packageInfo, true);
        }
        boolean c = m67181c(packageInfo, false);
        if (c || !m67181c(packageInfo, true)) {
            return c;
        }
