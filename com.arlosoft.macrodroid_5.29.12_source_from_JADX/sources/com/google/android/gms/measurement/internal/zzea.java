...
public final class zzea extends zzf {
    ...
    zzea(zzfr zzfr) {
        ...
        this.f46661c = new zzdz(this, c, "google_app_measurement_local.db");
    }
    ...
    private final boolean m65533v(int r17, byte[] r18) {
        /*
            r16 = this;
            r1 = r16
            r16.mo55073e()
            boolean r0 = r1.f46662d
            r2 = 0
        ...
        L_0x0028:
            ...
            r7 = 1
            r8 = 0
            android.database.sqlite.SQLiteDatabase r9 = r16.mo55074m()     // Catch:{ SQLiteFullException -> 0x00fb, SQLiteDatabaseLockedException -> 0x00e9, SQLiteException -> 0x00c2, all -> 0x00bf }
            if (r9 != 0) goto L_0x0035
            r1.f46662d = r7     // Catch:{ SQLiteFullException -> 0x00bb, SQLiteDatabaseLockedException -> 0x00ea, SQLiteException -> 0x00b7 }
            return r2
        L_0x0035:
        ...
        L_0x0054:
            ...
            com.google.android.gms.measurement.internal.zzfr r15 = r1.f46899a     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            com.google.android.gms.measurement.internal.zzeh r15 = r15.mo55221z()     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            com.google.android.gms.measurement.internal.zzef r15 = r15.mo55098p()     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            java.lang.String r4 = "Data loss, local db full"
            r15.mo55091a(r4)     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            long r13 = r13 - r11
            r11 = 1
            long r13 = r13 + r11
            ...
            com.google.android.gms.measurement.internal.zzfr r4 = r1.f46899a     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            com.google.android.gms.measurement.internal.zzeh r4 = r4.mo55221z()     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            com.google.android.gms.measurement.internal.zzef r4 = r4.mo55098p()     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            ...
            r4.mo55094d(r15, r2, r7, r11)     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
        L_0x009f:
        ...
        L_0x00cf:
            com.google.android.gms.measurement.internal.zzfr r2 = r1.f46899a     // Catch:{ all -> 0x011f }
            com.google.android.gms.measurement.internal.zzeh r2 = r2.mo55221z()     // Catch:{ all -> 0x011f }
            com.google.android.gms.measurement.internal.zzef r2 = r2.mo55098p()     // Catch:{ all -> 0x011f }
            java.lang.String r4 = "Error writing entry to local database"
            r2.mo55092b(r4, r0)     // Catch:{ all -> 0x011f }
            r2 = 1
            r1.f46662d = r2     // Catch:{ all -> 0x011f }
        ...
        L_0x012d:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzea.m65533v(int, byte[]):boolean");
    }
    ...
    @VisibleForTesting
    /* renamed from: m */
    public final SQLiteDatabase mo55074m() throws SQLiteException {
        if (this.f46662d) {
            return null;
        }
        SQLiteDatabase writableDatabase = this.f46661c.getWritableDatabase();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:47:?, code lost:
        r1.f46899a.mo55221z().mo55098p().mo55091a("Failed to load event from local database");
     */
    /* JADX WARNING: Code restructure failed: missing block: B:49:?, code lost:
        r12.recycle();
     */
    /* JADX WARNING: Code restructure failed: missing block: B:60:?, code lost:
        r1.f46899a.mo55221z().mo55098p().mo55091a("Failed to load user property from local database");
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:75:?, code lost:
        r1.f46899a.mo55221z().mo55098p().mo55091a("Failed to load conditional user property from local database");
     */
    ...
    /* renamed from: n */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final java.util.List mo55075n(int r23) {
        /*
            r22 = this;
            r1 = r22
        ...
        L_0x001e:
            ...
            r10 = 1
            android.database.sqlite.SQLiteDatabase r15 = r22.mo55074m()     // Catch:{ SQLiteFullException -> 0x022e, SQLiteDatabaseLockedException -> 0x021b, SQLiteException -> 0x01f6, all -> 0x01f3 }
            if (r15 != 0) goto L_0x002a
            r1.f46662d = r10     // Catch:{ SQLiteFullException -> 0x01ee, SQLiteDatabaseLockedException -> 0x01ea, SQLiteException -> 0x01e5, all -> 0x01e0 }
            return r4
        L_0x002a:
        ...
        L_0x00c0:
            ...
            goto L_0x00d5
        L_0x00c2:
            com.google.android.gms.measurement.internal.zzfr r0 = r1.f46899a     // Catch:{ all -> 0x00c0 }
            com.google.android.gms.measurement.internal.zzeh r0 = r0.mo55221z()     // Catch:{ all -> 0x00c0 }
            com.google.android.gms.measurement.internal.zzef r0 = r0.mo55098p()     // Catch:{ all -> 0x00c0 }
            java.lang.String r13 = "Failed to load event from local database"
            r0.mo55091a(r13)     // Catch:{ all -> 0x00c0 }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            goto L_0x008f
        L_0x00d5:
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
        ...
        L_0x00d9:
            ...
            android.os.Parcelable$Creator<com.google.android.gms.measurement.internal.zzkw> r0 = com.google.android.gms.measurement.internal.zzkw.CREATOR     // Catch:{ ParseException -> 0x00f4 }
            java.lang.Object r0 = r0.createFromParcel(r12)     // Catch:{ ParseException -> 0x00f4 }
            com.google.android.gms.measurement.internal.zzkw r0 = (com.google.android.gms.measurement.internal.zzkw) r0     // Catch:{ ParseException -> 0x00f4 }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            goto L_0x0107
        L_0x00f2:
            r0 = move-exception
            goto L_0x010d
        L_0x00f4:
            com.google.android.gms.measurement.internal.zzfr r0 = r1.f46899a     // Catch:{ all -> 0x00f2 }
            com.google.android.gms.measurement.internal.zzeh r0 = r0.mo55221z()     // Catch:{ all -> 0x00f2 }
            com.google.android.gms.measurement.internal.zzef r0 = r0.mo55098p()     // Catch:{ all -> 0x00f2 }
            java.lang.String r13 = "Failed to load user property from local database"
            r0.mo55091a(r13)     // Catch:{ all -> 0x00f2 }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            r0 = r4
        L_0x0107:
            if (r0 == 0) goto L_0x008f
        ...
        L_0x012a:
            ...
            goto L_0x0146
        L_0x012c:
            com.google.android.gms.measurement.internal.zzfr r0 = r1.f46899a     // Catch:{ all -> 0x012a }
            com.google.android.gms.measurement.internal.zzeh r0 = r0.mo55221z()     // Catch:{ all -> 0x012a }
            com.google.android.gms.measurement.internal.zzef r0 = r0.mo55098p()     // Catch:{ all -> 0x012a }
            java.lang.String r13 = "Failed to load conditional user property from local database"
            r0.mo55091a(r13)     // Catch:{ all -> 0x012a }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            r0 = r4
        L_0x013f:
            if (r0 == 0) goto L_0x008f
        ...
        L_0x014a:
            ...
            com.google.android.gms.measurement.internal.zzfr r0 = r1.f46899a     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            com.google.android.gms.measurement.internal.zzeh r0 = r0.mo55221z()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            com.google.android.gms.measurement.internal.zzef r0 = r0.mo55103u()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            java.lang.String r12 = "Skipping app launch break"
            r0.mo55091a(r12)     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            goto L_0x008f
        L_0x015e:
            com.google.android.gms.measurement.internal.zzfr r0 = r1.f46899a     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            com.google.android.gms.measurement.internal.zzeh r0 = r0.mo55221z()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            com.google.android.gms.measurement.internal.zzef r0 = r0.mo55098p()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
        ...
        L_0x016f:
            ...
            com.google.android.gms.measurement.internal.zzfr r0 = r1.f46899a     // Catch:{ SQLiteFullException -> 0x01a7, SQLiteDatabaseLockedException -> 0x01ec, SQLiteException -> 0x01a5, all -> 0x01a3 }
            com.google.android.gms.measurement.internal.zzeh r0 = r0.mo55221z()     // Catch:{ SQLiteFullException -> 0x01a7, SQLiteDatabaseLockedException -> 0x01ec, SQLiteException -> 0x01a5, all -> 0x01a3 }
            com.google.android.gms.measurement.internal.zzef r0 = r0.mo55098p()     // Catch:{ SQLiteFullException -> 0x01a7, SQLiteDatabaseLockedException -> 0x01ec, SQLiteException -> 0x01a5, all -> 0x01a3 }
            java.lang.String r12 = "Fewer entries removed from local database than expected"
            r0.mo55091a(r12)     // Catch:{ SQLiteFullException -> 0x01a7, SQLiteDatabaseLockedException -> 0x01ec, SQLiteException -> 0x01a5, all -> 0x01a3 }
        L_0x0196:
        ...
        L_0x0204:
            com.google.android.gms.measurement.internal.zzfr r12 = r1.f46899a     // Catch:{ all -> 0x024c }
            com.google.android.gms.measurement.internal.zzeh r12 = r12.mo55221z()     // Catch:{ all -> 0x024c }
            com.google.android.gms.measurement.internal.zzef r12 = r12.mo55098p()     // Catch:{ all -> 0x024c }
            r12.mo55092b(r3, r0)     // Catch:{ all -> 0x024c }
            r1.f46662d = r10     // Catch:{ all -> 0x024c }
        ...
        L_0x0269:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzea.mo55075n(int):java.util.List");
    }

    @WorkerThread
    /* renamed from: o */
    public final void mo55076o() {
        int delete;
        mo55073e();
        try {
            SQLiteDatabase m = mo55074m();
            if (m != null && (delete = m.delete("messages", (String) null, (String[]) null)) > 0) {
                this.f46899a.mo55221z().mo55102t().mo55092b("Reset local analytics data. records", Integer.valueOf(delete));
            }
        } catch (SQLiteException e) {
            this.f46899a.mo55221z().mo55098p().mo55092b("Error resetting local analytics data. error", e);
        }
    }

    @WorkerThread
    /* renamed from: p */
    public final boolean mo55077p() {
        return m65533v(3, new byte[0]);
    }

    /* access modifiers changed from: package-private */
    @VisibleForTesting
    /* renamed from: q */
    public final boolean mo55078q() {
        Context c = this.f46899a.mo55202c();
        this.f46899a.mo55219x();
    ...
    @WorkerThread
    /* renamed from: r */
    public final boolean mo55079r() {
        mo55073e();
        if (!this.f46662d && mo55078q()) {
            int i = 0;
            int i2 = 5;
            while (i < 5) {
                ...
                try {
                    ...
                    this.f46899a.mo55221z().mo55098p().mo55092b("Error deleting app launch break from local database", e);
                    this.f46662d = true;
                    ...
                    this.f46899a.mo55221z().mo55098p().mo55092b("Error deleting app launch break from local database", e2);
                    this.f46662d = true;
                    if (sQLiteDatabase != null) {
                        sQLiteDatabase.close();
                        i++;
            ...
            this.f46899a.mo55221z().mo55103u().mo55091a("Error deleting app launch break from local database in reasonable time");
        }
        return false;
    }

    /* renamed from: s */
    public final boolean mo55080s(zzac zzac) {
        byte[] c0 = this.f46899a.mo55196N().mo55595c0(zzac);
        if (c0.length <= 131072) {
            return m65533v(2, c0);
        }
        this.f46899a.mo55221z().mo55100r().mo55091a("Conditional user property too long for local database. Sending directly to service");
        return false;
    }

    /* renamed from: t */
    public final boolean mo55081t(zzaw zzaw) {
        Parcel obtain = Parcel.obtain();
        zzax.m65471a(zzaw, obtain, 0);
        byte[] marshall = obtain.marshall();
        obtain.recycle();
        if (marshall.length <= 131072) {
            return m65533v(0, marshall);
        }
        this.f46899a.mo55221z().mo55100r().mo55091a("Event is too long for local database. Sending event directly to service");
        return false;
    }

    /* renamed from: u */
    public final boolean mo55082u(zzkw zzkw) {
        Parcel obtain = Parcel.obtain();
        zzkx.m66117a(zzkw, obtain, 0);
        byte[] marshall = obtain.marshall();
        obtain.recycle();
        if (marshall.length <= 131072) {
            return m65533v(1, marshall);
        }
        this.f46899a.mo55221z().mo55100r().mo55091a("User property too long for local database. Sending directly to service");
        return false;
    }
}
