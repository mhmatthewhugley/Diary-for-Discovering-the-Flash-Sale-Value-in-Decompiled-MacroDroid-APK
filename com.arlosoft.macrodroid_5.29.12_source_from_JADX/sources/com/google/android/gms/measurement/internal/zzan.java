...
public final class zzan {
    ...
    static void m65446a(com.google.android.gms.measurement.internal.zzeh r14, android.database.sqlite.SQLiteDatabase r15, java.lang.String r16, java.lang.String r17, java.lang.String r18, java.lang.String[] r19) throws android.database.sqlite.SQLiteException {
        /*
            r9 = r15
            r10 = r16
            r11 = r19
        ...
        L_0x002f:
            ...
            r1 = r13
        L_0x0031:
            com.google.android.gms.measurement.internal.zzef r2 = r14.mo55103u()     // Catch:{ all -> 0x00e0 }
            java.lang.String r3 = "Error querying for table"
            r2.mo55093c(r3, r10, r0)     // Catch:{ all -> 0x00e0 }
        ...
        L_0x00ba:
            ...
            com.google.android.gms.measurement.internal.zzef r1 = r14.mo55103u()     // Catch:{ SQLiteException -> 0x00d5 }
            ...
            r1.mo55093c(r2, r10, r0)     // Catch:{ SQLiteException -> 0x00d5 }
        L_0x00cf:
            return
        L_0x00d0:
            r0 = move-exception
        ...
        L_0x00d5:
            r0 = move-exception
            com.google.android.gms.measurement.internal.zzef r1 = r14.mo55098p()
        ...
        L_0x00e8:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzan.m65446a(com.google.android.gms.measurement.internal.zzeh, android.database.sqlite.SQLiteDatabase, java.lang.String, java.lang.String, java.lang.String, java.lang.String[]):void");
    }

    /* renamed from: b */
    static void m65447b(zzeh zzeh, SQLiteDatabase sQLiteDatabase) {
        if (zzeh != null) {
            File file = new File(sQLiteDatabase.getPath());
            if (!file.setReadable(false, false)) {
                zzeh.mo55103u().mo55091a("Failed to turn off database read permission");
            }
            if (!file.setWritable(false, false)) {
                zzeh.mo55103u().mo55091a("Failed to turn off database write permission");
            }
            if (!file.setReadable(true, true)) {
                zzeh.mo55103u().mo55091a("Failed to turn on database read permission for owner");
            }
            if (!file.setWritable(true, true)) {
                zzeh.mo55103u().mo55091a("Failed to turn on database write permission for owner");
                return;
            }
            return;
        }
