...
public interface IGmsServiceBroker extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGmsServiceBroker {
        ...
        public final boolean onTransact(int i, @NonNull Parcel parcel, @Nullable Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 46) {
                ...
                mo21715P7(iGmsCallbacks, getServiceRequest);
                Preconditions.m4488k(parcel2);
    ...
    @KeepForSdk
    /* renamed from: P7 */
    void mo21715P7(@NonNull IGmsCallbacks iGmsCallbacks, @Nullable GetServiceRequest getServiceRequest) throws RemoteException;
}
