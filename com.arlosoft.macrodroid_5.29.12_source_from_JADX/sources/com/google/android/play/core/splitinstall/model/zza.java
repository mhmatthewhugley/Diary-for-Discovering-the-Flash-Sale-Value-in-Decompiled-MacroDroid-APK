...
public final class zza {
    ...
    /* renamed from: a */
    private static final Map f51795a;

    /* renamed from: b */
    private static final Map f51796b;

    /* renamed from: c */
    private static final Map f51797c = new HashMap();
    ...
    static {
        ...
        for (Map.Entry entry : hashMap2.entrySet()) {
            f51797c.put((String) entry.getValue(), (Integer) entry.getKey());
        }
    }

    @SplitInstallErrorCode
    /* renamed from: a */
    public static int m71124a(String str) {
        Integer num = (Integer) f51797c.get(str);
        if (num != null) {
            return num.intValue();
        }
    ...
    /* renamed from: b */
    public static String m71125b(@SplitInstallErrorCode int i) {
        Map map = f51795a;
