...
public final class zzcl {
    /* renamed from: a */
    public static long m70932a(zzcm zzcm, InputStream inputStream, OutputStream outputStream, long j) throws IOException {
        String str;
                    ...
                    if (read2 == -1) {
                        ...
                        switch (read2) {
                            case 247:
                                ...
                                m70934c(bArr, dataInputStream, outputStream, read2, j3);
                                break;
                            case 248:
                            ...
                            case 249:
                                ...
                                if (read2 != -1) {
                                    m70933b(bArr, zzcm, outputStream, readUnsignedShort, read2, j3);
                                    break;
                                } else {
                            ...
                            case ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION:
                                ...
                                read2 = dataInputStream.readUnsignedShort();
                                m70933b(bArr, zzcm, outputStream, readUnsignedShort2, read2, j3);
                                break;
                            case 251:
                                long readUnsignedShort3 = (long) dataInputStream.readUnsignedShort();
                                read2 = dataInputStream.readInt();
                                m70933b(bArr, zzcm, outputStream, readUnsignedShort3, read2, j3);
                                break;
                            case 252:
                                long readInt2 = (long) dataInputStream.readInt();
                                read2 = dataInputStream.read();
                                if (read2 != -1) {
                                    m70933b(bArr, zzcm, outputStream, readInt2, read2, j3);
                                    break;
                                } else {
                                    throw new IOException("Unexpected end of patch");
                                }
                            case 253:
                                ...
                                read2 = dataInputStream.readUnsignedShort();
                                m70933b(bArr, zzcm, outputStream, readInt3, read2, j3);
                                break;
                            case 254:
                                long readInt4 = (long) dataInputStream.readInt();
                                read2 = dataInputStream.readInt();
                                m70933b(bArr, zzcm, outputStream, readInt4, read2, j3);
                                break;
                            case 255:
                                long readLong = dataInputStream.readLong();
                                read2 = dataInputStream.readInt();
                                m70933b(bArr, zzcm, outputStream, readLong, read2, j3);
                                break;
                            default:
                                m70934c(bArr, dataInputStream, outputStream, read2, j3);
                                break;
    ...
    private static void m70933b(byte[] r10, com.google.android.play.core.internal.zzcm r11, java.io.OutputStream r12, long r13, int r15, long r16) throws java.io.IOException {
        /*
            r0 = r10
            r1 = r15
            ...
            java.io.InputStream r2 = r2.mo59862e()     // Catch:{ EOFException -> 0x0049 }
        L_0x001b:
        ...
        L_0x0062:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.play.core.internal.zzcl.m70933b(byte[], com.google.android.play.core.internal.zzcm, java.io.OutputStream, long, int, long):void");
    }

    /* renamed from: c */
    private static void m70934c(byte[] bArr, DataInputStream dataInputStream, OutputStream outputStream, int i, long j) throws IOException {
        if (i < 0) {
