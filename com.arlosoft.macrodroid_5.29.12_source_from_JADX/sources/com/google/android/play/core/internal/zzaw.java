...
public final class zzaw implements zzh {
    ...
    /* renamed from: b */
    private final zze f51690b;
    /* access modifiers changed from: private */

    /* renamed from: c */
    public final zzay f51691c;

    /* renamed from: d */
    private final Executor f51692d;

    /* renamed from: e */
    private final zzr f51693e;

    public zzaw(Context context, Executor executor, zzay zzay, zze zze, zzr zzr, byte[] bArr) {
        this.f51689a = context;
        this.f51690b = zze;
        this.f51691c = zzay;
        this.f51692d = executor;
        this.f51693e = zzr;
    }

    /* renamed from: c */
    static /* bridge */ /* synthetic */ void m70830c(zzaw zzaw, List list, zzf zzf) {
        Integer e = zzaw.m70832e(list);
        if (e != null) {
            if (e.intValue() == 0) {
                zzf.mo59996a();
            } else {
                zzf.mo59995B(e.intValue());
            }
        }
    }

    /* renamed from: d */
    static /* bridge */ /* synthetic */ void m70831d(zzaw zzaw, zzf zzf) {
        try {
            if (!SplitCompat.m71058d(zzce.m70925a(zzaw.f51689a))) {
    ...
    private final java.lang.Integer m70832e(java.util.List r15) {
        /*
            r14 = this;
            java.lang.String r0 = "SplitCompat"
            r1 = -13
            java.io.RandomAccessFile r2 = new java.io.RandomAccessFile     // Catch:{ Exception -> 0x0128 }
            com.google.android.play.core.splitcompat.zze r3 = r14.f51690b     // Catch:{ Exception -> 0x0128 }
            java.io.File r3 = r3.mo59944d()     // Catch:{ Exception -> 0x0128 }
        ...
        L_0x002d:
            ...
            android.content.Context r8 = r14.f51689a     // Catch:{ Exception -> 0x010c }
            ...
            com.google.android.play.core.splitcompat.zze r8 = r14.f51690b     // Catch:{ Exception -> 0x010c }
            java.io.File r8 = r8.mo59945e(r7)     // Catch:{ Exception -> 0x010c }
        ...
        L_0x006e:
            com.google.android.play.core.splitcompat.zze r9 = r14.f51690b     // Catch:{ Exception -> 0x010c }
            java.io.File r7 = r9.mo59947g(r7)     // Catch:{ Exception -> 0x010c }
        ...
        L_0x00a7:
            ...
            com.google.android.play.core.splitcompat.zze r15 = r14.f51690b     // Catch:{ IOException -> 0x0105 }
            java.io.File r15 = r15.mo59942b()     // Catch:{ IOException -> 0x0105 }
            java.io.File[] r15 = r15.listFiles()     // Catch:{ IOException -> 0x0105 }
            com.google.android.play.core.internal.zzay r6 = r14.f51691c     // Catch:{ Exception -> 0x00fc }
            boolean r6 = r6.mo59829c(r15)     // Catch:{ Exception -> 0x00fc }
            if (r6 == 0) goto L_0x00f6
            com.google.android.play.core.internal.zzay r6 = r14.f51691c     // Catch:{ Exception -> 0x00fc }
            boolean r15 = r6.mo59827a(r15)     // Catch:{ Exception -> 0x00fc }
            if (r15 == 0) goto L_0x00f6
            com.google.android.play.core.splitcompat.zze r15 = r14.f51690b     // Catch:{ IOException -> 0x00ef }
            java.io.File r15 = r15.mo59942b()     // Catch:{ IOException -> 0x00ef }
        ...
        L_0x00d4:
            ...
            com.google.android.play.core.splitcompat.zze.m71070m(r6)     // Catch:{ IOException -> 0x00ef }
            r6 = r15[r5]     // Catch:{ IOException -> 0x00ef }
            com.google.android.play.core.splitcompat.zze r7 = r14.f51690b     // Catch:{ IOException -> 0x00ef }
            java.io.File r7 = r7.mo59946f(r6)     // Catch:{ IOException -> 0x00ef }
        ...
        L_0x0128:
            ...
            return r15
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.play.core.internal.zzaw.m70832e(java.util.List):java.lang.Integer");
    }

    /* renamed from: a */
    public final void mo59824a(List list, zzf zzf) {
        if (SplitCompat.m71059e()) {
            this.f51692d.execute(new zzav(this, list, zzf));
            return;
        }
