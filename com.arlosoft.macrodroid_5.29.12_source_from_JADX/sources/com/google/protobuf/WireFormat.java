...
public final class WireFormat {
    ...
    /* renamed from: a */
    static final int f57164a = m81549c(1, 3);

    /* renamed from: b */
    static final int f57165b = m81549c(1, 4);

    /* renamed from: c */
    static final int f57166c = m81549c(2, 0);

    /* renamed from: d */
    static final int f57167d = m81549c(3, 2);

    /* renamed from: com.google.protobuf.WireFormat$1 */
    static /* synthetic */ class C116231 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f57168a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f57168a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f57168a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f57168a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f57168a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f57168a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f57168a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f57168a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r0 = f57168a     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f57168a     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r0 = f57168a     // Catch:{ NoSuchFieldError -> 0x0090 }
            ...
            L_0x0090:
                int[] r0 = f57168a     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x009c:
                int[] r0 = f57168a     // Catch:{ NoSuchFieldError -> 0x00a8 }
            ...
            L_0x00a8:
                int[] r0 = f57168a     // Catch:{ NoSuchFieldError -> 0x00b4 }
            ...
            L_0x00b4:
                int[] r0 = f57168a     // Catch:{ NoSuchFieldError -> 0x00c0 }
            ...
            L_0x00c0:
                int[] r0 = f57168a     // Catch:{ NoSuchFieldError -> 0x00cc }
            ...
            L_0x00cc:
                int[] r0 = f57168a     // Catch:{ NoSuchFieldError -> 0x00d8 }
            ...
            L_0x00d8:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.WireFormat.C116231.<clinit>():void");
        }
    }
    ...
    public enum JavaType {
        ...
        STRING(""),
        BYTE_STRING(ByteString.f56619a),
        ENUM((String) null),
        MESSAGE((String) null);
    ...
    /* renamed from: a */
    public static int m81547a(int i) {
        return i >>> 3;
    }

    /* renamed from: b */
    public static int m81548b(int i) {
        return i & 7;
    }

    /* renamed from: c */
    static int m81549c(int i, int i2) {
        return (i << 3) | i2;
    }
}
