...
public class CountryCodeToRegionCodeMap {
    /* renamed from: a */
    static Map<Integer, List<String>> m78736a() {
        ...
        arrayList47.add("SS");
        hashMap.put(Integer.valueOf(Opcodes.DIV_INT_LIT16), arrayList47);
        ArrayList arrayList48 = new ArrayList(2);
        arrayList48.add("MA");
        arrayList48.add("EH");
        hashMap.put(Integer.valueOf(Opcodes.REM_INT_LIT16), arrayList48);
        ArrayList arrayList49 = new ArrayList(1);
        arrayList49.add("DZ");
        hashMap.put(Integer.valueOf(Opcodes.AND_INT_LIT16), arrayList49);
        ArrayList arrayList50 = new ArrayList(1);
        arrayList50.add("TN");
        hashMap.put(Integer.valueOf(Opcodes.ADD_INT_LIT8), arrayList50);
        ArrayList arrayList51 = new ArrayList(1);
        arrayList51.add("LY");
        hashMap.put(Integer.valueOf(Opcodes.MUL_INT_LIT8), arrayList51);
        ArrayList arrayList52 = new ArrayList(1);
        arrayList52.add("GM");
        hashMap.put(Integer.valueOf(Opcodes.REM_INT_LIT8), arrayList52);
        ArrayList arrayList53 = new ArrayList(1);
        arrayList53.add("SN");
        hashMap.put(Integer.valueOf(Opcodes.AND_INT_LIT8), arrayList53);
        ArrayList arrayList54 = new ArrayList(1);
        arrayList54.add("MR");
        hashMap.put(Integer.valueOf(Opcodes.OR_INT_LIT8), arrayList54);
        ArrayList arrayList55 = new ArrayList(1);
        arrayList55.add("ML");
        hashMap.put(Integer.valueOf(Opcodes.XOR_INT_LIT8), arrayList55);
        ArrayList arrayList56 = new ArrayList(1);
        arrayList56.add("GN");
        hashMap.put(Integer.valueOf(Opcodes.SHL_INT_LIT8), arrayList56);
        ArrayList arrayList57 = new ArrayList(1);
        arrayList57.add("CI");
        hashMap.put(Integer.valueOf(Opcodes.SHR_INT_LIT8), arrayList57);
        ArrayList arrayList58 = new ArrayList(1);
        arrayList58.add("BF");
        hashMap.put(Integer.valueOf(Opcodes.USHR_INT_LIT8), arrayList58);
        ...
        arrayList133.add("SK");
        hashMap.put(Integer.valueOf(TypedValues.Cycle.TYPE_WAVE_SHAPE), arrayList133);
        ...
        arrayList141.add("CR");
        hashMap.put(Integer.valueOf(TypedValues.Position.TYPE_PERCENT_X), arrayList141);
        ArrayList arrayList142 = new ArrayList(1);
        arrayList142.add("PA");
        hashMap.put(507, arrayList142);
        ArrayList arrayList143 = new ArrayList(1);
        arrayList143.add("PM");
        hashMap.put(Integer.valueOf(TypedValues.Position.TYPE_CURVE_FIT), arrayList143);
