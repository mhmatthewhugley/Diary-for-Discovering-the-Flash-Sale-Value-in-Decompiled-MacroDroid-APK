...
class CrossProcessLock {
    ...
    /* renamed from: a */
    private final FileChannel f54828a;

    /* renamed from: b */
    private final FileLock f54829b;

    private CrossProcessLock(FileChannel fileChannel, FileLock fileLock) {
        this.f54828a = fileChannel;
        this.f54829b = fileLock;
    }
    ...
    static com.google.firebase.installations.CrossProcessLock m76592a(android.content.Context r4, java.lang.String r5) {
        /*
            r0 = 0
        ...
        L_0x0046:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.installations.CrossProcessLock.m76592a(android.content.Context, java.lang.String):com.google.firebase.installations.CrossProcessLock");
    }

    /* access modifiers changed from: package-private */
    /* renamed from: b */
    public void mo63231b() {
        try {
            this.f54829b.release();
            this.f54828a.close();
        } catch (IOException e) {
