...
public class RemoveRepeatsStrategy implements StackTraceTrimmingStrategy {
    ...
    /* renamed from: b */
    private static boolean m7621b(StackTraceElement[] stackTraceElementArr, int i, int i2) {
        int i3 = i2 - i;
    ...
    /* renamed from: c */
    private static StackTraceElement[] m7622c(StackTraceElement[] stackTraceElementArr, int i) {
        int i2;
        ...
        while (i3 < stackTraceElementArr.length) {
            ...
            if (num == null || !m7621b(stackTraceElementArr, num.intValue(), i3)) {
    ...
    public StackTraceElement[] mo23532a(StackTraceElement[] stackTraceElementArr) {
        StackTraceElement[] c = m7622c(stackTraceElementArr, this.f5520a);
