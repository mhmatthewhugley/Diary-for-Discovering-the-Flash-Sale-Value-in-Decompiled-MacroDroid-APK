...
public class PercentEscaper extends UnicodeEscaper {
    ...
    /* renamed from: c */
    private static final char[] f52845c = {'+'};

    /* renamed from: d */
    private static final char[] f52846d = "0123456789ABCDEF".toCharArray();
    ...
    public PercentEscaper(String str, boolean z) {
        ...
        } else if (!str.contains(TaskerPlugin.VARIABLE_PREFIX)) {
            this.f52847a = z;
            this.f52848b = m72752g(str);
        } else {
    ...
    /* renamed from: g */
    private static boolean[] m72752g(String str) {
    ...
    /* renamed from: a */
    public String mo60789a(String str) {
        int length = str.length();
        for (int i = 0; i < length; i++) {
            char charAt = str.charAt(i);
            boolean[] zArr = this.f52848b;
            if (charAt >= zArr.length || !zArr[charAt]) {
                return mo60794d(str, i);
            }
        }
        return str;
    }
    ...
    /* renamed from: c */
    public char[] mo60790c(int i) {
        boolean[] zArr = this.f52848b;
        if (i < zArr.length && zArr[i]) {
            return null;
        }
        if (i == 32 && this.f52847a) {
            return f52845c;
        }
        if (i <= 127) {
    ...
    /* access modifiers changed from: protected */
    /* renamed from: f */
    public int mo60791f(CharSequence charSequence, int i, int i2) {
        while (i < i2) {
