...
public final class ObjectTypeAdapter extends TypeAdapter<Object> {
    ...
    /* renamed from: b */
    public static final TypeAdapterFactory f55935b = new TypeAdapterFactory() {
        /* renamed from: a */
        public <T> TypeAdapter<T> mo40897a(Gson gson, TypeToken<T> typeToken) {
            if (typeToken.mo64306c() == Object.class) {
    ...
    static /* synthetic */ class C114842 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f55937a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f55937a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f55937a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f55937a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f55937a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.ObjectTypeAdapter.C114842.<clinit>():void");
        }
    }
    ...
    public Object mo40900c(JsonReader jsonReader) throws IOException {
        switch (C114842.f55937a[jsonReader.peek().ordinal()]) {
            case 1:
                ArrayList arrayList = new ArrayList();
                jsonReader.beginArray();
                while (jsonReader.hasNext()) {
                    arrayList.add(mo40900c(jsonReader));
                }
                jsonReader.endArray();
                return arrayList;
            case 2:
                ...
                while (jsonReader.hasNext()) {
                    linkedTreeMap.put(jsonReader.nextName(), mo40900c(jsonReader));
                }
    ...
    public void mo40901e(JsonWriter jsonWriter, Object obj) throws IOException {
        ...
        TypeAdapter<?> m = this.f55936a.mo63979m(obj.getClass());
        if (m instanceof ObjectTypeAdapter) {
            jsonWriter.beginObject();
            jsonWriter.endObject();
            return;
        }
        m.mo40901e(jsonWriter, obj);
    }
}
