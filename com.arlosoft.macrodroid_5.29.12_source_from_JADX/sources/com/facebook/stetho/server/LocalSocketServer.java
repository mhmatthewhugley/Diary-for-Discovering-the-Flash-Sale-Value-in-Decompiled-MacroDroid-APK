...
public class LocalSocketServer {
        ...
        while (true) {
            try {
                if (LogUtil.isLoggable(3)) {
                    LogUtil.m25474d("Trying to bind to @" + str);
                }
                return new LocalServerSocket(str);
            } catch (BindException e) {
                LogUtil.m25492w((Throwable) e, "Binding error, sleep 1000 ms...");
    ...
    private void listenOnAddress(String str) throws IOException {
        ...
        LogUtil.m25482i("Listening on @" + str);
        while (!Thread.interrupted()) {
            try {
                ...
                LogUtil.m25492w((Throwable) e, "I/O error");
            } catch (InterruptedIOException unused) {
            } catch (IOException e2) {
                LogUtil.m25492w((Throwable) e2, "I/O error initialising connection thread");
            }
        }
        LogUtil.m25482i("Server shutdown on @" + str);
    }
