        ...
        this.mDocument.postAndWait((Runnable) new Runnable() {
            public void run() {
                ...
                if (elementForNodeId == null) {
                    LogUtil.m25478e("Tried to get the style of an element that does not exist, using nodeid=" + getComputedStyleForNodeRequest.nodeId);
                    return;
                }
    ...
    public JsonRpcResult getMatchedStylesForNode(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        this.mDocument.postAndWait((Runnable) new Runnable() {
            public void run() {
                ...
                if (elementForNodeId == null) {
                    LogUtil.m25490w("Failed to get style of an element that does not exist, nodeid=" + getMatchedStylesForNodeRequest.nodeId);
                    return;
                }
    ...
    public SetPropertyTextResult setPropertyText(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        this.mDocument.postAndWait((Runnable) new Runnable() {
            public void run() {
                ...
                if (elementForNodeId == null) {
                    LogUtil.m25490w("Failed to get style of an element that does not exist, nodeid=" + parseInt);
                    return;
                }
                if (str2 != null) {
