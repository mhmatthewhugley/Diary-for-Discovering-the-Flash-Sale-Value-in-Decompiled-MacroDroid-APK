...
public class DOM implements ChromeDevtoolsDomain {
    ...
    private final class DocumentUpdateListener implements Document.UpdateListener {
        ...
        public void onInspectRequested(Object obj) {
            ...
            if (nodeIdForElement == null) {
                LogUtil.m25475d("DocumentProvider.Listener.onInspectRequested() called for a non-mapped node: element=%s", obj);
                return;
            }
    ...
    private static class RGBAColor {
        ...
        public int getColor() {
            ...
            return Color.argb(b, this.f15749r, this.f15748g, this.f15747b);
        }
    }
    ...
    public GetSearchResultsResponse getSearchResults(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        if (str == null) {
            LogUtil.m25490w("searchId may not be null");
            return null;
        }
        List list = this.mSearchResults.get(str);
        if (list == null) {
            LogUtil.m25490w("\"" + getSearchResultsRequest.searchId + "\" is not a valid reference to a search result");
            return null;
        }
    ...
    public void highlightNode(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        if (highlightNodeRequest.nodeId == null) {
            LogUtil.m25490w("DOM.highlightNode was not given a nodeId; JS objectId is not supported");
            return;
        }
        final RGBAColor rGBAColor = highlightNodeRequest.highlightConfig.contentColor;
        if (rGBAColor == null) {
            LogUtil.m25490w("DOM.highlightNode was not given a color to highlight with");
        } else {
            this.mDocument.postAndWait((Runnable) new Runnable() {
                public void run() {
