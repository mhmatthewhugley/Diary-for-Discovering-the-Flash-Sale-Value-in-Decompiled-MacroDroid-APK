...
/* renamed from: com.android.dx.cf.code.ByteOps */
public class ByteOps {
    ...
    static {
        ...
        while (i2 < 2498) {
            ...
            int i4 = i2 + 5;
            if (OPCODE_DETAILS.charAt(i4 - 1) == ':') {
                while (true) {
                    char charAt2 = OPCODE_DETAILS.charAt(i4);
                    if (charAt2 == 'D') {
                        i |= 256;
                    } else if (charAt2 == 'F') {
                        i |= 64;
            ...
            int indexOf = OPCODE_DETAILS.indexOf(59, i4);
            OPCODE_INFO[digit] = i;
            OPCODE_NAMES[digit] = OPCODE_DETAILS.substring(i4, indexOf);
            i2 = indexOf + 1;
        }
    }
    ...
    public static String opName(int i) {
        ...
        String str2 = "unused_" + Hex.m906u1(i);
        strArr[i] = str2;
        return str2;
    }
}
