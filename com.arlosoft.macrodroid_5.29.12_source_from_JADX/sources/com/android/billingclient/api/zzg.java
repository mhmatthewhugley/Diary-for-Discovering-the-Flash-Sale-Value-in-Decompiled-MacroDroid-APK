...
final class zzg extends BroadcastReceiver {
    ...
    public final void onReceive(Context context, Intent intent) {
        this.zzb.onPurchasesUpdated(zza.m63888g(intent, "BillingBroadcastManager"), zza.m63890i(intent.getExtras()));
    }
    ...
    public final void zzc(Context context) {
        ...
        zza.m63892k("BillingBroadcastManager", "Receiver is not registered.");
    }
}
