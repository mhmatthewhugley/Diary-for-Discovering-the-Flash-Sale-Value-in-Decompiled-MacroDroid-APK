...
public class SparkPostEmailJsonRequest {
    ...
    public SparkPostEmailJsonRequest(String str, String str2, String str3, String str4, String str5) {
        ...
        this.content = new SparkPostContent(new SparkPostSender("feedback@sparkpostbox.com", str5), str, str2, (String) null, (ArrayList<SparkPostFile>) null, (String) null);
    }
}
