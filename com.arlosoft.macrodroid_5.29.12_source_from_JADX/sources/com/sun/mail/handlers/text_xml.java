...
public class text_xml extends text_plain {
    ...
    static {
        ...
        flavors = new ActivationDataFlavor[]{new ActivationDataFlavor(cls, "text/xml", "XML String"), new ActivationDataFlavor(cls, "application/xml", "XML String"), new ActivationDataFlavor(StreamSource.class, "text/xml", "XML"), new ActivationDataFlavor(StreamSource.class, "application/xml", "XML")};
    }
    ...
    private boolean isXmlType(String str) {
        try {
            ...
            if (contentType.getPrimaryType().equals("text") || contentType.getPrimaryType().equals("application")) {
                return true;
            }
            return false;
