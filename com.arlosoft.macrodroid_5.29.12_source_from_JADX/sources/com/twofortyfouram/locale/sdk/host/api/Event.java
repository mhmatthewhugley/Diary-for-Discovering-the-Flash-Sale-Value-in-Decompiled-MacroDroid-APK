...
public final class Event {
    ...
    public Event(@NonNull Context context, @NonNull Plugin plugin) {
        HandlerThread a = C13307f.m85642a(Event.class.getName(), C13307f.C13308a.BACKGROUND);
    ...
    public Pair<Integer, Bundle> query(@NonNull PluginInstanceData pluginInstanceData, int i, Bundle bundle) {
        C12406a.m83260d(pluginInstanceData, Miui3DFaceManagerImpl.TABLE_TEMPLATE_COLUMN_DATA);
        C12406a.m83257a(i, 16, 18, "previousState");
        try {
            return query(BundleSerializer.deserializeFromByteArray(pluginInstanceData.getSerializedBundle()), i, bundle);
        } catch (Exception e) {
    ...
    private Pair<Integer, Bundle> query(@NonNull Bundle bundle, int i, Bundle bundle2) {
