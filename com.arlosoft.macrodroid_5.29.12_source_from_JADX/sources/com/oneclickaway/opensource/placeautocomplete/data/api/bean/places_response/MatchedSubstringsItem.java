...
public final class MatchedSubstringsItem {
    ...
    public MatchedSubstringsItem(Integer num, Integer num2) {
        this.offset = num;
        this.length = num2;
    }

    public static /* synthetic */ MatchedSubstringsItem copy$default(MatchedSubstringsItem matchedSubstringsItem, Integer num, Integer num2, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public final MatchedSubstringsItem copy(Integer num, Integer num2) {
    ...
    public boolean equals(Object obj) {
        ...
        return C13706o.m87924a(this.offset, matchedSubstringsItem.offset) && C13706o.m87924a(this.length, matchedSubstringsItem.length);
    }
    ...
    public /* synthetic */ MatchedSubstringsItem(Integer num, Integer num2, int i, C13695i iVar) {
