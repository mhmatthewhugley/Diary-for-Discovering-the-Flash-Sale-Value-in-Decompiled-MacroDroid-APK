...
public enum C16205t implements C16189i {
    BEFORE_ROC,
    ROC;

    /* renamed from: i */
    public static C16205t m97398i(int i) {
        if (i == 0) {
            return BEFORE_ROC;
        }
        if (i == 1) {
    ...
    /* renamed from: j */
    static C16205t m97399j(DataInput dataInput) throws IOException {
        return m97398i(dataInput.readByte());
    }

    private Object writeReplace() {
        return new C16206u((byte) 6, this);
    }
    ...
    /* renamed from: m */
    public void mo78710m(DataOutput dataOutput) throws IOException {
