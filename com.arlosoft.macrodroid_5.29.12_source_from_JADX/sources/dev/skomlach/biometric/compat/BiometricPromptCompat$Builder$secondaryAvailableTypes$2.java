...
final class BiometricPromptCompat$Builder$secondaryAvailableTypes$2 extends C13708q implements C16254a<HashSet<BiometricType>> {
    final /* synthetic */ BiometricPromptCompat.Builder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BiometricPromptCompat$Builder$secondaryAvailableTypes$2(BiometricPromptCompat.Builder builder) {
        super(0);
        this.this$0 = builder;
    }
    ...
    public final HashSet<BiometricType> invoke() {
        ...
        if (HardwareAccessImpl.Companion.getInstance(this.this$0.biometricAuthRequest).isNewBiometricApi()) {
            if (this.this$0.biometricAuthRequest.getType() == BiometricType.BIOMETRIC_ANY) {
                for (BiometricType biometricType : BiometricType.values()) {
                    if (biometricType != BiometricType.BIOMETRIC_ANY) {
                        BiometricAuthRequest biometricAuthRequest = new BiometricAuthRequest(BiometricApi.LEGACY_API, biometricType, (BiometricConfirmation) null, 4, (C13695i) null);
                        BiometricLoggerImpl.INSTANCE.mo68217d("secondaryAvailableTypes - " + biometricAuthRequest + " -> " + BiometricManagerCompat.isHardwareDetected(biometricAuthRequest));
            ...
            hashSet.removeAll(this.this$0.getPrimaryAvailableTypes());
        }
        return hashSet;
    }
}
