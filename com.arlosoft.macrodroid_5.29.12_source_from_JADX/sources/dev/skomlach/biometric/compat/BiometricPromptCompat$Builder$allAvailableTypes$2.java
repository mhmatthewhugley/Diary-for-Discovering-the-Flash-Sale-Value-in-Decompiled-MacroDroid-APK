...
final class BiometricPromptCompat$Builder$allAvailableTypes$2 extends C13708q implements C16254a<HashSet<BiometricType>> {
    final /* synthetic */ BiometricPromptCompat.Builder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BiometricPromptCompat$Builder$allAvailableTypes$2(BiometricPromptCompat.Builder builder) {
        super(0);
        this.this$0 = builder;
    }
    ...
    public final HashSet<BiometricType> invoke() {
        ...
        hashSet.addAll(this.this$0.getPrimaryAvailableTypes());
        hashSet.addAll(this.this$0.getSecondaryAvailableTypes());
        return hashSet;
    }
}
