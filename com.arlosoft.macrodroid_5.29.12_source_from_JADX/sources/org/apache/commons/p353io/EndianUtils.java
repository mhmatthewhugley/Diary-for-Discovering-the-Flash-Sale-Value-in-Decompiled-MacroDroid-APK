...
public class EndianUtils {
    ...
    public static long readSwappedLong(byte[] bArr, int i) {
        return (((long) (((((bArr[i + 4] & 255) << 0) + ((bArr[i + 5] & 255) << 8)) + ((bArr[i + 6] & 255) << 16)) + ((bArr[i + 7] & 255) << 24))) << 32) + (((long) (((bArr[i + 0] & 255) << 0) + ((bArr[i + 1] & 255) << 8) + ((bArr[i + 2] & 255) << 16) + ((bArr[i + 3] & 255) << 24))) & UIDFolder.MAXUID);
    }
