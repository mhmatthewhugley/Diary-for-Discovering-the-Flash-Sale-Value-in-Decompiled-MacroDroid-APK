...
public class FileSystemUtils {
    ...
    /* renamed from: DF */
    private static final String f65995DF;
    private static final int INIT_PROBLEM = -1;
    private static final FileSystemUtils INSTANCE = new FileSystemUtils();

    /* renamed from: OS */
    private static final int f65996OS;
    ...
    public static long freeSpace(String str) throws IOException {
        return INSTANCE.freeSpaceOS(str, f65996OS, false, -1);
    }
    ...
    public long freeSpaceUnix(String str, boolean z, boolean z2, long j) throws IOException {
        if (str.length() != 0) {
            ...
            List<String> performCommand = performCommand(str2.length() > 1 ? new String[]{f65995DF, str2, str} : new String[]{f65995DF, str}, 3, j);
            if (performCommand.size() >= 2) {
                ...
                if (stringTokenizer.countTokens() >= 4) {
                    ...
                    throw new IOException("Command line '" + f65995DF + "' did not return data as expected " + "for path '" + str + "'- check path is valid");
                } else {
            ...
            throw new IOException("Command line '" + f65995DF + "' did not return info as expected " + "for path '" + str + "'- response was " + performCommand);
        }
        throw new IllegalArgumentException("Path must not be empty");
    }
    ...
    public long parseBytes(String str, String str2) throws IOException {
        try {
            ...
            throw new IOException("Command line '" + f65995DF + "' did not find free space in response " + "for path '" + str2 + "'- check path is valid");
        } catch (NumberFormatException e) {
            throw new IOExceptionWithCause("Command line '" + f65995DF + "' did not return numeric data as expected " + "for path '" + str2 + "'- check path is valid", e);
        }
    }
    ...
    public java.util.List<java.lang.String> performCommand(java.lang.String[] r10, int r11, long r12) throws java.io.IOException {
        /*
            ...
            r0.<init>(r1)
            r1 = 0
            java.lang.Thread r2 = org.apache.commons.p353io.ThreadMonitor.start(r12)     // Catch:{ InterruptedException -> 0x00d2, all -> 0x00cc }
            java.lang.Process r3 = r9.openProcess(r10)     // Catch:{ InterruptedException -> 0x00d2, all -> 0x00cc }
            java.io.InputStream r4 = r3.getInputStream()     // Catch:{ InterruptedException -> 0x00c5, all -> 0x00c2 }
            java.io.OutputStream r5 = r3.getOutputStream()     // Catch:{ InterruptedException -> 0x00bf, all -> 0x00ba }
            java.io.InputStream r6 = r3.getErrorStream()     // Catch:{ InterruptedException -> 0x00b7, all -> 0x00b4 }
            java.io.BufferedReader r7 = new java.io.BufferedReader     // Catch:{ InterruptedException -> 0x00b1, all -> 0x00ad }
            java.io.InputStreamReader r8 = new java.io.InputStreamReader     // Catch:{ InterruptedException -> 0x00b1, all -> 0x00ad }
            r8.<init>(r4)     // Catch:{ InterruptedException -> 0x00b1, all -> 0x00ad }
            r7.<init>(r8)     // Catch:{ InterruptedException -> 0x00b1, all -> 0x00ad }
            java.lang.String r1 = r7.readLine()     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
        L_0x002a:
            if (r1 == 0) goto L_0x0044
            int r8 = r0.size()     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
            if (r8 >= r11) goto L_0x0044
            java.util.Locale r8 = java.util.Locale.ENGLISH     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
            java.lang.String r1 = r1.toLowerCase(r8)     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
            java.lang.String r1 = r1.trim()     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
            r0.add(r1)     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
            java.lang.String r1 = r7.readLine()     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
            goto L_0x002a
        L_0x0044:
            r3.waitFor()     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
            org.apache.commons.p353io.ThreadMonitor.stop(r2)     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
            int r11 = r3.exitValue()     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
            if (r11 != 0) goto L_0x0081
            boolean r11 = r0.isEmpty()     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
            if (r11 != 0) goto L_0x0066
            org.apache.commons.p353io.IOUtils.closeQuietly((java.io.InputStream) r4)
            org.apache.commons.p353io.IOUtils.closeQuietly((java.io.OutputStream) r5)
            org.apache.commons.p353io.IOUtils.closeQuietly((java.io.InputStream) r6)
            org.apache.commons.p353io.IOUtils.closeQuietly((java.io.Reader) r7)
            r3.destroy()
            return r0
        L_0x0066:
            java.io.IOException r11 = new java.io.IOException     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
            java.lang.StringBuilder r0 = new java.lang.StringBuilder     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
            r0.<init>()     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
            java.lang.String r1 = "Command line did not return any info for command "
            r0.append(r1)     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
            java.util.List r1 = java.util.Arrays.asList(r10)     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
            r0.append(r1)     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
            java.lang.String r0 = r0.toString()     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
            r11.<init>(r0)     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
            throw r11     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
        L_0x0081:
            java.io.IOException r11 = new java.io.IOException     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
            java.lang.StringBuilder r0 = new java.lang.StringBuilder     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
            r0.<init>()     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
            ...
            r0.append(r1)     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
            int r1 = r3.exitValue()     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
            r0.append(r1)     // Catch:{ InterruptedException -> 0x00ab, all -> 0x00a8 }
        ...
        L_0x00d2:
            ...
            r7 = r6
        L_0x00d7:
            org.apache.commons.io.IOExceptionWithCause r0 = new org.apache.commons.io.IOExceptionWithCause     // Catch:{ all -> 0x00fa }
            ...
            java.util.List r10 = java.util.Arrays.asList(r10)     // Catch:{ all -> 0x00fa }
            r2.append(r10)     // Catch:{ all -> 0x00fa }
            java.lang.String r10 = " timeout="
            r2.append(r10)     // Catch:{ all -> 0x00fa }
            r2.append(r12)     // Catch:{ all -> 0x00fa }
            java.lang.String r10 = r2.toString()     // Catch:{ all -> 0x00fa }
            r0.<init>(r10, r11)     // Catch:{ all -> 0x00fa }
        ...
        L_0x00fc:
            r1 = r4
        L_0x00fd:
            org.apache.commons.p353io.IOUtils.closeQuietly((java.io.InputStream) r1)
            org.apache.commons.p353io.IOUtils.closeQuietly((java.io.OutputStream) r5)
            org.apache.commons.p353io.IOUtils.closeQuietly((java.io.InputStream) r6)
            org.apache.commons.p353io.IOUtils.closeQuietly((java.io.Reader) r7)
        ...
        L_0x010e:
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.commons.p353io.FileSystemUtils.performCommand(java.lang.String[], int, long):java.util.List");
    }

    public static long freeSpaceKb(String str, long j) throws IOException {
        return INSTANCE.freeSpaceOS(str, f65996OS, true, j);
    }
