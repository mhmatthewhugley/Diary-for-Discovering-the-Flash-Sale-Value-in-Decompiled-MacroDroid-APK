...
public class Tailer implements Runnable {
    ...
    /* JADX WARNING: Missing exception handler attribute for start block: B:49:0x0094 */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:46:0x008c A[Catch:{ Exception -> 0x00a9 }] */
    ...
    public void run() {
        /*
            ...
            r5 = r3
        L_0x0005:
            boolean r7 = r14.run     // Catch:{ Exception -> 0x00a9 }
            ...
            goto L_0x001b
        L_0x0016:
            org.apache.commons.io.input.TailerListener r7 = r14.listener     // Catch:{ Exception -> 0x00a9 }
            r7.fileNotFound()     // Catch:{ Exception -> 0x00a9 }
        L_0x001b:
            ...
            goto L_0x0005
        L_0x0023:
            boolean r3 = r14.end     // Catch:{ Exception -> 0x00a9 }
            if (r3 == 0) goto L_0x002f
            java.io.File r3 = r14.file     // Catch:{ Exception -> 0x00a9 }
            long r3 = r3.length()     // Catch:{ Exception -> 0x00a9 }
            r5 = r3
            goto L_0x0030
        L_0x002f:
            r5 = r0
        L_0x0030:
            ...
            r2.seek(r5)     // Catch:{ Exception -> 0x00a9 }
            goto L_0x0005
        L_0x0038:
            boolean r7 = r14.run     // Catch:{ Exception -> 0x00a9 }
            if (r7 == 0) goto L_0x00af
            java.io.File r7 = r14.file     // Catch:{ Exception -> 0x00a9 }
            boolean r7 = org.apache.commons.p353io.FileUtils.isFileNewer((java.io.File) r7, (long) r3)     // Catch:{ Exception -> 0x00a9 }
            java.io.File r9 = r14.file     // Catch:{ Exception -> 0x00a9 }
            long r9 = r9.length()     // Catch:{ Exception -> 0x00a9 }
            int r11 = (r9 > r5 ? 1 : (r9 == r5 ? 0 : -1))
            if (r11 >= 0) goto L_0x006c
            org.apache.commons.io.input.TailerListener r7 = r14.listener     // Catch:{ Exception -> 0x00a9 }
            r7.fileRotated()     // Catch:{ Exception -> 0x00a9 }
            ...
            org.apache.commons.p353io.IOUtils.closeQuietly((java.io.Closeable) r2)     // Catch:{ FileNotFoundException -> 0x0064 }
            r5 = r0
        L_0x005c:
            r2 = r7
            goto L_0x0038
        ...
        L_0x006c:
            ...
            long r3 = r14.readLines(r2)     // Catch:{ Exception -> 0x00a9 }
            long r5 = java.lang.System.currentTimeMillis()     // Catch:{ Exception -> 0x00a9 }
        L_0x0076:
            r12 = r3
            r3 = r5
            r5 = r12
        ...
        L_0x007a:
            ...
            r2.seek(r0)     // Catch:{ Exception -> 0x00a9 }
            long r3 = r14.readLines(r2)     // Catch:{ Exception -> 0x00a9 }
            long r5 = java.lang.System.currentTimeMillis()     // Catch:{ Exception -> 0x00a9 }
            goto L_0x0076
        L_0x0088:
            boolean r7 = r14.reOpen     // Catch:{ Exception -> 0x00a9 }
            if (r7 == 0) goto L_0x008f
            org.apache.commons.p353io.IOUtils.closeQuietly((java.io.Closeable) r2)     // Catch:{ Exception -> 0x00a9 }
        L_0x008f:
            long r9 = r14.delayMillis     // Catch:{ InterruptedException -> 0x0094 }
            java.lang.Thread.sleep(r9)     // Catch:{ InterruptedException -> 0x0094 }
        L_0x0094:
            boolean r7 = r14.run     // Catch:{ Exception -> 0x00a9 }
            if (r7 == 0) goto L_0x0038
            boolean r7 = r14.reOpen     // Catch:{ Exception -> 0x00a9 }
            if (r7 == 0) goto L_0x0038
            java.io.RandomAccessFile r7 = new java.io.RandomAccessFile     // Catch:{ Exception -> 0x00a9 }
            java.io.File r9 = r14.file     // Catch:{ Exception -> 0x00a9 }
            r7.<init>(r9, r8)     // Catch:{ Exception -> 0x00a9 }
        ...
        L_0x00a9:
            r0 = move-exception
        L_0x00aa:
            org.apache.commons.io.input.TailerListener r1 = r14.listener     // Catch:{ all -> 0x00a7 }
            r1.handle((java.lang.Exception) r0)     // Catch:{ all -> 0x00a7 }
        L_0x00af:
            org.apache.commons.p353io.IOUtils.closeQuietly((java.io.Closeable) r2)
            return
        L_0x00b3:
            org.apache.commons.p353io.IOUtils.closeQuietly((java.io.Closeable) r2)
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.commons.p353io.input.Tailer.run():void");
    }
