    ...
    public static abstract class C0049a extends Binder implements C0048a {
        ...
        private static class C0050a implements C0048a {
            ...
            public void extraCallback(String str, Bundle bundle) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(C0049a.DESCRIPTOR);
                    ...
                    if (this.f173a.transact(3, obtain, obtain2, 0) || C0049a.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
                    }
                    C0049a.getDefaultImpl().extraCallback(str, bundle);
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
            ...
            public Bundle extraCallbackWithResult(String str, Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.f173a.transact(7, obtain, obtain2, 0) && C0049a.getDefaultImpl() != null) {
                        return C0049a.getDefaultImpl().extraCallbackWithResult(str, bundle);
                    }
                    obtain2.readException();
            ...
            public void onMessageChannelReady(Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    if (this.f173a.transact(4, obtain, obtain2, 0) || C0049a.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
                    }
                    C0049a.getDefaultImpl().onMessageChannelReady(bundle);
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
            ...
            public void onNavigationEvent(int i, Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    if (this.f173a.transact(2, obtain, obtain2, 0) || C0049a.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
                    }
                    C0049a.getDefaultImpl().onNavigationEvent(i, bundle);
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
            ...
            public void onPostMessage(String str, Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    if (this.f173a.transact(5, obtain, obtain2, 0) || C0049a.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
                    }
                    C0049a.getDefaultImpl().onPostMessage(str, bundle);
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
            ...
            public void onRelationshipValidationResult(int i, Uri uri, boolean z, Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    if (this.f173a.transact(6, obtain, obtain2, 0) || C0049a.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
                    }
                    C0049a.getDefaultImpl().onRelationshipValidationResult(i, uri, z, bundle);
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
        ...
        public static C0048a asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public static C0048a getDefaultImpl() {
            return C0050a.f172c;
        }

        public static boolean setDefaultImpl(C0048a aVar) {
            if (C0050a.f172c != null) {
        ...
        public boolean onTransact(int r5, android.os.Parcel r6, android.os.Parcel r7, int r8) throws android.os.RemoteException {
            ...
            L_0x00e0:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.customtabs.C0048a.C0049a.onTransact(int, android.os.Parcel, android.os.Parcel, int):boolean");
        }
    }
