...
import p329me.zhanghai.android.materialprogressbar.Interpolators;
import p329me.zhanghai.android.materialprogressbar.internal.ObjectAnimatorCompat;
...
class Animators {
    ...
    public static Animator createIndeterminateRotation(@NonNull Object obj) {
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(obj, Key.ROTATION, new float[]{0.0f, 720.0f});
